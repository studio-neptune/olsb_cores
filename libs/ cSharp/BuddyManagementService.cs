      ...
      try
      {
        ...
        if (UserMids != null && __isset.userMids) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter196 in UserMids)
            {
      ...
      try
      {
        ...
        if (RequestIdList != null && __isset.requestIdList) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter200 in RequestIdList)
            {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (SendBuddyMessageResult _iter204 in Success)
              {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (RequestIdList != null && __isset.requestIdList) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.String, RequestIdList.Count));
            foreach (string _iter211 in RequestIdList)
            {
        ...
        if (Mids != null && __isset.mids) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter212 in Mids)
            {
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (SendBuddyMessageResult _iter216 in Success)
              {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (string _iter220 in Success)
              {
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.String, Success.Count));
              foreach (string _iter224 in Success)
              {
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.String, Success.Count));
              foreach (string _iter228 in Success)
              {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (Mids != null && __isset.mids) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.String, Mids.Count));
            foreach (string _iter232 in Mids)
            {
      ...
      try
      {
        ...
        if (Settings != null && __isset.settings) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter237 in Settings.Keys)
            {
              oprot.WriteString(_iter237);
              oprot.WriteString(Settings[_iter237]);
            }
            oprot.WriteMapEnd();
          }
          oprot.WriteFieldEnd();
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (UserMids != null && __isset.userMids) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.String, UserMids.Count));
            foreach (string _iter241 in UserMids)
            {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (Mids != null && __isset.mids) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.String, Mids.Count));
            foreach (string _iter245 in Mids)
            {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (Mids != null && __isset.mids) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.String, Mids.Count));
            foreach (string _iter249 in Mids)
            {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (Mids != null && __isset.mids) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.String, Mids.Count));
            foreach (string _iter253 in Mids)
            {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (Mids != null && __isset.mids) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.String, Mids.Count));
            foreach (string _iter257 in Mids)
            {
      ...
      try
      {
        ...
        if (Attributes != null && __isset.attributes) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter262 in Attributes.Keys)
            {
              oprot.WriteString(_iter262);
              oprot.WriteString(Attributes[_iter262]);
            }
            oprot.WriteMapEnd();
          }
          oprot.WriteFieldEnd();
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (Attributes != null && __isset.attributes) {
          ...
          {
            oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
            foreach (string _iter267 in Attributes.Keys)
            {
              oprot.WriteString(_iter267);
              oprot.WriteString(Attributes[_iter267]);
            }
            oprot.WriteMapEnd();
          }
          oprot.WriteFieldEnd();
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (Attributes != null && __isset.attributes) {
          ...
          {
            oprot.WriteMapBegin(new TMap(TType.String, TType.String, Attributes.Count));
            foreach (string _iter272 in Attributes.Keys)
            {
              oprot.WriteString(_iter272);
              oprot.WriteString(Attributes[_iter272]);
            }
            oprot.WriteMapEnd();
          }
          oprot.WriteFieldEnd();
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (Settings != null && __isset.settings) {
          ...
          {
            oprot.WriteMapBegin(new TMap(TType.String, TType.String, Settings.Count));
            foreach (string _iter277 in Settings.Keys)
            {
              oprot.WriteString(_iter277);
              oprot.WriteString(Settings[_iter277]);
            }
            oprot.WriteMapEnd();
          }
          oprot.WriteFieldEnd();
