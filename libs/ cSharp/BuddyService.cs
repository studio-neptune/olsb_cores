        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (BuddySearchResult _iter281 in Success)
              {
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (Contact _iter285 in Success)
              {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (string _iter289 in Success)
              {
          ...
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (string _iter294 in Success.Keys)
              {
                ...
                oprot.WriteI64(Success[_iter294]);
              }
              oprot.WriteMapEnd();
            }
            oprot.WriteFieldEnd();
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (BuddyList _iter298 in Success)
              {
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (Contact _iter302 in Success)
              {
