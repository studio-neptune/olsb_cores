        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (string _iter306 in Success)
              {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (CompactContact _iter310 in Success)
              {
      ...
      try
      {
        ...
        if (Ids != null && __isset.ids) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter314 in Ids)
            {
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (Contact _iter318 in Success)
              {
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.String, Success.Count));
              foreach (string _iter326 in Success)
              {
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.String, Success.Count));
              foreach (string _iter330 in Success)
              {
      ...
      try
      {
        ...
        if (GroupIds != null && __isset.groupIds) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter334 in GroupIds)
            {
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (@Group _iter338 in Success)
              {
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.String, Success.Count));
              foreach (string _iter342 in Success)
              {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (Ids != null && __isset.ids) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.String, Ids.Count));
            foreach (string _iter346 in Ids)
            {
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (SimpleChannelContact _iter350 in Success)
              {
              ...
              if (field.Type == TType.Map) {
                {
                  ...
                  for( int _i352 = 0; _i352 < _map351.Count; ++_i352)
                  {
                    ...
                    string _val354;
                    _key353 = (RegistrationType)iprot.ReadI32();
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (RegistrationType _iter355 in Success.Keys)
              {
                oprot.WriteI32((int)_iter355);
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.String, Success.Count));
              foreach (string _iter359 in Success)
              {
