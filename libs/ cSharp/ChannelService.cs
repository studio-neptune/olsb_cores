        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (ChannelNotificationSetting _iter363 in Success)
              {
      ...
      try
      {
        ...
        if (ChannelIds != null && __isset.channelIds) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter367 in ChannelIds)
            {
      ...
      try
      {
        ...
        if (AuthScheme != null && __isset.authScheme) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter371 in AuthScheme)
            {
      ...
      try
      {
        ...
        if (Setting != null && __isset.setting) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (ChannelNotificationSetting _iter375 in Setting)
            {
