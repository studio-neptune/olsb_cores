            ...
            if (field.Type == TType.Map) {
              {
                ...
                for( int _i106 = 0; _i106 < _map105.Count; ++_i106)
                {
                  ...
                  string _val108;
                  _key107 = (RegistrationType)iprot.ReadI32();
                  _val108 = iprot.ReadString();
                  Identities[_key107] = _val108;
                }
                iprot.ReadMapEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (Identities != null && __isset.identities) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (RegistrationType _iter109 in Identities.Keys)
          {
            oprot.WriteI32((int)_iter109);
            oprot.WriteString(Identities[_iter109]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
