            ...
            if (field.Type == TType.Map) {
              {
                ...
                for( int _i145 = 0; _i145 < _map144.Count; ++_i145)
                {
                  SnsIdType _key146;
                  string _val147;
                  _key146 = (SnsIdType)iprot.ReadI32();
                  _val147 = iprot.ReadString();
                  SnsAccounts[_key146] = _val147;
                }
                iprot.ReadMapEnd();
              }
            } else { 
            ...
            if (field.Type == TType.Map) {
              {
                ...
                for( int _i149 = 0; _i149 < _map148.Count; ++_i149)
                {
                  CustomMode _key150;
                  string _val151;
                  _key150 = (CustomMode)iprot.ReadI32();
                  _val151 = iprot.ReadString();
                  CustomModes[_key150] = _val151;
                }
                iprot.ReadMapEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (SnsAccounts != null && __isset.snsAccounts) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (SnsIdType _iter152 in SnsAccounts.Keys)
          {
            oprot.WriteI32((int)_iter152);
            oprot.WriteString(SnsAccounts[_iter152]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
      ...
      if (CustomModes != null && __isset.customModes) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (CustomMode _iter153 in CustomModes.Keys)
          {
            oprot.WriteI32((int)_iter153);
            oprot.WriteString(CustomModes[_iter153]);
          }
          oprot.WriteMapEnd();
        }
        oprot.WriteFieldEnd();
