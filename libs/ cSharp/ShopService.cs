        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (CoinProductItem _iter387 in Success)
              {
      ...
      try
      {
        ...
        if (this.__isset.success) {
          if (Success != null) {
            ...
            {
              oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
              foreach (CoinProductItem _iter391 in Success)
              {
      ...
      try
      {
        ...
        if (ProductIdList != null && __isset.productIdList) {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (string _iter395 in ProductIdList)
            {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (ProductIdList != null && __isset.productIdList) {
          ...
          {
            oprot.WriteListBegin(new TList(TType.String, ProductIdList.Count));
            foreach (string _iter399 in ProductIdList)
            {
