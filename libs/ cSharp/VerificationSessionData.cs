            ...
            if (field.Type == TType.List) {
              {
                ...
                for( int _i185 = 0; _i185 < _list184.Count; ++_i185)
                {
                  ...
                  _elem186 = (VerificationMethod)iprot.ReadI32();
                  AvailableVerificationMethods.Add(_elem186);
                }
                iprot.ReadListEnd();
              }
            } else { 
    ...
    try
    {
      ...
      if (AvailableVerificationMethods != null && __isset.availableVerificationMethods) {
        ...
        oprot.WriteFieldBegin(field);
        {
          ...
          foreach (VerificationMethod _iter187 in AvailableVerificationMethods)
          {
            oprot.WriteI32((int)_iter187);
          }
          oprot.WriteListEnd();
        }
        oprot.WriteFieldEnd();
