...
interface TalkService {
  ...
  enum methodMeta = [
    ...
    TMethodMeta(`findAndAddContactsByMid`, 
      [TParamMeta(`reqSeq`, 1), TParamMeta(`mid`, 2)],
      [TExceptionMeta(`e`, 1, `TalkException`)]
    ),
    ...
    TMethodMeta(`registerDeviceWithoutPhoneNumberWithIdentityCredential`, 
      [TParamMeta(`region`, 2), TParamMeta(`udidHash`, 3), TParamMeta(`deviceInfo`, 4), TParamMeta(`provider`, 5), TParamMeta(`identifier`, 6), TParamMeta(`verifier`, 7), TParamMeta(`mid`, 8)],
      [TExceptionMeta(`e`, 1, `TalkException`)]
    ),
    ...
    TMethodMeta(`setIdentityCredential`, 
      [TParamMeta(`provider`, 4), TParamMeta(`identifier`, 2), TParamMeta(`verifier`, 3)],
      [TExceptionMeta(`e`, 1, `TalkException`)]
    ),
    ...
    TMethodMeta(`startVerification`, 
      [TParamMeta(`region`, 2), TParamMeta(`carrier`, 3), TParamMeta(`phone`, 4), TParamMeta(`udidHash`, 5), TParamMeta(`deviceInfo`, 6), TParamMeta(`networkCode`, 7), TParamMeta(`mid`, 8), TParamMeta(`locale`, 9)],
      [TExceptionMeta(`e`, 1, `TalkException`)]
    ),
