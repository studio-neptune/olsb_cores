...
from_GetRSAKey_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v1185 -> (1, ("e",from_TalkException _v1185))) <$> getRSAKey_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v1185 -> P.Just (0, ("success",from_RSAKey _v1185))) $ getRSAKey_result_success record
    , (\_v1185 -> (1, ("e",from_TalkException _v1185))) <$> getRSAKey_result_e record
    ]
    )
...
to_GetRSAKey_result (T.TStruct fields) = GetRSAKey_result{
  getRSAKey_result_success = P.maybe (getRSAKey_result_success default_GetRSAKey_result) (\(_,_val1187) -> (case _val1187 of {T.TStruct _val1188 -> (to_RSAKey (T.TStruct _val1188)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getRSAKey_result_e = P.maybe (P.Nothing) (\(_,_val1187) -> P.Just (case _val1187 of {T.TStruct _val1189 -> (to_TalkException (T.TStruct _val1189)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_NotifyEmailConfirmationResult_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v1192 -> P.Just (2, ("parameterMap",T.TMap T.T_STRING T.T_STRING $ P.map (\(_k1193,_v1194) -> (T.TString $ E.encodeUtf8 _k1193, T.TString $ E.encodeUtf8 _v1194)) $ Map.toList _v1192))) $ notifyEmailConfirmationResult_args_parameterMap record
  ]
...
to_NotifyEmailConfirmationResult_args (T.TStruct fields) = NotifyEmailConfirmationResult_args{
  notifyEmailConfirmationResult_args_parameterMap = P.maybe (notifyEmailConfirmationResult_args_parameterMap default_NotifyEmailConfirmationResult_args) (\(_,_val1196) -> (case _val1196 of {T.TMap _ _ _val1197 -> (Map.fromList $ P.map (\(_k1199,_v1198) -> ((case _k1199 of {T.TString _val1200 -> E.decodeUtf8 _val1200; _ -> P.error "wrong type"}),(case _v1198 of {T.TString _val1201 -> E.decodeUtf8 _val1201; _ -> P.error "wrong type"}))) _val1197); _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_NotifyEmailConfirmationResult_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v1204 -> (1, ("e",from_TalkException _v1204))) <$> notifyEmailConfirmationResult_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v1204 -> (1, ("e",from_TalkException _v1204))) <$> notifyEmailConfirmationResult_result_e record
    ]
    )
...
to_NotifyEmailConfirmationResult_result (T.TStruct fields) = NotifyEmailConfirmationResult_result{
  notifyEmailConfirmationResult_result_e = P.maybe (P.Nothing) (\(_,_val1206) -> P.Just (case _val1206 of {T.TStruct _val1207 -> (to_TalkException (T.TStruct _val1207)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_RegisterVirtualAccount_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v1210 -> P.Just (2, ("locale",T.TString $ E.encodeUtf8 _v1210))) $ registerVirtualAccount_args_locale record
  , (\_v1210 -> P.Just (3, ("encryptedVirtualUserId",T.TString $ E.encodeUtf8 _v1210))) $ registerVirtualAccount_args_encryptedVirtualUserId record
  , (\_v1210 -> P.Just (4, ("encryptedPassword",T.TString $ E.encodeUtf8 _v1210))) $ registerVirtualAccount_args_encryptedPassword record
  ]
...
to_RegisterVirtualAccount_args (T.TStruct fields) = RegisterVirtualAccount_args{
  registerVirtualAccount_args_locale = P.maybe (registerVirtualAccount_args_locale default_RegisterVirtualAccount_args) (\(_,_val1212) -> (case _val1212 of {T.TString _val1213 -> E.decodeUtf8 _val1213; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  registerVirtualAccount_args_encryptedVirtualUserId = P.maybe (registerVirtualAccount_args_encryptedVirtualUserId default_RegisterVirtualAccount_args) (\(_,_val1212) -> (case _val1212 of {T.TString _val1214 -> E.decodeUtf8 _val1214; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  registerVirtualAccount_args_encryptedPassword = P.maybe (registerVirtualAccount_args_encryptedPassword default_RegisterVirtualAccount_args) (\(_,_val1212) -> (case _val1212 of {T.TString _val1215 -> E.decodeUtf8 _val1215; _ -> P.error "wrong type"})) (Map.lookup (4) fields)
  }
...
from_RegisterVirtualAccount_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v1218 -> (1, ("e",from_TalkException _v1218))) <$> registerVirtualAccount_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v1218 -> P.Just (0, ("success",T.TString $ E.encodeUtf8 _v1218))) $ registerVirtualAccount_result_success record
    , (\_v1218 -> (1, ("e",from_TalkException _v1218))) <$> registerVirtualAccount_result_e record
    ]
    )
...
to_RegisterVirtualAccount_result (T.TStruct fields) = RegisterVirtualAccount_result{
  registerVirtualAccount_result_success = P.maybe (registerVirtualAccount_result_success default_RegisterVirtualAccount_result) (\(_,_val1220) -> (case _val1220 of {T.TString _val1221 -> E.decodeUtf8 _val1221; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  registerVirtualAccount_result_e = P.maybe (P.Nothing) (\(_,_val1220) -> P.Just (case _val1220 of {T.TStruct _val1222 -> (to_TalkException (T.TStruct _val1222)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_RequestVirtualAccountPasswordChange_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v1225 -> P.Just (2, ("virtualMid",T.TString $ E.encodeUtf8 _v1225))) $ requestVirtualAccountPasswordChange_args_virtualMid record
  , (\_v1225 -> P.Just (3, ("encryptedVirtualUserId",T.TString $ E.encodeUtf8 _v1225))) $ requestVirtualAccountPasswordChange_args_encryptedVirtualUserId record
  , (\_v1225 -> P.Just (4, ("encryptedOldPassword",T.TString $ E.encodeUtf8 _v1225))) $ requestVirtualAccountPasswordChange_args_encryptedOldPassword record
  , (\_v1225 -> P.Just (5, ("encryptedNewPassword",T.TString $ E.encodeUtf8 _v1225))) $ requestVirtualAccountPasswordChange_args_encryptedNewPassword record
  ]
...
to_RequestVirtualAccountPasswordChange_args (T.TStruct fields) = RequestVirtualAccountPasswordChange_args{
  requestVirtualAccountPasswordChange_args_virtualMid = P.maybe (requestVirtualAccountPasswordChange_args_virtualMid default_RequestVirtualAccountPasswordChange_args) (\(_,_val1227) -> (case _val1227 of {T.TString _val1228 -> E.decodeUtf8 _val1228; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  requestVirtualAccountPasswordChange_args_encryptedVirtualUserId = P.maybe (requestVirtualAccountPasswordChange_args_encryptedVirtualUserId default_RequestVirtualAccountPasswordChange_args) (\(_,_val1227) -> (case _val1227 of {T.TString _val1229 -> E.decodeUtf8 _val1229; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  requestVirtualAccountPasswordChange_args_encryptedOldPassword = P.maybe (requestVirtualAccountPasswordChange_args_encryptedOldPassword default_RequestVirtualAccountPasswordChange_args) (\(_,_val1227) -> (case _val1227 of {T.TString _val1230 -> E.decodeUtf8 _val1230; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  requestVirtualAccountPasswordChange_args_encryptedNewPassword = P.maybe (requestVirtualAccountPasswordChange_args_encryptedNewPassword default_RequestVirtualAccountPasswordChange_args) (\(_,_val1227) -> (case _val1227 of {T.TString _val1231 -> E.decodeUtf8 _val1231; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_RequestVirtualAccountPasswordChange_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v1234 -> (1, ("e",from_TalkException _v1234))) <$> requestVirtualAccountPasswordChange_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v1234 -> (1, ("e",from_TalkException _v1234))) <$> requestVirtualAccountPasswordChange_result_e record
    ]
    )
...
to_RequestVirtualAccountPasswordChange_result (T.TStruct fields) = RequestVirtualAccountPasswordChange_result{
  requestVirtualAccountPasswordChange_result_e = P.maybe (P.Nothing) (\(_,_val1236) -> P.Just (case _val1236 of {T.TStruct _val1237 -> (to_TalkException (T.TStruct _val1237)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_RequestVirtualAccountPasswordSet_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v1240 -> P.Just (2, ("virtualMid",T.TString $ E.encodeUtf8 _v1240))) $ requestVirtualAccountPasswordSet_args_virtualMid record
  , (\_v1240 -> P.Just (3, ("encryptedVirtualUserId",T.TString $ E.encodeUtf8 _v1240))) $ requestVirtualAccountPasswordSet_args_encryptedVirtualUserId record
  , (\_v1240 -> P.Just (4, ("encryptedNewPassword",T.TString $ E.encodeUtf8 _v1240))) $ requestVirtualAccountPasswordSet_args_encryptedNewPassword record
  ]
...
to_RequestVirtualAccountPasswordSet_args (T.TStruct fields) = RequestVirtualAccountPasswordSet_args{
  requestVirtualAccountPasswordSet_args_virtualMid = P.maybe (requestVirtualAccountPasswordSet_args_virtualMid default_RequestVirtualAccountPasswordSet_args) (\(_,_val1242) -> (case _val1242 of {T.TString _val1243 -> E.decodeUtf8 _val1243; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  requestVirtualAccountPasswordSet_args_encryptedVirtualUserId = P.maybe (requestVirtualAccountPasswordSet_args_encryptedVirtualUserId default_RequestVirtualAccountPasswordSet_args) (\(_,_val1242) -> (case _val1242 of {T.TString _val1244 -> E.decodeUtf8 _val1244; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  requestVirtualAccountPasswordSet_args_encryptedNewPassword = P.maybe (requestVirtualAccountPasswordSet_args_encryptedNewPassword default_RequestVirtualAccountPasswordSet_args) (\(_,_val1242) -> (case _val1242 of {T.TString _val1245 -> E.decodeUtf8 _val1245; _ -> P.error "wrong type"})) (Map.lookup (4) fields)
  }
...
from_RequestVirtualAccountPasswordSet_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v1248 -> (1, ("e",from_TalkException _v1248))) <$> requestVirtualAccountPasswordSet_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v1248 -> (1, ("e",from_TalkException _v1248))) <$> requestVirtualAccountPasswordSet_result_e record
    ]
    )
...
to_RequestVirtualAccountPasswordSet_result (T.TStruct fields) = RequestVirtualAccountPasswordSet_result{
  requestVirtualAccountPasswordSet_result_e = P.maybe (P.Nothing) (\(_,_val1250) -> P.Just (case _val1250 of {T.TStruct _val1251 -> (to_TalkException (T.TStruct _val1251)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_UnregisterVirtualAccount_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v1254 -> P.Just (2, ("virtualMid",T.TString $ E.encodeUtf8 _v1254))) $ unregisterVirtualAccount_args_virtualMid record
  ]
...
to_UnregisterVirtualAccount_args (T.TStruct fields) = UnregisterVirtualAccount_args{
  unregisterVirtualAccount_args_virtualMid = P.maybe (unregisterVirtualAccount_args_virtualMid default_UnregisterVirtualAccount_args) (\(_,_val1256) -> (case _val1256 of {T.TString _val1257 -> E.decodeUtf8 _val1257; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_UnregisterVirtualAccount_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v1260 -> (1, ("e",from_TalkException _v1260))) <$> unregisterVirtualAccount_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v1260 -> (1, ("e",from_TalkException _v1260))) <$> unregisterVirtualAccount_result_e record
    ]
    )
...
to_UnregisterVirtualAccount_result (T.TStruct fields) = UnregisterVirtualAccount_result{
  unregisterVirtualAccount_result_e = P.maybe (P.Nothing) (\(_,_val1262) -> P.Just (case _val1262 of {T.TStruct _val1263 -> (to_TalkException (T.TStruct _val1263)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
