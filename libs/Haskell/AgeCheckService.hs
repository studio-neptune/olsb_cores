...
from_CheckUserAge_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v1266 -> P.Just (2, ("carrier",T.TI32 $ P.fromIntegral $ P.fromEnum _v1266))) $ checkUserAge_args_carrier record
  , (\_v1266 -> P.Just (3, ("sessionId",T.TString $ E.encodeUtf8 _v1266))) $ checkUserAge_args_sessionId record
  , (\_v1266 -> P.Just (4, ("verifier",T.TString $ E.encodeUtf8 _v1266))) $ checkUserAge_args_verifier record
  , (\_v1266 -> P.Just (5, ("standardAge",T.TI32 _v1266))) $ checkUserAge_args_standardAge record
  ]
...
to_CheckUserAge_args (T.TStruct fields) = CheckUserAge_args{
  checkUserAge_args_carrier = P.maybe (checkUserAge_args_carrier default_CheckUserAge_args) (\(_,_val1268) -> (case _val1268 of {T.TI32 _val1269 -> P.toEnum $ P.fromIntegral _val1269; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  checkUserAge_args_sessionId = P.maybe (checkUserAge_args_sessionId default_CheckUserAge_args) (\(_,_val1268) -> (case _val1268 of {T.TString _val1270 -> E.decodeUtf8 _val1270; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  checkUserAge_args_verifier = P.maybe (checkUserAge_args_verifier default_CheckUserAge_args) (\(_,_val1268) -> (case _val1268 of {T.TString _val1271 -> E.decodeUtf8 _val1271; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  checkUserAge_args_standardAge = P.maybe (checkUserAge_args_standardAge default_CheckUserAge_args) (\(_,_val1268) -> (case _val1268 of {T.TI32 _val1272 -> _val1272; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_CheckUserAge_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v1275 -> (1, ("e",from_TalkException _v1275))) <$> checkUserAge_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v1275 -> P.Just (0, ("success",T.TI32 $ P.fromIntegral $ P.fromEnum _v1275))) $ checkUserAge_result_success record
    , (\_v1275 -> (1, ("e",from_TalkException _v1275))) <$> checkUserAge_result_e record
    ]
    )
...
to_CheckUserAge_result (T.TStruct fields) = CheckUserAge_result{
  checkUserAge_result_success = P.maybe (checkUserAge_result_success default_CheckUserAge_result) (\(_,_val1277) -> (case _val1277 of {T.TI32 _val1278 -> P.toEnum $ P.fromIntegral _val1278; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  checkUserAge_result_e = P.maybe (P.Nothing) (\(_,_val1277) -> P.Just (case _val1277 of {T.TStruct _val1279 -> (to_TalkException (T.TStruct _val1279)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_CheckUserAgeWithDocomo_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v1282 -> P.Just (2, ("openIdRedirectUrl",T.TString $ E.encodeUtf8 _v1282))) $ checkUserAgeWithDocomo_args_openIdRedirectUrl record
  , (\_v1282 -> P.Just (3, ("standardAge",T.TI32 _v1282))) $ checkUserAgeWithDocomo_args_standardAge record
  , (\_v1282 -> P.Just (4, ("verifier",T.TString $ E.encodeUtf8 _v1282))) $ checkUserAgeWithDocomo_args_verifier record
  ]
...
to_CheckUserAgeWithDocomo_args (T.TStruct fields) = CheckUserAgeWithDocomo_args{
  checkUserAgeWithDocomo_args_openIdRedirectUrl = P.maybe (checkUserAgeWithDocomo_args_openIdRedirectUrl default_CheckUserAgeWithDocomo_args) (\(_,_val1284) -> (case _val1284 of {T.TString _val1285 -> E.decodeUtf8 _val1285; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  checkUserAgeWithDocomo_args_standardAge = P.maybe (checkUserAgeWithDocomo_args_standardAge default_CheckUserAgeWithDocomo_args) (\(_,_val1284) -> (case _val1284 of {T.TI32 _val1286 -> _val1286; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  checkUserAgeWithDocomo_args_verifier = P.maybe (checkUserAgeWithDocomo_args_verifier default_CheckUserAgeWithDocomo_args) (\(_,_val1284) -> (case _val1284 of {T.TString _val1287 -> E.decodeUtf8 _val1287; _ -> P.error "wrong type"})) (Map.lookup (4) fields)
  }
...
from_CheckUserAgeWithDocomo_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v1290 -> (1, ("e",from_TalkException _v1290))) <$> checkUserAgeWithDocomo_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v1290 -> P.Just (0, ("success",from_AgeCheckDocomoResult _v1290))) $ checkUserAgeWithDocomo_result_success record
    , (\_v1290 -> (1, ("e",from_TalkException _v1290))) <$> checkUserAgeWithDocomo_result_e record
    ]
    )
...
to_CheckUserAgeWithDocomo_result (T.TStruct fields) = CheckUserAgeWithDocomo_result{
  checkUserAgeWithDocomo_result_success = P.maybe (checkUserAgeWithDocomo_result_success default_CheckUserAgeWithDocomo_result) (\(_,_val1292) -> (case _val1292 of {T.TStruct _val1293 -> (to_AgeCheckDocomoResult (T.TStruct _val1293)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  checkUserAgeWithDocomo_result_e = P.maybe (P.Nothing) (\(_,_val1292) -> P.Just (case _val1292 of {T.TStruct _val1294 -> (to_TalkException (T.TStruct _val1294)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_RetrieveOpenIdAuthUrlWithDocomo_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v1302 -> (1, ("e",from_TalkException _v1302))) <$> retrieveOpenIdAuthUrlWithDocomo_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v1302 -> P.Just (0, ("success",T.TString $ E.encodeUtf8 _v1302))) $ retrieveOpenIdAuthUrlWithDocomo_result_success record
    , (\_v1302 -> (1, ("e",from_TalkException _v1302))) <$> retrieveOpenIdAuthUrlWithDocomo_result_e record
    ]
    )
...
to_RetrieveOpenIdAuthUrlWithDocomo_result (T.TStruct fields) = RetrieveOpenIdAuthUrlWithDocomo_result{
  retrieveOpenIdAuthUrlWithDocomo_result_success = P.maybe (retrieveOpenIdAuthUrlWithDocomo_result_success default_RetrieveOpenIdAuthUrlWithDocomo_result) (\(_,_val1304) -> (case _val1304 of {T.TString _val1305 -> E.decodeUtf8 _val1305; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  retrieveOpenIdAuthUrlWithDocomo_result_e = P.maybe (P.Nothing) (\(_,_val1304) -> P.Just (case _val1304 of {T.TStruct _val1306 -> (to_TalkException (T.TStruct _val1306)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_RetrieveRequestToken_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v1309 -> P.Just (2, ("carrier",T.TI32 $ P.fromIntegral $ P.fromEnum _v1309))) $ retrieveRequestToken_args_carrier record
  ]
...
to_RetrieveRequestToken_args (T.TStruct fields) = RetrieveRequestToken_args{
  retrieveRequestToken_args_carrier = P.maybe (retrieveRequestToken_args_carrier default_RetrieveRequestToken_args) (\(_,_val1311) -> (case _val1311 of {T.TI32 _val1312 -> P.toEnum $ P.fromIntegral _val1312; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_RetrieveRequestToken_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v1315 -> (1, ("e",from_TalkException _v1315))) <$> retrieveRequestToken_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v1315 -> P.Just (0, ("success",from_AgeCheckRequestResult _v1315))) $ retrieveRequestToken_result_success record
    , (\_v1315 -> (1, ("e",from_TalkException _v1315))) <$> retrieveRequestToken_result_e record
    ]
    )
...
to_RetrieveRequestToken_result (T.TStruct fields) = RetrieveRequestToken_result{
  retrieveRequestToken_result_success = P.maybe (retrieveRequestToken_result_success default_RetrieveRequestToken_result) (\(_,_val1317) -> (case _val1317 of {T.TStruct _val1318 -> (to_AgeCheckRequestResult (T.TStruct _val1318)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  retrieveRequestToken_result_e = P.maybe (P.Nothing) (\(_,_val1317) -> P.Just (case _val1317 of {T.TStruct _val1319 -> (to_TalkException (T.TStruct _val1319)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
