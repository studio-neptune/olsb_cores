...
from_FindBuddyContactsByQuery_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v2177 -> P.Just (2, ("language",T.TString $ E.encodeUtf8 _v2177))) $ findBuddyContactsByQuery_args_language record
  , (\_v2177 -> P.Just (3, ("country",T.TString $ E.encodeUtf8 _v2177))) $ findBuddyContactsByQuery_args_country record
  , (\_v2177 -> P.Just (4, ("query",T.TString $ E.encodeUtf8 _v2177))) $ findBuddyContactsByQuery_args_query record
  , (\_v2177 -> P.Just (5, ("fromIndex",T.TI32 _v2177))) $ findBuddyContactsByQuery_args_fromIndex record
  , (\_v2177 -> P.Just (6, ("count",T.TI32 _v2177))) $ findBuddyContactsByQuery_args_count record
  , (\_v2177 -> P.Just (7, ("requestSource",T.TI32 $ P.fromIntegral $ P.fromEnum _v2177))) $ findBuddyContactsByQuery_args_requestSource record
  ]
...
to_FindBuddyContactsByQuery_args (T.TStruct fields) = FindBuddyContactsByQuery_args{
  findBuddyContactsByQuery_args_language = P.maybe (findBuddyContactsByQuery_args_language default_FindBuddyContactsByQuery_args) (\(_,_val2179) -> (case _val2179 of {T.TString _val2180 -> E.decodeUtf8 _val2180; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  findBuddyContactsByQuery_args_country = P.maybe (findBuddyContactsByQuery_args_country default_FindBuddyContactsByQuery_args) (\(_,_val2179) -> (case _val2179 of {T.TString _val2181 -> E.decodeUtf8 _val2181; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  findBuddyContactsByQuery_args_query = P.maybe (findBuddyContactsByQuery_args_query default_FindBuddyContactsByQuery_args) (\(_,_val2179) -> (case _val2179 of {T.TString _val2182 -> E.decodeUtf8 _val2182; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  findBuddyContactsByQuery_args_fromIndex = P.maybe (findBuddyContactsByQuery_args_fromIndex default_FindBuddyContactsByQuery_args) (\(_,_val2179) -> (case _val2179 of {T.TI32 _val2183 -> _val2183; _ -> P.error "wrong type"})) (Map.lookup (5) fields),
  findBuddyContactsByQuery_args_count = P.maybe (findBuddyContactsByQuery_args_count default_FindBuddyContactsByQuery_args) (\(_,_val2179) -> (case _val2179 of {T.TI32 _val2184 -> _val2184; _ -> P.error "wrong type"})) (Map.lookup (6) fields),
  findBuddyContactsByQuery_args_requestSource = P.maybe (findBuddyContactsByQuery_args_requestSource default_FindBuddyContactsByQuery_args) (\(_,_val2179) -> (case _val2179 of {T.TI32 _val2185 -> P.toEnum $ P.fromIntegral _val2185; _ -> P.error "wrong type"})) (Map.lookup (7) fields)
  }
...
from_FindBuddyContactsByQuery_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v2188 -> (1, ("e",from_TalkException _v2188))) <$> findBuddyContactsByQuery_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v2188 -> P.Just (0, ("success",T.TList (T.T_STRUCT typemap_BuddySearchResult) $ P.map (\_v2190 -> from_BuddySearchResult _v2190) $ Vector.toList _v2188))) $ findBuddyContactsByQuery_result_success record
    , (\_v2188 -> (1, ("e",from_TalkException _v2188))) <$> findBuddyContactsByQuery_result_e record
    ]
    )
...
to_FindBuddyContactsByQuery_result (T.TStruct fields) = FindBuddyContactsByQuery_result{
  findBuddyContactsByQuery_result_success = P.maybe (findBuddyContactsByQuery_result_success default_FindBuddyContactsByQuery_result) (\(_,_val2192) -> (case _val2192 of {T.TList _ _val2193 -> (Vector.fromList $ P.map (\_v2194 -> (case _v2194 of {T.TStruct _val2195 -> (to_BuddySearchResult (T.TStruct _val2195)); _ -> P.error "wrong type"})) _val2193); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  findBuddyContactsByQuery_result_e = P.maybe (P.Nothing) (\(_,_val2192) -> P.Just (case _val2192 of {T.TStruct _val2196 -> (to_TalkException (T.TStruct _val2196)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetBuddyContacts_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v2199 -> P.Just (2, ("language",T.TString $ E.encodeUtf8 _v2199))) $ getBuddyContacts_args_language record
  , (\_v2199 -> P.Just (3, ("country",T.TString $ E.encodeUtf8 _v2199))) $ getBuddyContacts_args_country record
  , (\_v2199 -> P.Just (4, ("classification",T.TString $ E.encodeUtf8 _v2199))) $ getBuddyContacts_args_classification record
  , (\_v2199 -> P.Just (5, ("fromIndex",T.TI32 _v2199))) $ getBuddyContacts_args_fromIndex record
  , (\_v2199 -> P.Just (6, ("count",T.TI32 _v2199))) $ getBuddyContacts_args_count record
  ]
...
to_GetBuddyContacts_args (T.TStruct fields) = GetBuddyContacts_args{
  getBuddyContacts_args_language = P.maybe (getBuddyContacts_args_language default_GetBuddyContacts_args) (\(_,_val2201) -> (case _val2201 of {T.TString _val2202 -> E.decodeUtf8 _val2202; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getBuddyContacts_args_country = P.maybe (getBuddyContacts_args_country default_GetBuddyContacts_args) (\(_,_val2201) -> (case _val2201 of {T.TString _val2203 -> E.decodeUtf8 _val2203; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getBuddyContacts_args_classification = P.maybe (getBuddyContacts_args_classification default_GetBuddyContacts_args) (\(_,_val2201) -> (case _val2201 of {T.TString _val2204 -> E.decodeUtf8 _val2204; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getBuddyContacts_args_fromIndex = P.maybe (getBuddyContacts_args_fromIndex default_GetBuddyContacts_args) (\(_,_val2201) -> (case _val2201 of {T.TI32 _val2205 -> _val2205; _ -> P.error "wrong type"})) (Map.lookup (5) fields),
  getBuddyContacts_args_count = P.maybe (getBuddyContacts_args_count default_GetBuddyContacts_args) (\(_,_val2201) -> (case _val2201 of {T.TI32 _val2206 -> _val2206; _ -> P.error "wrong type"})) (Map.lookup (6) fields)
  }
...
from_GetBuddyContacts_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v2209 -> (1, ("e",from_TalkException _v2209))) <$> getBuddyContacts_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v2209 -> P.Just (0, ("success",T.TList (T.T_STRUCT typemap_Contact) $ P.map (\_v2211 -> from_Contact _v2211) $ Vector.toList _v2209))) $ getBuddyContacts_result_success record
    , (\_v2209 -> (1, ("e",from_TalkException _v2209))) <$> getBuddyContacts_result_e record
    ]
    )
...
to_GetBuddyContacts_result (T.TStruct fields) = GetBuddyContacts_result{
  getBuddyContacts_result_success = P.maybe (getBuddyContacts_result_success default_GetBuddyContacts_result) (\(_,_val2213) -> (case _val2213 of {T.TList _ _val2214 -> (Vector.fromList $ P.map (\_v2215 -> (case _v2215 of {T.TStruct _val2216 -> (to_Contact (T.TStruct _val2216)); _ -> P.error "wrong type"})) _val2214); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getBuddyContacts_result_e = P.maybe (P.Nothing) (\(_,_val2213) -> P.Just (case _val2213 of {T.TStruct _val2217 -> (to_TalkException (T.TStruct _val2217)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetBuddyDetail_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v2220 -> P.Just (4, ("buddyMid",T.TString $ E.encodeUtf8 _v2220))) $ getBuddyDetail_args_buddyMid record
  ]
...
to_GetBuddyDetail_args (T.TStruct fields) = GetBuddyDetail_args{
  getBuddyDetail_args_buddyMid = P.maybe (getBuddyDetail_args_buddyMid default_GetBuddyDetail_args) (\(_,_val2222) -> (case _val2222 of {T.TString _val2223 -> E.decodeUtf8 _val2223; _ -> P.error "wrong type"})) (Map.lookup (4) fields)
  }
...
from_GetBuddyDetail_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v2226 -> (1, ("e",from_TalkException _v2226))) <$> getBuddyDetail_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v2226 -> P.Just (0, ("success",from_BuddyDetail _v2226))) $ getBuddyDetail_result_success record
    , (\_v2226 -> (1, ("e",from_TalkException _v2226))) <$> getBuddyDetail_result_e record
    ]
    )
...
to_GetBuddyDetail_result (T.TStruct fields) = GetBuddyDetail_result{
  getBuddyDetail_result_success = P.maybe (getBuddyDetail_result_success default_GetBuddyDetail_result) (\(_,_val2228) -> (case _val2228 of {T.TStruct _val2229 -> (to_BuddyDetail (T.TStruct _val2229)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getBuddyDetail_result_e = P.maybe (P.Nothing) (\(_,_val2228) -> P.Just (case _val2228 of {T.TStruct _val2230 -> (to_TalkException (T.TStruct _val2230)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetBuddyOnAir_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v2233 -> P.Just (4, ("buddyMid",T.TString $ E.encodeUtf8 _v2233))) $ getBuddyOnAir_args_buddyMid record
  ]
...
to_GetBuddyOnAir_args (T.TStruct fields) = GetBuddyOnAir_args{
  getBuddyOnAir_args_buddyMid = P.maybe (getBuddyOnAir_args_buddyMid default_GetBuddyOnAir_args) (\(_,_val2235) -> (case _val2235 of {T.TString _val2236 -> E.decodeUtf8 _val2236; _ -> P.error "wrong type"})) (Map.lookup (4) fields)
  }
...
from_GetBuddyOnAir_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v2239 -> (1, ("e",from_TalkException _v2239))) <$> getBuddyOnAir_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v2239 -> P.Just (0, ("success",from_BuddyOnAir _v2239))) $ getBuddyOnAir_result_success record
    , (\_v2239 -> (1, ("e",from_TalkException _v2239))) <$> getBuddyOnAir_result_e record
    ]
    )
...
to_GetBuddyOnAir_result (T.TStruct fields) = GetBuddyOnAir_result{
  getBuddyOnAir_result_success = P.maybe (getBuddyOnAir_result_success default_GetBuddyOnAir_result) (\(_,_val2241) -> (case _val2241 of {T.TStruct _val2242 -> (to_BuddyOnAir (T.TStruct _val2242)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getBuddyOnAir_result_e = P.maybe (P.Nothing) (\(_,_val2241) -> P.Just (case _val2241 of {T.TStruct _val2243 -> (to_TalkException (T.TStruct _val2243)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetCountriesHavingBuddy_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v2251 -> (1, ("e",from_TalkException _v2251))) <$> getCountriesHavingBuddy_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v2251 -> P.Just (0, ("success",T.TList T.T_STRING $ P.map (\_v2253 -> T.TString $ E.encodeUtf8 _v2253) $ Vector.toList _v2251))) $ getCountriesHavingBuddy_result_success record
    , (\_v2251 -> (1, ("e",from_TalkException _v2251))) <$> getCountriesHavingBuddy_result_e record
    ]
    )
...
to_GetCountriesHavingBuddy_result (T.TStruct fields) = GetCountriesHavingBuddy_result{
  getCountriesHavingBuddy_result_success = P.maybe (getCountriesHavingBuddy_result_success default_GetCountriesHavingBuddy_result) (\(_,_val2255) -> (case _val2255 of {T.TList _ _val2256 -> (Vector.fromList $ P.map (\_v2257 -> (case _v2257 of {T.TString _val2258 -> E.decodeUtf8 _val2258; _ -> P.error "wrong type"})) _val2256); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getCountriesHavingBuddy_result_e = P.maybe (P.Nothing) (\(_,_val2255) -> P.Just (case _val2255 of {T.TStruct _val2259 -> (to_TalkException (T.TStruct _val2259)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetNewlyReleasedBuddyIds_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v2262 -> P.Just (3, ("country",T.TString $ E.encodeUtf8 _v2262))) $ getNewlyReleasedBuddyIds_args_country record
  ]
...
to_GetNewlyReleasedBuddyIds_args (T.TStruct fields) = GetNewlyReleasedBuddyIds_args{
  getNewlyReleasedBuddyIds_args_country = P.maybe (getNewlyReleasedBuddyIds_args_country default_GetNewlyReleasedBuddyIds_args) (\(_,_val2264) -> (case _val2264 of {T.TString _val2265 -> E.decodeUtf8 _val2265; _ -> P.error "wrong type"})) (Map.lookup (3) fields)
  }
...
from_GetNewlyReleasedBuddyIds_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v2268 -> (1, ("e",from_TalkException _v2268))) <$> getNewlyReleasedBuddyIds_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v2268 -> P.Just (0, ("success",T.TMap T.T_STRING T.T_I64 $ P.map (\(_k2269,_v2270) -> (T.TString $ E.encodeUtf8 _k2269, T.TI64 _v2270)) $ Map.toList _v2268))) $ getNewlyReleasedBuddyIds_result_success record
    , (\_v2268 -> (1, ("e",from_TalkException _v2268))) <$> getNewlyReleasedBuddyIds_result_e record
    ]
    )
...
to_GetNewlyReleasedBuddyIds_result (T.TStruct fields) = GetNewlyReleasedBuddyIds_result{
  getNewlyReleasedBuddyIds_result_success = P.maybe (getNewlyReleasedBuddyIds_result_success default_GetNewlyReleasedBuddyIds_result) (\(_,_val2272) -> (case _val2272 of {T.TMap _ _ _val2273 -> (Map.fromList $ P.map (\(_k2275,_v2274) -> ((case _k2275 of {T.TString _val2276 -> E.decodeUtf8 _val2276; _ -> P.error "wrong type"}),(case _v2274 of {T.TI64 _val2277 -> _val2277; _ -> P.error "wrong type"}))) _val2273); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getNewlyReleasedBuddyIds_result_e = P.maybe (P.Nothing) (\(_,_val2272) -> P.Just (case _val2272 of {T.TStruct _val2278 -> (to_TalkException (T.TStruct _val2278)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetPopularBuddyBanner_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v2281 -> P.Just (2, ("language",T.TString $ E.encodeUtf8 _v2281))) $ getPopularBuddyBanner_args_language record
  , (\_v2281 -> P.Just (3, ("country",T.TString $ E.encodeUtf8 _v2281))) $ getPopularBuddyBanner_args_country record
  , (\_v2281 -> P.Just (4, ("applicationType",T.TI32 $ P.fromIntegral $ P.fromEnum _v2281))) $ getPopularBuddyBanner_args_applicationType record
  , (\_v2281 -> P.Just (5, ("resourceSpecification",T.TString $ E.encodeUtf8 _v2281))) $ getPopularBuddyBanner_args_resourceSpecification record
  ]
...
to_GetPopularBuddyBanner_args (T.TStruct fields) = GetPopularBuddyBanner_args{
  getPopularBuddyBanner_args_language = P.maybe (getPopularBuddyBanner_args_language default_GetPopularBuddyBanner_args) (\(_,_val2283) -> (case _val2283 of {T.TString _val2284 -> E.decodeUtf8 _val2284; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getPopularBuddyBanner_args_country = P.maybe (getPopularBuddyBanner_args_country default_GetPopularBuddyBanner_args) (\(_,_val2283) -> (case _val2283 of {T.TString _val2285 -> E.decodeUtf8 _val2285; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getPopularBuddyBanner_args_applicationType = P.maybe (getPopularBuddyBanner_args_applicationType default_GetPopularBuddyBanner_args) (\(_,_val2283) -> (case _val2283 of {T.TI32 _val2286 -> P.toEnum $ P.fromIntegral _val2286; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getPopularBuddyBanner_args_resourceSpecification = P.maybe (getPopularBuddyBanner_args_resourceSpecification default_GetPopularBuddyBanner_args) (\(_,_val2283) -> (case _val2283 of {T.TString _val2287 -> E.decodeUtf8 _val2287; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetPopularBuddyBanner_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v2290 -> (1, ("e",from_TalkException _v2290))) <$> getPopularBuddyBanner_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v2290 -> P.Just (0, ("success",from_BuddyBanner _v2290))) $ getPopularBuddyBanner_result_success record
    , (\_v2290 -> (1, ("e",from_TalkException _v2290))) <$> getPopularBuddyBanner_result_e record
    ]
    )
...
to_GetPopularBuddyBanner_result (T.TStruct fields) = GetPopularBuddyBanner_result{
  getPopularBuddyBanner_result_success = P.maybe (getPopularBuddyBanner_result_success default_GetPopularBuddyBanner_result) (\(_,_val2292) -> (case _val2292 of {T.TStruct _val2293 -> (to_BuddyBanner (T.TStruct _val2293)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getPopularBuddyBanner_result_e = P.maybe (P.Nothing) (\(_,_val2292) -> P.Just (case _val2292 of {T.TStruct _val2294 -> (to_TalkException (T.TStruct _val2294)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetPopularBuddyLists_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v2297 -> P.Just (2, ("language",T.TString $ E.encodeUtf8 _v2297))) $ getPopularBuddyLists_args_language record
  , (\_v2297 -> P.Just (3, ("country",T.TString $ E.encodeUtf8 _v2297))) $ getPopularBuddyLists_args_country record
  ]
...
to_GetPopularBuddyLists_args (T.TStruct fields) = GetPopularBuddyLists_args{
  getPopularBuddyLists_args_language = P.maybe (getPopularBuddyLists_args_language default_GetPopularBuddyLists_args) (\(_,_val2299) -> (case _val2299 of {T.TString _val2300 -> E.decodeUtf8 _val2300; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getPopularBuddyLists_args_country = P.maybe (getPopularBuddyLists_args_country default_GetPopularBuddyLists_args) (\(_,_val2299) -> (case _val2299 of {T.TString _val2301 -> E.decodeUtf8 _val2301; _ -> P.error "wrong type"})) (Map.lookup (3) fields)
  }
...
from_GetPopularBuddyLists_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v2304 -> (1, ("e",from_TalkException _v2304))) <$> getPopularBuddyLists_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v2304 -> P.Just (0, ("success",T.TList (T.T_STRUCT typemap_BuddyList) $ P.map (\_v2306 -> from_BuddyList _v2306) $ Vector.toList _v2304))) $ getPopularBuddyLists_result_success record
    , (\_v2304 -> (1, ("e",from_TalkException _v2304))) <$> getPopularBuddyLists_result_e record
    ]
    )
...
to_GetPopularBuddyLists_result (T.TStruct fields) = GetPopularBuddyLists_result{
  getPopularBuddyLists_result_success = P.maybe (getPopularBuddyLists_result_success default_GetPopularBuddyLists_result) (\(_,_val2308) -> (case _val2308 of {T.TList _ _val2309 -> (Vector.fromList $ P.map (\_v2310 -> (case _v2310 of {T.TStruct _val2311 -> (to_BuddyList (T.TStruct _val2311)); _ -> P.error "wrong type"})) _val2309); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getPopularBuddyLists_result_e = P.maybe (P.Nothing) (\(_,_val2308) -> P.Just (case _val2308 of {T.TStruct _val2312 -> (to_TalkException (T.TStruct _val2312)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetPromotedBuddyContacts_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v2315 -> P.Just (2, ("language",T.TString $ E.encodeUtf8 _v2315))) $ getPromotedBuddyContacts_args_language record
  , (\_v2315 -> P.Just (3, ("country",T.TString $ E.encodeUtf8 _v2315))) $ getPromotedBuddyContacts_args_country record
  ]
...
to_GetPromotedBuddyContacts_args (T.TStruct fields) = GetPromotedBuddyContacts_args{
  getPromotedBuddyContacts_args_language = P.maybe (getPromotedBuddyContacts_args_language default_GetPromotedBuddyContacts_args) (\(_,_val2317) -> (case _val2317 of {T.TString _val2318 -> E.decodeUtf8 _val2318; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getPromotedBuddyContacts_args_country = P.maybe (getPromotedBuddyContacts_args_country default_GetPromotedBuddyContacts_args) (\(_,_val2317) -> (case _val2317 of {T.TString _val2319 -> E.decodeUtf8 _val2319; _ -> P.error "wrong type"})) (Map.lookup (3) fields)
  }
...
from_GetPromotedBuddyContacts_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v2322 -> (1, ("e",from_TalkException _v2322))) <$> getPromotedBuddyContacts_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v2322 -> P.Just (0, ("success",T.TList (T.T_STRUCT typemap_Contact) $ P.map (\_v2324 -> from_Contact _v2324) $ Vector.toList _v2322))) $ getPromotedBuddyContacts_result_success record
    , (\_v2322 -> (1, ("e",from_TalkException _v2322))) <$> getPromotedBuddyContacts_result_e record
    ]
    )
...
to_GetPromotedBuddyContacts_result (T.TStruct fields) = GetPromotedBuddyContacts_result{
  getPromotedBuddyContacts_result_success = P.maybe (getPromotedBuddyContacts_result_success default_GetPromotedBuddyContacts_result) (\(_,_val2326) -> (case _val2326 of {T.TList _ _val2327 -> (Vector.fromList $ P.map (\_v2328 -> (case _v2328 of {T.TStruct _val2329 -> (to_Contact (T.TStruct _val2329)); _ -> P.error "wrong type"})) _val2327); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getPromotedBuddyContacts_result_e = P.maybe (P.Nothing) (\(_,_val2326) -> P.Just (case _val2326 of {T.TStruct _val2330 -> (to_TalkException (T.TStruct _val2330)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
