...
from_BuyCoinProduct_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3089 -> P.Just (2, ("paymentReservation",from_PaymentReservation _v3089))) $ buyCoinProduct_args_paymentReservation record
  ]
...
to_BuyCoinProduct_args (T.TStruct fields) = BuyCoinProduct_args{
  buyCoinProduct_args_paymentReservation = P.maybe (buyCoinProduct_args_paymentReservation default_BuyCoinProduct_args) (\(_,_val3091) -> (case _val3091 of {T.TStruct _val3092 -> (to_PaymentReservation (T.TStruct _val3092)); _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_BuyCoinProduct_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3095 -> (1, ("e",from_TalkException _v3095))) <$> buyCoinProduct_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3095 -> (1, ("e",from_TalkException _v3095))) <$> buyCoinProduct_result_e record
    ]
    )
...
to_BuyCoinProduct_result (T.TStruct fields) = BuyCoinProduct_result{
  buyCoinProduct_result_e = P.maybe (P.Nothing) (\(_,_val3097) -> P.Just (case _val3097 of {T.TStruct _val3098 -> (to_TalkException (T.TStruct _val3098)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_BuyFreeProduct_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3101 -> P.Just (2, ("receiverMid",T.TString $ E.encodeUtf8 _v3101))) $ buyFreeProduct_args_receiverMid record
  , (\_v3101 -> P.Just (3, ("productId",T.TString $ E.encodeUtf8 _v3101))) $ buyFreeProduct_args_productId record
  , (\_v3101 -> P.Just (4, ("messageTemplate",T.TI32 _v3101))) $ buyFreeProduct_args_messageTemplate record
  , (\_v3101 -> P.Just (5, ("language",T.TString $ E.encodeUtf8 _v3101))) $ buyFreeProduct_args_language record
  , (\_v3101 -> P.Just (6, ("country",T.TString $ E.encodeUtf8 _v3101))) $ buyFreeProduct_args_country record
  , (\_v3101 -> P.Just (7, ("packageId",T.TI64 _v3101))) $ buyFreeProduct_args_packageId record
  ]
...
to_BuyFreeProduct_args (T.TStruct fields) = BuyFreeProduct_args{
  buyFreeProduct_args_receiverMid = P.maybe (buyFreeProduct_args_receiverMid default_BuyFreeProduct_args) (\(_,_val3103) -> (case _val3103 of {T.TString _val3104 -> E.decodeUtf8 _val3104; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  buyFreeProduct_args_productId = P.maybe (buyFreeProduct_args_productId default_BuyFreeProduct_args) (\(_,_val3103) -> (case _val3103 of {T.TString _val3105 -> E.decodeUtf8 _val3105; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  buyFreeProduct_args_messageTemplate = P.maybe (buyFreeProduct_args_messageTemplate default_BuyFreeProduct_args) (\(_,_val3103) -> (case _val3103 of {T.TI32 _val3106 -> _val3106; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  buyFreeProduct_args_language = P.maybe (buyFreeProduct_args_language default_BuyFreeProduct_args) (\(_,_val3103) -> (case _val3103 of {T.TString _val3107 -> E.decodeUtf8 _val3107; _ -> P.error "wrong type"})) (Map.lookup (5) fields),
  buyFreeProduct_args_country = P.maybe (buyFreeProduct_args_country default_BuyFreeProduct_args) (\(_,_val3103) -> (case _val3103 of {T.TString _val3108 -> E.decodeUtf8 _val3108; _ -> P.error "wrong type"})) (Map.lookup (6) fields),
  buyFreeProduct_args_packageId = P.maybe (buyFreeProduct_args_packageId default_BuyFreeProduct_args) (\(_,_val3103) -> (case _val3103 of {T.TI64 _val3109 -> _val3109; _ -> P.error "wrong type"})) (Map.lookup (7) fields)
  }
...
from_BuyFreeProduct_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3112 -> (1, ("e",from_TalkException _v3112))) <$> buyFreeProduct_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3112 -> (1, ("e",from_TalkException _v3112))) <$> buyFreeProduct_result_e record
    ]
    )
...
to_BuyFreeProduct_result (T.TStruct fields) = BuyFreeProduct_result{
  buyFreeProduct_result_e = P.maybe (P.Nothing) (\(_,_val3114) -> P.Just (case _val3114 of {T.TStruct _val3115 -> (to_TalkException (T.TStruct _val3115)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_BuyMustbuyProduct_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3118 -> P.Just (2, ("receiverMid",T.TString $ E.encodeUtf8 _v3118))) $ buyMustbuyProduct_args_receiverMid record
  , (\_v3118 -> P.Just (3, ("productId",T.TString $ E.encodeUtf8 _v3118))) $ buyMustbuyProduct_args_productId record
  , (\_v3118 -> P.Just (4, ("messageTemplate",T.TI32 _v3118))) $ buyMustbuyProduct_args_messageTemplate record
  , (\_v3118 -> P.Just (5, ("language",T.TString $ E.encodeUtf8 _v3118))) $ buyMustbuyProduct_args_language record
  , (\_v3118 -> P.Just (6, ("country",T.TString $ E.encodeUtf8 _v3118))) $ buyMustbuyProduct_args_country record
  , (\_v3118 -> P.Just (7, ("packageId",T.TI64 _v3118))) $ buyMustbuyProduct_args_packageId record
  , (\_v3118 -> P.Just (8, ("serialNumber",T.TString $ E.encodeUtf8 _v3118))) $ buyMustbuyProduct_args_serialNumber record
  ]
...
to_BuyMustbuyProduct_args (T.TStruct fields) = BuyMustbuyProduct_args{
  buyMustbuyProduct_args_receiverMid = P.maybe (buyMustbuyProduct_args_receiverMid default_BuyMustbuyProduct_args) (\(_,_val3120) -> (case _val3120 of {T.TString _val3121 -> E.decodeUtf8 _val3121; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  buyMustbuyProduct_args_productId = P.maybe (buyMustbuyProduct_args_productId default_BuyMustbuyProduct_args) (\(_,_val3120) -> (case _val3120 of {T.TString _val3122 -> E.decodeUtf8 _val3122; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  buyMustbuyProduct_args_messageTemplate = P.maybe (buyMustbuyProduct_args_messageTemplate default_BuyMustbuyProduct_args) (\(_,_val3120) -> (case _val3120 of {T.TI32 _val3123 -> _val3123; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  buyMustbuyProduct_args_language = P.maybe (buyMustbuyProduct_args_language default_BuyMustbuyProduct_args) (\(_,_val3120) -> (case _val3120 of {T.TString _val3124 -> E.decodeUtf8 _val3124; _ -> P.error "wrong type"})) (Map.lookup (5) fields),
  buyMustbuyProduct_args_country = P.maybe (buyMustbuyProduct_args_country default_BuyMustbuyProduct_args) (\(_,_val3120) -> (case _val3120 of {T.TString _val3125 -> E.decodeUtf8 _val3125; _ -> P.error "wrong type"})) (Map.lookup (6) fields),
  buyMustbuyProduct_args_packageId = P.maybe (buyMustbuyProduct_args_packageId default_BuyMustbuyProduct_args) (\(_,_val3120) -> (case _val3120 of {T.TI64 _val3126 -> _val3126; _ -> P.error "wrong type"})) (Map.lookup (7) fields),
  buyMustbuyProduct_args_serialNumber = P.maybe (buyMustbuyProduct_args_serialNumber default_BuyMustbuyProduct_args) (\(_,_val3120) -> (case _val3120 of {T.TString _val3127 -> E.decodeUtf8 _val3127; _ -> P.error "wrong type"})) (Map.lookup (8) fields)
  }
...
from_BuyMustbuyProduct_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3130 -> (1, ("e",from_TalkException _v3130))) <$> buyMustbuyProduct_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3130 -> (1, ("e",from_TalkException _v3130))) <$> buyMustbuyProduct_result_e record
    ]
    )
...
to_BuyMustbuyProduct_result (T.TStruct fields) = BuyMustbuyProduct_result{
  buyMustbuyProduct_result_e = P.maybe (P.Nothing) (\(_,_val3132) -> P.Just (case _val3132 of {T.TStruct _val3133 -> (to_TalkException (T.TStruct _val3133)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_CheckCanReceivePresent_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3136 -> P.Just (2, ("recipientMid",T.TString $ E.encodeUtf8 _v3136))) $ checkCanReceivePresent_args_recipientMid record
  , (\_v3136 -> P.Just (3, ("packageId",T.TI64 _v3136))) $ checkCanReceivePresent_args_packageId record
  , (\_v3136 -> P.Just (4, ("language",T.TString $ E.encodeUtf8 _v3136))) $ checkCanReceivePresent_args_language record
  , (\_v3136 -> P.Just (5, ("country",T.TString $ E.encodeUtf8 _v3136))) $ checkCanReceivePresent_args_country record
  ]
...
to_CheckCanReceivePresent_args (T.TStruct fields) = CheckCanReceivePresent_args{
  checkCanReceivePresent_args_recipientMid = P.maybe (checkCanReceivePresent_args_recipientMid default_CheckCanReceivePresent_args) (\(_,_val3138) -> (case _val3138 of {T.TString _val3139 -> E.decodeUtf8 _val3139; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  checkCanReceivePresent_args_packageId = P.maybe (checkCanReceivePresent_args_packageId default_CheckCanReceivePresent_args) (\(_,_val3138) -> (case _val3138 of {T.TI64 _val3140 -> _val3140; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  checkCanReceivePresent_args_language = P.maybe (checkCanReceivePresent_args_language default_CheckCanReceivePresent_args) (\(_,_val3138) -> (case _val3138 of {T.TString _val3141 -> E.decodeUtf8 _val3141; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  checkCanReceivePresent_args_country = P.maybe (checkCanReceivePresent_args_country default_CheckCanReceivePresent_args) (\(_,_val3138) -> (case _val3138 of {T.TString _val3142 -> E.decodeUtf8 _val3142; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_CheckCanReceivePresent_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3145 -> (1, ("e",from_TalkException _v3145))) <$> checkCanReceivePresent_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3145 -> (1, ("e",from_TalkException _v3145))) <$> checkCanReceivePresent_result_e record
    ]
    )
...
to_CheckCanReceivePresent_result (T.TStruct fields) = CheckCanReceivePresent_result{
  checkCanReceivePresent_result_e = P.maybe (P.Nothing) (\(_,_val3147) -> P.Just (case _val3147 of {T.TStruct _val3148 -> (to_TalkException (T.TStruct _val3148)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetActivePurchases_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3151 -> P.Just (2, ("start",T.TI64 _v3151))) $ getActivePurchases_args_start record
  , (\_v3151 -> P.Just (3, ("size",T.TI32 _v3151))) $ getActivePurchases_args_size record
  , (\_v3151 -> P.Just (4, ("language",T.TString $ E.encodeUtf8 _v3151))) $ getActivePurchases_args_language record
  , (\_v3151 -> P.Just (5, ("country",T.TString $ E.encodeUtf8 _v3151))) $ getActivePurchases_args_country record
  ]
...
to_GetActivePurchases_args (T.TStruct fields) = GetActivePurchases_args{
  getActivePurchases_args_start = P.maybe (getActivePurchases_args_start default_GetActivePurchases_args) (\(_,_val3153) -> (case _val3153 of {T.TI64 _val3154 -> _val3154; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getActivePurchases_args_size = P.maybe (getActivePurchases_args_size default_GetActivePurchases_args) (\(_,_val3153) -> (case _val3153 of {T.TI32 _val3155 -> _val3155; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getActivePurchases_args_language = P.maybe (getActivePurchases_args_language default_GetActivePurchases_args) (\(_,_val3153) -> (case _val3153 of {T.TString _val3156 -> E.decodeUtf8 _val3156; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getActivePurchases_args_country = P.maybe (getActivePurchases_args_country default_GetActivePurchases_args) (\(_,_val3153) -> (case _val3153 of {T.TString _val3157 -> E.decodeUtf8 _val3157; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetActivePurchases_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3160 -> (1, ("e",from_TalkException _v3160))) <$> getActivePurchases_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3160 -> P.Just (0, ("success",from_ProductList _v3160))) $ getActivePurchases_result_success record
    , (\_v3160 -> (1, ("e",from_TalkException _v3160))) <$> getActivePurchases_result_e record
    ]
    )
...
to_GetActivePurchases_result (T.TStruct fields) = GetActivePurchases_result{
  getActivePurchases_result_success = P.maybe (getActivePurchases_result_success default_GetActivePurchases_result) (\(_,_val3162) -> (case _val3162 of {T.TStruct _val3163 -> (to_ProductList (T.TStruct _val3163)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getActivePurchases_result_e = P.maybe (P.Nothing) (\(_,_val3162) -> P.Just (case _val3162 of {T.TStruct _val3164 -> (to_TalkException (T.TStruct _val3164)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetActivePurchaseVersions_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3167 -> P.Just (2, ("start",T.TI64 _v3167))) $ getActivePurchaseVersions_args_start record
  , (\_v3167 -> P.Just (3, ("size",T.TI32 _v3167))) $ getActivePurchaseVersions_args_size record
  , (\_v3167 -> P.Just (4, ("language",T.TString $ E.encodeUtf8 _v3167))) $ getActivePurchaseVersions_args_language record
  , (\_v3167 -> P.Just (5, ("country",T.TString $ E.encodeUtf8 _v3167))) $ getActivePurchaseVersions_args_country record
  ]
...
to_GetActivePurchaseVersions_args (T.TStruct fields) = GetActivePurchaseVersions_args{
  getActivePurchaseVersions_args_start = P.maybe (getActivePurchaseVersions_args_start default_GetActivePurchaseVersions_args) (\(_,_val3169) -> (case _val3169 of {T.TI64 _val3170 -> _val3170; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getActivePurchaseVersions_args_size = P.maybe (getActivePurchaseVersions_args_size default_GetActivePurchaseVersions_args) (\(_,_val3169) -> (case _val3169 of {T.TI32 _val3171 -> _val3171; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getActivePurchaseVersions_args_language = P.maybe (getActivePurchaseVersions_args_language default_GetActivePurchaseVersions_args) (\(_,_val3169) -> (case _val3169 of {T.TString _val3172 -> E.decodeUtf8 _val3172; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getActivePurchaseVersions_args_country = P.maybe (getActivePurchaseVersions_args_country default_GetActivePurchaseVersions_args) (\(_,_val3169) -> (case _val3169 of {T.TString _val3173 -> E.decodeUtf8 _val3173; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetActivePurchaseVersions_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3176 -> (1, ("e",from_TalkException _v3176))) <$> getActivePurchaseVersions_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3176 -> P.Just (0, ("success",from_ProductSimpleList _v3176))) $ getActivePurchaseVersions_result_success record
    , (\_v3176 -> (1, ("e",from_TalkException _v3176))) <$> getActivePurchaseVersions_result_e record
    ]
    )
...
to_GetActivePurchaseVersions_result (T.TStruct fields) = GetActivePurchaseVersions_result{
  getActivePurchaseVersions_result_success = P.maybe (getActivePurchaseVersions_result_success default_GetActivePurchaseVersions_result) (\(_,_val3178) -> (case _val3178 of {T.TStruct _val3179 -> (to_ProductSimpleList (T.TStruct _val3179)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getActivePurchaseVersions_result_e = P.maybe (P.Nothing) (\(_,_val3178) -> P.Just (case _val3178 of {T.TStruct _val3180 -> (to_TalkException (T.TStruct _val3180)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetCoinProducts_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3183 -> P.Just (2, ("appStoreCode",T.TI32 $ P.fromIntegral $ P.fromEnum _v3183))) $ getCoinProducts_args_appStoreCode record
  , (\_v3183 -> P.Just (3, ("country",T.TString $ E.encodeUtf8 _v3183))) $ getCoinProducts_args_country record
  , (\_v3183 -> P.Just (4, ("language",T.TString $ E.encodeUtf8 _v3183))) $ getCoinProducts_args_language record
  ]
...
to_GetCoinProducts_args (T.TStruct fields) = GetCoinProducts_args{
  getCoinProducts_args_appStoreCode = P.maybe (getCoinProducts_args_appStoreCode default_GetCoinProducts_args) (\(_,_val3185) -> (case _val3185 of {T.TI32 _val3186 -> P.toEnum $ P.fromIntegral _val3186; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getCoinProducts_args_country = P.maybe (getCoinProducts_args_country default_GetCoinProducts_args) (\(_,_val3185) -> (case _val3185 of {T.TString _val3187 -> E.decodeUtf8 _val3187; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getCoinProducts_args_language = P.maybe (getCoinProducts_args_language default_GetCoinProducts_args) (\(_,_val3185) -> (case _val3185 of {T.TString _val3188 -> E.decodeUtf8 _val3188; _ -> P.error "wrong type"})) (Map.lookup (4) fields)
  }
...
from_GetCoinProducts_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3191 -> (1, ("e",from_TalkException _v3191))) <$> getCoinProducts_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3191 -> P.Just (0, ("success",T.TList (T.T_STRUCT typemap_CoinProductItem) $ P.map (\_v3193 -> from_CoinProductItem _v3193) $ Vector.toList _v3191))) $ getCoinProducts_result_success record
    , (\_v3191 -> (1, ("e",from_TalkException _v3191))) <$> getCoinProducts_result_e record
    ]
    )
...
to_GetCoinProducts_result (T.TStruct fields) = GetCoinProducts_result{
  getCoinProducts_result_success = P.maybe (getCoinProducts_result_success default_GetCoinProducts_result) (\(_,_val3195) -> (case _val3195 of {T.TList _ _val3196 -> (Vector.fromList $ P.map (\_v3197 -> (case _v3197 of {T.TStruct _val3198 -> (to_CoinProductItem (T.TStruct _val3198)); _ -> P.error "wrong type"})) _val3196); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getCoinProducts_result_e = P.maybe (P.Nothing) (\(_,_val3195) -> P.Just (case _val3195 of {T.TStruct _val3199 -> (to_TalkException (T.TStruct _val3199)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetCoinProductsByPgCode_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3202 -> P.Just (2, ("appStoreCode",T.TI32 $ P.fromIntegral $ P.fromEnum _v3202))) $ getCoinProductsByPgCode_args_appStoreCode record
  , (\_v3202 -> P.Just (3, ("pgCode",T.TI32 $ P.fromIntegral $ P.fromEnum _v3202))) $ getCoinProductsByPgCode_args_pgCode record
  , (\_v3202 -> P.Just (4, ("country",T.TString $ E.encodeUtf8 _v3202))) $ getCoinProductsByPgCode_args_country record
  , (\_v3202 -> P.Just (5, ("language",T.TString $ E.encodeUtf8 _v3202))) $ getCoinProductsByPgCode_args_language record
  ]
...
to_GetCoinProductsByPgCode_args (T.TStruct fields) = GetCoinProductsByPgCode_args{
  getCoinProductsByPgCode_args_appStoreCode = P.maybe (getCoinProductsByPgCode_args_appStoreCode default_GetCoinProductsByPgCode_args) (\(_,_val3204) -> (case _val3204 of {T.TI32 _val3205 -> P.toEnum $ P.fromIntegral _val3205; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getCoinProductsByPgCode_args_pgCode = P.maybe (getCoinProductsByPgCode_args_pgCode default_GetCoinProductsByPgCode_args) (\(_,_val3204) -> (case _val3204 of {T.TI32 _val3206 -> P.toEnum $ P.fromIntegral _val3206; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getCoinProductsByPgCode_args_country = P.maybe (getCoinProductsByPgCode_args_country default_GetCoinProductsByPgCode_args) (\(_,_val3204) -> (case _val3204 of {T.TString _val3207 -> E.decodeUtf8 _val3207; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getCoinProductsByPgCode_args_language = P.maybe (getCoinProductsByPgCode_args_language default_GetCoinProductsByPgCode_args) (\(_,_val3204) -> (case _val3204 of {T.TString _val3208 -> E.decodeUtf8 _val3208; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetCoinProductsByPgCode_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3211 -> (1, ("e",from_TalkException _v3211))) <$> getCoinProductsByPgCode_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3211 -> P.Just (0, ("success",T.TList (T.T_STRUCT typemap_CoinProductItem) $ P.map (\_v3213 -> from_CoinProductItem _v3213) $ Vector.toList _v3211))) $ getCoinProductsByPgCode_result_success record
    , (\_v3211 -> (1, ("e",from_TalkException _v3211))) <$> getCoinProductsByPgCode_result_e record
    ]
    )
...
to_GetCoinProductsByPgCode_result (T.TStruct fields) = GetCoinProductsByPgCode_result{
  getCoinProductsByPgCode_result_success = P.maybe (getCoinProductsByPgCode_result_success default_GetCoinProductsByPgCode_result) (\(_,_val3215) -> (case _val3215 of {T.TList _ _val3216 -> (Vector.fromList $ P.map (\_v3217 -> (case _v3217 of {T.TStruct _val3218 -> (to_CoinProductItem (T.TStruct _val3218)); _ -> P.error "wrong type"})) _val3216); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getCoinProductsByPgCode_result_e = P.maybe (P.Nothing) (\(_,_val3215) -> P.Just (case _val3215 of {T.TStruct _val3219 -> (to_TalkException (T.TStruct _val3219)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetCoinPurchaseHistory_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3222 -> P.Just (2, ("request",from_CoinHistoryCondition _v3222))) $ getCoinPurchaseHistory_args_request record
  ]
...
to_GetCoinPurchaseHistory_args (T.TStruct fields) = GetCoinPurchaseHistory_args{
  getCoinPurchaseHistory_args_request = P.maybe (getCoinPurchaseHistory_args_request default_GetCoinPurchaseHistory_args) (\(_,_val3224) -> (case _val3224 of {T.TStruct _val3225 -> (to_CoinHistoryCondition (T.TStruct _val3225)); _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_GetCoinPurchaseHistory_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3228 -> (1, ("e",from_TalkException _v3228))) <$> getCoinPurchaseHistory_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3228 -> P.Just (0, ("success",from_CoinHistoryResult _v3228))) $ getCoinPurchaseHistory_result_success record
    , (\_v3228 -> (1, ("e",from_TalkException _v3228))) <$> getCoinPurchaseHistory_result_e record
    ]
    )
...
to_GetCoinPurchaseHistory_result (T.TStruct fields) = GetCoinPurchaseHistory_result{
  getCoinPurchaseHistory_result_success = P.maybe (getCoinPurchaseHistory_result_success default_GetCoinPurchaseHistory_result) (\(_,_val3230) -> (case _val3230 of {T.TStruct _val3231 -> (to_CoinHistoryResult (T.TStruct _val3231)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getCoinPurchaseHistory_result_e = P.maybe (P.Nothing) (\(_,_val3230) -> P.Just (case _val3230 of {T.TStruct _val3232 -> (to_TalkException (T.TStruct _val3232)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetCoinUseAndRefundHistory_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3235 -> P.Just (2, ("request",from_CoinHistoryCondition _v3235))) $ getCoinUseAndRefundHistory_args_request record
  ]
...
to_GetCoinUseAndRefundHistory_args (T.TStruct fields) = GetCoinUseAndRefundHistory_args{
  getCoinUseAndRefundHistory_args_request = P.maybe (getCoinUseAndRefundHistory_args_request default_GetCoinUseAndRefundHistory_args) (\(_,_val3237) -> (case _val3237 of {T.TStruct _val3238 -> (to_CoinHistoryCondition (T.TStruct _val3238)); _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_GetCoinUseAndRefundHistory_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3241 -> (1, ("e",from_TalkException _v3241))) <$> getCoinUseAndRefundHistory_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3241 -> P.Just (0, ("success",from_CoinHistoryResult _v3241))) $ getCoinUseAndRefundHistory_result_success record
    , (\_v3241 -> (1, ("e",from_TalkException _v3241))) <$> getCoinUseAndRefundHistory_result_e record
    ]
    )
...
to_GetCoinUseAndRefundHistory_result (T.TStruct fields) = GetCoinUseAndRefundHistory_result{
  getCoinUseAndRefundHistory_result_success = P.maybe (getCoinUseAndRefundHistory_result_success default_GetCoinUseAndRefundHistory_result) (\(_,_val3243) -> (case _val3243 of {T.TStruct _val3244 -> (to_CoinHistoryResult (T.TStruct _val3244)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getCoinUseAndRefundHistory_result_e = P.maybe (P.Nothing) (\(_,_val3243) -> P.Just (case _val3243 of {T.TStruct _val3245 -> (to_TalkException (T.TStruct _val3245)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetDownloads_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3248 -> P.Just (2, ("start",T.TI64 _v3248))) $ getDownloads_args_start record
  , (\_v3248 -> P.Just (3, ("size",T.TI32 _v3248))) $ getDownloads_args_size record
  , (\_v3248 -> P.Just (4, ("language",T.TString $ E.encodeUtf8 _v3248))) $ getDownloads_args_language record
  , (\_v3248 -> P.Just (5, ("country",T.TString $ E.encodeUtf8 _v3248))) $ getDownloads_args_country record
  ]
...
to_GetDownloads_args (T.TStruct fields) = GetDownloads_args{
  getDownloads_args_start = P.maybe (getDownloads_args_start default_GetDownloads_args) (\(_,_val3250) -> (case _val3250 of {T.TI64 _val3251 -> _val3251; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getDownloads_args_size = P.maybe (getDownloads_args_size default_GetDownloads_args) (\(_,_val3250) -> (case _val3250 of {T.TI32 _val3252 -> _val3252; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getDownloads_args_language = P.maybe (getDownloads_args_language default_GetDownloads_args) (\(_,_val3250) -> (case _val3250 of {T.TString _val3253 -> E.decodeUtf8 _val3253; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getDownloads_args_country = P.maybe (getDownloads_args_country default_GetDownloads_args) (\(_,_val3250) -> (case _val3250 of {T.TString _val3254 -> E.decodeUtf8 _val3254; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetDownloads_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3257 -> (1, ("e",from_TalkException _v3257))) <$> getDownloads_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3257 -> P.Just (0, ("success",from_ProductList _v3257))) $ getDownloads_result_success record
    , (\_v3257 -> (1, ("e",from_TalkException _v3257))) <$> getDownloads_result_e record
    ]
    )
...
to_GetDownloads_result (T.TStruct fields) = GetDownloads_result{
  getDownloads_result_success = P.maybe (getDownloads_result_success default_GetDownloads_result) (\(_,_val3259) -> (case _val3259 of {T.TStruct _val3260 -> (to_ProductList (T.TStruct _val3260)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getDownloads_result_e = P.maybe (P.Nothing) (\(_,_val3259) -> P.Just (case _val3259 of {T.TStruct _val3261 -> (to_TalkException (T.TStruct _val3261)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetEventPackages_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3264 -> P.Just (2, ("start",T.TI64 _v3264))) $ getEventPackages_args_start record
  , (\_v3264 -> P.Just (3, ("size",T.TI32 _v3264))) $ getEventPackages_args_size record
  , (\_v3264 -> P.Just (4, ("language",T.TString $ E.encodeUtf8 _v3264))) $ getEventPackages_args_language record
  , (\_v3264 -> P.Just (5, ("country",T.TString $ E.encodeUtf8 _v3264))) $ getEventPackages_args_country record
  ]
...
to_GetEventPackages_args (T.TStruct fields) = GetEventPackages_args{
  getEventPackages_args_start = P.maybe (getEventPackages_args_start default_GetEventPackages_args) (\(_,_val3266) -> (case _val3266 of {T.TI64 _val3267 -> _val3267; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getEventPackages_args_size = P.maybe (getEventPackages_args_size default_GetEventPackages_args) (\(_,_val3266) -> (case _val3266 of {T.TI32 _val3268 -> _val3268; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getEventPackages_args_language = P.maybe (getEventPackages_args_language default_GetEventPackages_args) (\(_,_val3266) -> (case _val3266 of {T.TString _val3269 -> E.decodeUtf8 _val3269; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getEventPackages_args_country = P.maybe (getEventPackages_args_country default_GetEventPackages_args) (\(_,_val3266) -> (case _val3266 of {T.TString _val3270 -> E.decodeUtf8 _val3270; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetEventPackages_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3273 -> (1, ("e",from_TalkException _v3273))) <$> getEventPackages_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3273 -> P.Just (0, ("success",from_ProductList _v3273))) $ getEventPackages_result_success record
    , (\_v3273 -> (1, ("e",from_TalkException _v3273))) <$> getEventPackages_result_e record
    ]
    )
...
to_GetEventPackages_result (T.TStruct fields) = GetEventPackages_result{
  getEventPackages_result_success = P.maybe (getEventPackages_result_success default_GetEventPackages_result) (\(_,_val3275) -> (case _val3275 of {T.TStruct _val3276 -> (to_ProductList (T.TStruct _val3276)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getEventPackages_result_e = P.maybe (P.Nothing) (\(_,_val3275) -> P.Just (case _val3275 of {T.TStruct _val3277 -> (to_TalkException (T.TStruct _val3277)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetNewlyReleasedPackages_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3280 -> P.Just (2, ("start",T.TI64 _v3280))) $ getNewlyReleasedPackages_args_start record
  , (\_v3280 -> P.Just (3, ("size",T.TI32 _v3280))) $ getNewlyReleasedPackages_args_size record
  , (\_v3280 -> P.Just (4, ("language",T.TString $ E.encodeUtf8 _v3280))) $ getNewlyReleasedPackages_args_language record
  , (\_v3280 -> P.Just (5, ("country",T.TString $ E.encodeUtf8 _v3280))) $ getNewlyReleasedPackages_args_country record
  ]
...
to_GetNewlyReleasedPackages_args (T.TStruct fields) = GetNewlyReleasedPackages_args{
  getNewlyReleasedPackages_args_start = P.maybe (getNewlyReleasedPackages_args_start default_GetNewlyReleasedPackages_args) (\(_,_val3282) -> (case _val3282 of {T.TI64 _val3283 -> _val3283; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getNewlyReleasedPackages_args_size = P.maybe (getNewlyReleasedPackages_args_size default_GetNewlyReleasedPackages_args) (\(_,_val3282) -> (case _val3282 of {T.TI32 _val3284 -> _val3284; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getNewlyReleasedPackages_args_language = P.maybe (getNewlyReleasedPackages_args_language default_GetNewlyReleasedPackages_args) (\(_,_val3282) -> (case _val3282 of {T.TString _val3285 -> E.decodeUtf8 _val3285; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getNewlyReleasedPackages_args_country = P.maybe (getNewlyReleasedPackages_args_country default_GetNewlyReleasedPackages_args) (\(_,_val3282) -> (case _val3282 of {T.TString _val3286 -> E.decodeUtf8 _val3286; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetNewlyReleasedPackages_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3289 -> (1, ("e",from_TalkException _v3289))) <$> getNewlyReleasedPackages_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3289 -> P.Just (0, ("success",from_ProductList _v3289))) $ getNewlyReleasedPackages_result_success record
    , (\_v3289 -> (1, ("e",from_TalkException _v3289))) <$> getNewlyReleasedPackages_result_e record
    ]
    )
...
to_GetNewlyReleasedPackages_result (T.TStruct fields) = GetNewlyReleasedPackages_result{
  getNewlyReleasedPackages_result_success = P.maybe (getNewlyReleasedPackages_result_success default_GetNewlyReleasedPackages_result) (\(_,_val3291) -> (case _val3291 of {T.TStruct _val3292 -> (to_ProductList (T.TStruct _val3292)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getNewlyReleasedPackages_result_e = P.maybe (P.Nothing) (\(_,_val3291) -> P.Just (case _val3291 of {T.TStruct _val3293 -> (to_TalkException (T.TStruct _val3293)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetPopularPackages_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3296 -> P.Just (2, ("start",T.TI64 _v3296))) $ getPopularPackages_args_start record
  , (\_v3296 -> P.Just (3, ("size",T.TI32 _v3296))) $ getPopularPackages_args_size record
  , (\_v3296 -> P.Just (4, ("language",T.TString $ E.encodeUtf8 _v3296))) $ getPopularPackages_args_language record
  , (\_v3296 -> P.Just (5, ("country",T.TString $ E.encodeUtf8 _v3296))) $ getPopularPackages_args_country record
  ]
...
to_GetPopularPackages_args (T.TStruct fields) = GetPopularPackages_args{
  getPopularPackages_args_start = P.maybe (getPopularPackages_args_start default_GetPopularPackages_args) (\(_,_val3298) -> (case _val3298 of {T.TI64 _val3299 -> _val3299; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getPopularPackages_args_size = P.maybe (getPopularPackages_args_size default_GetPopularPackages_args) (\(_,_val3298) -> (case _val3298 of {T.TI32 _val3300 -> _val3300; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getPopularPackages_args_language = P.maybe (getPopularPackages_args_language default_GetPopularPackages_args) (\(_,_val3298) -> (case _val3298 of {T.TString _val3301 -> E.decodeUtf8 _val3301; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getPopularPackages_args_country = P.maybe (getPopularPackages_args_country default_GetPopularPackages_args) (\(_,_val3298) -> (case _val3298 of {T.TString _val3302 -> E.decodeUtf8 _val3302; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetPopularPackages_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3305 -> (1, ("e",from_TalkException _v3305))) <$> getPopularPackages_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3305 -> P.Just (0, ("success",from_ProductList _v3305))) $ getPopularPackages_result_success record
    , (\_v3305 -> (1, ("e",from_TalkException _v3305))) <$> getPopularPackages_result_e record
    ]
    )
...
to_GetPopularPackages_result (T.TStruct fields) = GetPopularPackages_result{
  getPopularPackages_result_success = P.maybe (getPopularPackages_result_success default_GetPopularPackages_result) (\(_,_val3307) -> (case _val3307 of {T.TStruct _val3308 -> (to_ProductList (T.TStruct _val3308)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getPopularPackages_result_e = P.maybe (P.Nothing) (\(_,_val3307) -> P.Just (case _val3307 of {T.TStruct _val3309 -> (to_TalkException (T.TStruct _val3309)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetPresentsReceived_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3312 -> P.Just (2, ("start",T.TI64 _v3312))) $ getPresentsReceived_args_start record
  , (\_v3312 -> P.Just (3, ("size",T.TI32 _v3312))) $ getPresentsReceived_args_size record
  , (\_v3312 -> P.Just (4, ("language",T.TString $ E.encodeUtf8 _v3312))) $ getPresentsReceived_args_language record
  , (\_v3312 -> P.Just (5, ("country",T.TString $ E.encodeUtf8 _v3312))) $ getPresentsReceived_args_country record
  ]
...
to_GetPresentsReceived_args (T.TStruct fields) = GetPresentsReceived_args{
  getPresentsReceived_args_start = P.maybe (getPresentsReceived_args_start default_GetPresentsReceived_args) (\(_,_val3314) -> (case _val3314 of {T.TI64 _val3315 -> _val3315; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getPresentsReceived_args_size = P.maybe (getPresentsReceived_args_size default_GetPresentsReceived_args) (\(_,_val3314) -> (case _val3314 of {T.TI32 _val3316 -> _val3316; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getPresentsReceived_args_language = P.maybe (getPresentsReceived_args_language default_GetPresentsReceived_args) (\(_,_val3314) -> (case _val3314 of {T.TString _val3317 -> E.decodeUtf8 _val3317; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getPresentsReceived_args_country = P.maybe (getPresentsReceived_args_country default_GetPresentsReceived_args) (\(_,_val3314) -> (case _val3314 of {T.TString _val3318 -> E.decodeUtf8 _val3318; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetPresentsReceived_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3321 -> (1, ("e",from_TalkException _v3321))) <$> getPresentsReceived_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3321 -> P.Just (0, ("success",from_ProductList _v3321))) $ getPresentsReceived_result_success record
    , (\_v3321 -> (1, ("e",from_TalkException _v3321))) <$> getPresentsReceived_result_e record
    ]
    )
...
to_GetPresentsReceived_result (T.TStruct fields) = GetPresentsReceived_result{
  getPresentsReceived_result_success = P.maybe (getPresentsReceived_result_success default_GetPresentsReceived_result) (\(_,_val3323) -> (case _val3323 of {T.TStruct _val3324 -> (to_ProductList (T.TStruct _val3324)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getPresentsReceived_result_e = P.maybe (P.Nothing) (\(_,_val3323) -> P.Just (case _val3323 of {T.TStruct _val3325 -> (to_TalkException (T.TStruct _val3325)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetPresentsSent_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3328 -> P.Just (2, ("start",T.TI64 _v3328))) $ getPresentsSent_args_start record
  , (\_v3328 -> P.Just (3, ("size",T.TI32 _v3328))) $ getPresentsSent_args_size record
  , (\_v3328 -> P.Just (4, ("language",T.TString $ E.encodeUtf8 _v3328))) $ getPresentsSent_args_language record
  , (\_v3328 -> P.Just (5, ("country",T.TString $ E.encodeUtf8 _v3328))) $ getPresentsSent_args_country record
  ]
...
to_GetPresentsSent_args (T.TStruct fields) = GetPresentsSent_args{
  getPresentsSent_args_start = P.maybe (getPresentsSent_args_start default_GetPresentsSent_args) (\(_,_val3330) -> (case _val3330 of {T.TI64 _val3331 -> _val3331; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getPresentsSent_args_size = P.maybe (getPresentsSent_args_size default_GetPresentsSent_args) (\(_,_val3330) -> (case _val3330 of {T.TI32 _val3332 -> _val3332; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getPresentsSent_args_language = P.maybe (getPresentsSent_args_language default_GetPresentsSent_args) (\(_,_val3330) -> (case _val3330 of {T.TString _val3333 -> E.decodeUtf8 _val3333; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getPresentsSent_args_country = P.maybe (getPresentsSent_args_country default_GetPresentsSent_args) (\(_,_val3330) -> (case _val3330 of {T.TString _val3334 -> E.decodeUtf8 _val3334; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetPresentsSent_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3337 -> (1, ("e",from_TalkException _v3337))) <$> getPresentsSent_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3337 -> P.Just (0, ("success",from_ProductList _v3337))) $ getPresentsSent_result_success record
    , (\_v3337 -> (1, ("e",from_TalkException _v3337))) <$> getPresentsSent_result_e record
    ]
    )
...
to_GetPresentsSent_result (T.TStruct fields) = GetPresentsSent_result{
  getPresentsSent_result_success = P.maybe (getPresentsSent_result_success default_GetPresentsSent_result) (\(_,_val3339) -> (case _val3339 of {T.TStruct _val3340 -> (to_ProductList (T.TStruct _val3340)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getPresentsSent_result_e = P.maybe (P.Nothing) (\(_,_val3339) -> P.Just (case _val3339 of {T.TStruct _val3341 -> (to_TalkException (T.TStruct _val3341)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetProduct_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3344 -> P.Just (2, ("packageID",T.TI64 _v3344))) $ getProduct_args_packageID record
  , (\_v3344 -> P.Just (3, ("language",T.TString $ E.encodeUtf8 _v3344))) $ getProduct_args_language record
  , (\_v3344 -> P.Just (4, ("country",T.TString $ E.encodeUtf8 _v3344))) $ getProduct_args_country record
  ]
...
to_GetProduct_args (T.TStruct fields) = GetProduct_args{
  getProduct_args_packageID = P.maybe (getProduct_args_packageID default_GetProduct_args) (\(_,_val3346) -> (case _val3346 of {T.TI64 _val3347 -> _val3347; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getProduct_args_language = P.maybe (getProduct_args_language default_GetProduct_args) (\(_,_val3346) -> (case _val3346 of {T.TString _val3348 -> E.decodeUtf8 _val3348; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getProduct_args_country = P.maybe (getProduct_args_country default_GetProduct_args) (\(_,_val3346) -> (case _val3346 of {T.TString _val3349 -> E.decodeUtf8 _val3349; _ -> P.error "wrong type"})) (Map.lookup (4) fields)
  }
...
from_GetProduct_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3352 -> (1, ("e",from_TalkException _v3352))) <$> getProduct_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3352 -> P.Just (0, ("success",from_Product _v3352))) $ getProduct_result_success record
    , (\_v3352 -> (1, ("e",from_TalkException _v3352))) <$> getProduct_result_e record
    ]
    )
...
to_GetProduct_result (T.TStruct fields) = GetProduct_result{
  getProduct_result_success = P.maybe (getProduct_result_success default_GetProduct_result) (\(_,_val3354) -> (case _val3354 of {T.TStruct _val3355 -> (to_Product (T.TStruct _val3355)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getProduct_result_e = P.maybe (P.Nothing) (\(_,_val3354) -> P.Just (case _val3354 of {T.TStruct _val3356 -> (to_TalkException (T.TStruct _val3356)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetProductList_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3359 -> P.Just (2, ("productIdList",T.TList T.T_STRING $ P.map (\_v3361 -> T.TString $ E.encodeUtf8 _v3361) $ Vector.toList _v3359))) $ getProductList_args_productIdList record
  , (\_v3359 -> P.Just (3, ("language",T.TString $ E.encodeUtf8 _v3359))) $ getProductList_args_language record
  , (\_v3359 -> P.Just (4, ("country",T.TString $ E.encodeUtf8 _v3359))) $ getProductList_args_country record
  ]
...
to_GetProductList_args (T.TStruct fields) = GetProductList_args{
  getProductList_args_productIdList = P.maybe (getProductList_args_productIdList default_GetProductList_args) (\(_,_val3363) -> (case _val3363 of {T.TList _ _val3364 -> (Vector.fromList $ P.map (\_v3365 -> (case _v3365 of {T.TString _val3366 -> E.decodeUtf8 _val3366; _ -> P.error "wrong type"})) _val3364); _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getProductList_args_language = P.maybe (getProductList_args_language default_GetProductList_args) (\(_,_val3363) -> (case _val3363 of {T.TString _val3367 -> E.decodeUtf8 _val3367; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getProductList_args_country = P.maybe (getProductList_args_country default_GetProductList_args) (\(_,_val3363) -> (case _val3363 of {T.TString _val3368 -> E.decodeUtf8 _val3368; _ -> P.error "wrong type"})) (Map.lookup (4) fields)
  }
...
from_GetProductList_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3371 -> (1, ("e",from_TalkException _v3371))) <$> getProductList_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3371 -> P.Just (0, ("success",from_ProductList _v3371))) $ getProductList_result_success record
    , (\_v3371 -> (1, ("e",from_TalkException _v3371))) <$> getProductList_result_e record
    ]
    )
...
to_GetProductList_result (T.TStruct fields) = GetProductList_result{
  getProductList_result_success = P.maybe (getProductList_result_success default_GetProductList_result) (\(_,_val3373) -> (case _val3373 of {T.TStruct _val3374 -> (to_ProductList (T.TStruct _val3374)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getProductList_result_e = P.maybe (P.Nothing) (\(_,_val3373) -> P.Just (case _val3373 of {T.TStruct _val3375 -> (to_TalkException (T.TStruct _val3375)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetProductListWithCarrier_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3378 -> P.Just (2, ("productIdList",T.TList T.T_STRING $ P.map (\_v3380 -> T.TString $ E.encodeUtf8 _v3380) $ Vector.toList _v3378))) $ getProductListWithCarrier_args_productIdList record
  , (\_v3378 -> P.Just (3, ("language",T.TString $ E.encodeUtf8 _v3378))) $ getProductListWithCarrier_args_language record
  , (\_v3378 -> P.Just (4, ("country",T.TString $ E.encodeUtf8 _v3378))) $ getProductListWithCarrier_args_country record
  , (\_v3378 -> P.Just (5, ("carrierCode",T.TString $ E.encodeUtf8 _v3378))) $ getProductListWithCarrier_args_carrierCode record
  ]
...
to_GetProductListWithCarrier_args (T.TStruct fields) = GetProductListWithCarrier_args{
  getProductListWithCarrier_args_productIdList = P.maybe (getProductListWithCarrier_args_productIdList default_GetProductListWithCarrier_args) (\(_,_val3382) -> (case _val3382 of {T.TList _ _val3383 -> (Vector.fromList $ P.map (\_v3384 -> (case _v3384 of {T.TString _val3385 -> E.decodeUtf8 _val3385; _ -> P.error "wrong type"})) _val3383); _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getProductListWithCarrier_args_language = P.maybe (getProductListWithCarrier_args_language default_GetProductListWithCarrier_args) (\(_,_val3382) -> (case _val3382 of {T.TString _val3386 -> E.decodeUtf8 _val3386; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getProductListWithCarrier_args_country = P.maybe (getProductListWithCarrier_args_country default_GetProductListWithCarrier_args) (\(_,_val3382) -> (case _val3382 of {T.TString _val3387 -> E.decodeUtf8 _val3387; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getProductListWithCarrier_args_carrierCode = P.maybe (getProductListWithCarrier_args_carrierCode default_GetProductListWithCarrier_args) (\(_,_val3382) -> (case _val3382 of {T.TString _val3388 -> E.decodeUtf8 _val3388; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetProductListWithCarrier_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3391 -> (1, ("e",from_TalkException _v3391))) <$> getProductListWithCarrier_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3391 -> P.Just (0, ("success",from_ProductList _v3391))) $ getProductListWithCarrier_result_success record
    , (\_v3391 -> (1, ("e",from_TalkException _v3391))) <$> getProductListWithCarrier_result_e record
    ]
    )
...
to_GetProductListWithCarrier_result (T.TStruct fields) = GetProductListWithCarrier_result{
  getProductListWithCarrier_result_success = P.maybe (getProductListWithCarrier_result_success default_GetProductListWithCarrier_result) (\(_,_val3393) -> (case _val3393 of {T.TStruct _val3394 -> (to_ProductList (T.TStruct _val3394)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getProductListWithCarrier_result_e = P.maybe (P.Nothing) (\(_,_val3393) -> P.Just (case _val3393 of {T.TStruct _val3395 -> (to_TalkException (T.TStruct _val3395)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetProductWithCarrier_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3398 -> P.Just (2, ("packageID",T.TI64 _v3398))) $ getProductWithCarrier_args_packageID record
  , (\_v3398 -> P.Just (3, ("language",T.TString $ E.encodeUtf8 _v3398))) $ getProductWithCarrier_args_language record
  , (\_v3398 -> P.Just (4, ("country",T.TString $ E.encodeUtf8 _v3398))) $ getProductWithCarrier_args_country record
  , (\_v3398 -> P.Just (5, ("carrierCode",T.TString $ E.encodeUtf8 _v3398))) $ getProductWithCarrier_args_carrierCode record
  ]
...
to_GetProductWithCarrier_args (T.TStruct fields) = GetProductWithCarrier_args{
  getProductWithCarrier_args_packageID = P.maybe (getProductWithCarrier_args_packageID default_GetProductWithCarrier_args) (\(_,_val3400) -> (case _val3400 of {T.TI64 _val3401 -> _val3401; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getProductWithCarrier_args_language = P.maybe (getProductWithCarrier_args_language default_GetProductWithCarrier_args) (\(_,_val3400) -> (case _val3400 of {T.TString _val3402 -> E.decodeUtf8 _val3402; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getProductWithCarrier_args_country = P.maybe (getProductWithCarrier_args_country default_GetProductWithCarrier_args) (\(_,_val3400) -> (case _val3400 of {T.TString _val3403 -> E.decodeUtf8 _val3403; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getProductWithCarrier_args_carrierCode = P.maybe (getProductWithCarrier_args_carrierCode default_GetProductWithCarrier_args) (\(_,_val3400) -> (case _val3400 of {T.TString _val3404 -> E.decodeUtf8 _val3404; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetProductWithCarrier_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3407 -> (1, ("e",from_TalkException _v3407))) <$> getProductWithCarrier_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3407 -> P.Just (0, ("success",from_Product _v3407))) $ getProductWithCarrier_result_success record
    , (\_v3407 -> (1, ("e",from_TalkException _v3407))) <$> getProductWithCarrier_result_e record
    ]
    )
...
to_GetProductWithCarrier_result (T.TStruct fields) = GetProductWithCarrier_result{
  getProductWithCarrier_result_success = P.maybe (getProductWithCarrier_result_success default_GetProductWithCarrier_result) (\(_,_val3409) -> (case _val3409 of {T.TStruct _val3410 -> (to_Product (T.TStruct _val3410)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getProductWithCarrier_result_e = P.maybe (P.Nothing) (\(_,_val3409) -> P.Just (case _val3409 of {T.TStruct _val3411 -> (to_TalkException (T.TStruct _val3411)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetPurchaseHistory_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3414 -> P.Just (2, ("start",T.TI64 _v3414))) $ getPurchaseHistory_args_start record
  , (\_v3414 -> P.Just (3, ("size",T.TI32 _v3414))) $ getPurchaseHistory_args_size record
  , (\_v3414 -> P.Just (4, ("language",T.TString $ E.encodeUtf8 _v3414))) $ getPurchaseHistory_args_language record
  , (\_v3414 -> P.Just (5, ("country",T.TString $ E.encodeUtf8 _v3414))) $ getPurchaseHistory_args_country record
  ]
...
to_GetPurchaseHistory_args (T.TStruct fields) = GetPurchaseHistory_args{
  getPurchaseHistory_args_start = P.maybe (getPurchaseHistory_args_start default_GetPurchaseHistory_args) (\(_,_val3416) -> (case _val3416 of {T.TI64 _val3417 -> _val3417; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getPurchaseHistory_args_size = P.maybe (getPurchaseHistory_args_size default_GetPurchaseHistory_args) (\(_,_val3416) -> (case _val3416 of {T.TI32 _val3418 -> _val3418; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getPurchaseHistory_args_language = P.maybe (getPurchaseHistory_args_language default_GetPurchaseHistory_args) (\(_,_val3416) -> (case _val3416 of {T.TString _val3419 -> E.decodeUtf8 _val3419; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getPurchaseHistory_args_country = P.maybe (getPurchaseHistory_args_country default_GetPurchaseHistory_args) (\(_,_val3416) -> (case _val3416 of {T.TString _val3420 -> E.decodeUtf8 _val3420; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetPurchaseHistory_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3423 -> (1, ("e",from_TalkException _v3423))) <$> getPurchaseHistory_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3423 -> P.Just (0, ("success",from_ProductList _v3423))) $ getPurchaseHistory_result_success record
    , (\_v3423 -> (1, ("e",from_TalkException _v3423))) <$> getPurchaseHistory_result_e record
    ]
    )
...
to_GetPurchaseHistory_result (T.TStruct fields) = GetPurchaseHistory_result{
  getPurchaseHistory_result_success = P.maybe (getPurchaseHistory_result_success default_GetPurchaseHistory_result) (\(_,_val3425) -> (case _val3425 of {T.TStruct _val3426 -> (to_ProductList (T.TStruct _val3426)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getPurchaseHistory_result_e = P.maybe (P.Nothing) (\(_,_val3425) -> P.Just (case _val3425 of {T.TStruct _val3427 -> (to_TalkException (T.TStruct _val3427)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetTotalBalance_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3430 -> P.Just (2, ("appStoreCode",T.TI32 $ P.fromIntegral $ P.fromEnum _v3430))) $ getTotalBalance_args_appStoreCode record
  ]
...
to_GetTotalBalance_args (T.TStruct fields) = GetTotalBalance_args{
  getTotalBalance_args_appStoreCode = P.maybe (getTotalBalance_args_appStoreCode default_GetTotalBalance_args) (\(_,_val3432) -> (case _val3432 of {T.TI32 _val3433 -> P.toEnum $ P.fromIntegral _val3433; _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_GetTotalBalance_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3436 -> (1, ("e",from_TalkException _v3436))) <$> getTotalBalance_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3436 -> P.Just (0, ("success",from_Coin _v3436))) $ getTotalBalance_result_success record
    , (\_v3436 -> (1, ("e",from_TalkException _v3436))) <$> getTotalBalance_result_e record
    ]
    )
...
to_GetTotalBalance_result (T.TStruct fields) = GetTotalBalance_result{
  getTotalBalance_result_success = P.maybe (getTotalBalance_result_success default_GetTotalBalance_result) (\(_,_val3438) -> (case _val3438 of {T.TStruct _val3439 -> (to_Coin (T.TStruct _val3439)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getTotalBalance_result_e = P.maybe (P.Nothing) (\(_,_val3438) -> P.Just (case _val3438 of {T.TStruct _val3440 -> (to_TalkException (T.TStruct _val3440)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_NotifyDownloaded_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3443 -> P.Just (2, ("packageId",T.TI64 _v3443))) $ notifyDownloaded_args_packageId record
  , (\_v3443 -> P.Just (3, ("language",T.TString $ E.encodeUtf8 _v3443))) $ notifyDownloaded_args_language record
  ]
...
to_NotifyDownloaded_args (T.TStruct fields) = NotifyDownloaded_args{
  notifyDownloaded_args_packageId = P.maybe (notifyDownloaded_args_packageId default_NotifyDownloaded_args) (\(_,_val3445) -> (case _val3445 of {T.TI64 _val3446 -> _val3446; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  notifyDownloaded_args_language = P.maybe (notifyDownloaded_args_language default_NotifyDownloaded_args) (\(_,_val3445) -> (case _val3445 of {T.TString _val3447 -> E.decodeUtf8 _val3447; _ -> P.error "wrong type"})) (Map.lookup (3) fields)
  }
...
from_NotifyDownloaded_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3450 -> (1, ("e",from_TalkException _v3450))) <$> notifyDownloaded_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3450 -> P.Just (0, ("success",T.TI64 _v3450))) $ notifyDownloaded_result_success record
    , (\_v3450 -> (1, ("e",from_TalkException _v3450))) <$> notifyDownloaded_result_e record
    ]
    )
...
to_NotifyDownloaded_result (T.TStruct fields) = NotifyDownloaded_result{
  notifyDownloaded_result_success = P.maybe (notifyDownloaded_result_success default_NotifyDownloaded_result) (\(_,_val3452) -> (case _val3452 of {T.TI64 _val3453 -> _val3453; _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  notifyDownloaded_result_e = P.maybe (P.Nothing) (\(_,_val3452) -> P.Just (case _val3452 of {T.TStruct _val3454 -> (to_TalkException (T.TStruct _val3454)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_ReserveCoinPurchase_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3457 -> P.Just (2, ("request",from_CoinPurchaseReservation _v3457))) $ reserveCoinPurchase_args_request record
  ]
...
to_ReserveCoinPurchase_args (T.TStruct fields) = ReserveCoinPurchase_args{
  reserveCoinPurchase_args_request = P.maybe (reserveCoinPurchase_args_request default_ReserveCoinPurchase_args) (\(_,_val3459) -> (case _val3459 of {T.TStruct _val3460 -> (to_CoinPurchaseReservation (T.TStruct _val3460)); _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_ReserveCoinPurchase_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3463 -> (1, ("e",from_TalkException _v3463))) <$> reserveCoinPurchase_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3463 -> P.Just (0, ("success",from_PaymentReservationResult _v3463))) $ reserveCoinPurchase_result_success record
    , (\_v3463 -> (1, ("e",from_TalkException _v3463))) <$> reserveCoinPurchase_result_e record
    ]
    )
...
to_ReserveCoinPurchase_result (T.TStruct fields) = ReserveCoinPurchase_result{
  reserveCoinPurchase_result_success = P.maybe (reserveCoinPurchase_result_success default_ReserveCoinPurchase_result) (\(_,_val3465) -> (case _val3465 of {T.TStruct _val3466 -> (to_PaymentReservationResult (T.TStruct _val3466)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  reserveCoinPurchase_result_e = P.maybe (P.Nothing) (\(_,_val3465) -> P.Just (case _val3465 of {T.TStruct _val3467 -> (to_TalkException (T.TStruct _val3467)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_ReservePayment_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3470 -> P.Just (2, ("paymentReservation",from_PaymentReservation _v3470))) $ reservePayment_args_paymentReservation record
  ]
...
to_ReservePayment_args (T.TStruct fields) = ReservePayment_args{
  reservePayment_args_paymentReservation = P.maybe (reservePayment_args_paymentReservation default_ReservePayment_args) (\(_,_val3472) -> (case _val3472 of {T.TStruct _val3473 -> (to_PaymentReservation (T.TStruct _val3473)); _ -> P.error "wrong type"})) (Map.lookup (2) fields)
  }
...
from_ReservePayment_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3476 -> (1, ("e",from_TalkException _v3476))) <$> reservePayment_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3476 -> P.Just (0, ("success",from_PaymentReservationResult _v3476))) $ reservePayment_result_success record
    , (\_v3476 -> (1, ("e",from_TalkException _v3476))) <$> reservePayment_result_e record
    ]
    )
...
to_ReservePayment_result (T.TStruct fields) = ReservePayment_result{
  reservePayment_result_success = P.maybe (reservePayment_result_success default_ReservePayment_result) (\(_,_val3478) -> (case _val3478 of {T.TStruct _val3479 -> (to_PaymentReservationResult (T.TStruct _val3479)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  reservePayment_result_e = P.maybe (P.Nothing) (\(_,_val3478) -> P.Just (case _val3478 of {T.TStruct _val3480 -> (to_TalkException (T.TStruct _val3480)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
