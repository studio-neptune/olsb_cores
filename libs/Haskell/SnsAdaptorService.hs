...
from_GetSnsFriends_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3483 -> P.Just (2, ("snsIdType",T.TI32 $ P.fromIntegral $ P.fromEnum _v3483))) $ getSnsFriends_args_snsIdType record
  , (\_v3483 -> P.Just (3, ("snsAccessToken",T.TString $ E.encodeUtf8 _v3483))) $ getSnsFriends_args_snsAccessToken record
  , (\_v3483 -> P.Just (4, ("startIdx",T.TI32 _v3483))) $ getSnsFriends_args_startIdx record
  , (\_v3483 -> P.Just (5, ("limit",T.TI32 _v3483))) $ getSnsFriends_args_limit record
  ]
...
to_GetSnsFriends_args (T.TStruct fields) = GetSnsFriends_args{
  getSnsFriends_args_snsIdType = P.maybe (getSnsFriends_args_snsIdType default_GetSnsFriends_args) (\(_,_val3485) -> (case _val3485 of {T.TI32 _val3486 -> P.toEnum $ P.fromIntegral _val3486; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getSnsFriends_args_snsAccessToken = P.maybe (getSnsFriends_args_snsAccessToken default_GetSnsFriends_args) (\(_,_val3485) -> (case _val3485 of {T.TString _val3487 -> E.decodeUtf8 _val3487; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  getSnsFriends_args_startIdx = P.maybe (getSnsFriends_args_startIdx default_GetSnsFriends_args) (\(_,_val3485) -> (case _val3485 of {T.TI32 _val3488 -> _val3488; _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  getSnsFriends_args_limit = P.maybe (getSnsFriends_args_limit default_GetSnsFriends_args) (\(_,_val3485) -> (case _val3485 of {T.TI32 _val3489 -> _val3489; _ -> P.error "wrong type"})) (Map.lookup (5) fields)
  }
...
from_GetSnsFriends_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3492 -> (1, ("e",from_TalkException _v3492))) <$> getSnsFriends_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3492 -> P.Just (0, ("success",from_SnsFriends _v3492))) $ getSnsFriends_result_success record
    , (\_v3492 -> (1, ("e",from_TalkException _v3492))) <$> getSnsFriends_result_e record
    ]
    )
...
to_GetSnsFriends_result (T.TStruct fields) = GetSnsFriends_result{
  getSnsFriends_result_success = P.maybe (getSnsFriends_result_success default_GetSnsFriends_result) (\(_,_val3494) -> (case _val3494 of {T.TStruct _val3495 -> (to_SnsFriends (T.TStruct _val3495)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getSnsFriends_result_e = P.maybe (P.Nothing) (\(_,_val3494) -> P.Just (case _val3494 of {T.TStruct _val3496 -> (to_TalkException (T.TStruct _val3496)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_GetSnsMyProfile_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3499 -> P.Just (2, ("snsIdType",T.TI32 $ P.fromIntegral $ P.fromEnum _v3499))) $ getSnsMyProfile_args_snsIdType record
  , (\_v3499 -> P.Just (3, ("snsAccessToken",T.TString $ E.encodeUtf8 _v3499))) $ getSnsMyProfile_args_snsAccessToken record
  ]
...
to_GetSnsMyProfile_args (T.TStruct fields) = GetSnsMyProfile_args{
  getSnsMyProfile_args_snsIdType = P.maybe (getSnsMyProfile_args_snsIdType default_GetSnsMyProfile_args) (\(_,_val3501) -> (case _val3501 of {T.TI32 _val3502 -> P.toEnum $ P.fromIntegral _val3502; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  getSnsMyProfile_args_snsAccessToken = P.maybe (getSnsMyProfile_args_snsAccessToken default_GetSnsMyProfile_args) (\(_,_val3501) -> (case _val3501 of {T.TString _val3503 -> E.decodeUtf8 _val3503; _ -> P.error "wrong type"})) (Map.lookup (3) fields)
  }
...
from_GetSnsMyProfile_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3506 -> (1, ("e",from_TalkException _v3506))) <$> getSnsMyProfile_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3506 -> P.Just (0, ("success",from_SnsProfile _v3506))) $ getSnsMyProfile_result_success record
    , (\_v3506 -> (1, ("e",from_TalkException _v3506))) <$> getSnsMyProfile_result_e record
    ]
    )
...
to_GetSnsMyProfile_result (T.TStruct fields) = GetSnsMyProfile_result{
  getSnsMyProfile_result_success = P.maybe (getSnsMyProfile_result_success default_GetSnsMyProfile_result) (\(_,_val3508) -> (case _val3508 of {T.TStruct _val3509 -> (to_SnsProfile (T.TStruct _val3509)); _ -> P.error "wrong type"})) (Map.lookup (0) fields),
  getSnsMyProfile_result_e = P.maybe (P.Nothing) (\(_,_val3508) -> P.Just (case _val3508 of {T.TStruct _val3510 -> (to_TalkException (T.TStruct _val3510)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_PostSnsInvitationMessage_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v3513 -> P.Just (2, ("snsIdType",T.TI32 $ P.fromIntegral $ P.fromEnum _v3513))) $ postSnsInvitationMessage_args_snsIdType record
  , (\_v3513 -> P.Just (3, ("snsAccessToken",T.TString $ E.encodeUtf8 _v3513))) $ postSnsInvitationMessage_args_snsAccessToken record
  , (\_v3513 -> P.Just (4, ("toSnsUserId",T.TString $ E.encodeUtf8 _v3513))) $ postSnsInvitationMessage_args_toSnsUserId record
  ]
...
to_PostSnsInvitationMessage_args (T.TStruct fields) = PostSnsInvitationMessage_args{
  postSnsInvitationMessage_args_snsIdType = P.maybe (postSnsInvitationMessage_args_snsIdType default_PostSnsInvitationMessage_args) (\(_,_val3515) -> (case _val3515 of {T.TI32 _val3516 -> P.toEnum $ P.fromIntegral _val3516; _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  postSnsInvitationMessage_args_snsAccessToken = P.maybe (postSnsInvitationMessage_args_snsAccessToken default_PostSnsInvitationMessage_args) (\(_,_val3515) -> (case _val3515 of {T.TString _val3517 -> E.decodeUtf8 _val3517; _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  postSnsInvitationMessage_args_toSnsUserId = P.maybe (postSnsInvitationMessage_args_toSnsUserId default_PostSnsInvitationMessage_args) (\(_,_val3515) -> (case _val3515 of {T.TString _val3518 -> E.decodeUtf8 _val3518; _ -> P.error "wrong type"})) (Map.lookup (4) fields)
  }
...
from_PostSnsInvitationMessage_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v3521 -> (1, ("e",from_TalkException _v3521))) <$> postSnsInvitationMessage_result_e record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v3521 -> (1, ("e",from_TalkException _v3521))) <$> postSnsInvitationMessage_result_e record
    ]
    )
...
to_PostSnsInvitationMessage_result (T.TStruct fields) = PostSnsInvitationMessage_result{
  postSnsInvitationMessage_result_e = P.maybe (P.Nothing) (\(_,_val3523) -> P.Just (case _val3523 of {T.TStruct _val3524 -> (to_TalkException (T.TStruct _val3524)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
