            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.approvedChannelInfos = new java.util.ArrayList<ApprovedChannelInfo>(_list16.size);
                @org.apache.thrift.annotation.Nullable ApprovedChannelInfo _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = new ApprovedChannelInfo();
                  _elem17.read(iprot);
                  struct.approvedChannelInfos.add(_elem17);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.approvedChannelInfos = new java.util.ArrayList<ApprovedChannelInfo>(_list21.size);
          @org.apache.thrift.annotation.Nullable ApprovedChannelInfo _elem22;
          for (int _i23 = 0; _i23 < _list21.size; ++_i23)
          {
            _elem22 = new ApprovedChannelInfo();
            _elem22.read(iprot);
            struct.approvedChannelInfos.add(_elem22);
          }
        }
        struct.setApprovedChannelInfosIsSet(true);
      }
