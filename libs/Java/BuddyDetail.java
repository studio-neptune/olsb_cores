            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                @org.apache.thrift.annotation.Nullable ContentType _elem25;
                for (int _i26 = 0; _i26 < _set24.size; ++_i26)
                {
                  _elem25 = ContentType.findByValue(iprot.readI32());
                  if (_elem25 != null)
                  {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.acceptableContentTypes = java.util.EnumSet.noneOf(ContentType.class);
          @org.apache.thrift.annotation.Nullable ContentType _elem30;
          for (int _i31 = 0; _i31 < _set29.size; ++_i31)
          {
            _elem30 = ContentType.findByValue(iprot.readI32());
            if (_elem30 != null)
            {
