            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.parameterMap = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map78.size);
                ...
                for (int _i81 = 0; _i81 < _map78.size; ++_i81)
                {
                  ...
                  struct.parameterMap.put(_key79, _val80);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ChannelException struct) throws org.apache.thrift.TException {
      ...
      if (struct.parameterMap != null) {
        oprot.writeFieldBegin(PARAMETER_MAP_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter82 : struct.parameterMap.entrySet())
          {
      ...
      if (struct.isSetParameterMap()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter83 : struct.parameterMap.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.parameterMap = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map84.size);
          ...
          for (int _i87 = 0; _i87 < _map84.size; ++_i87)
          {
            ...
            struct.parameterMap.put(_key85, _val86);
          }
        }
        struct.setParameterMapIsSet(true);
      }
