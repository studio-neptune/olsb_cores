            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.channelInfos = new java.util.ArrayList<ChannelInfo>(_list96.size);
                @org.apache.thrift.annotation.Nullable ChannelInfo _elem97;
                for (int _i98 = 0; _i98 < _list96.size; ++_i98)
                {
                  _elem97 = new ChannelInfo();
                  _elem97.read(iprot);
                  struct.channelInfos.add(_elem97);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.channelDomains = new java.util.ArrayList<ChannelDomain>(_list99.size);
                @org.apache.thrift.annotation.Nullable ChannelDomain _elem100;
                for (int _i101 = 0; _i101 < _list99.size; ++_i101)
                {
                  _elem100 = new ChannelDomain();
                  _elem100.read(iprot);
                  struct.channelDomains.add(_elem100);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.channelInfos = new java.util.ArrayList<ChannelInfo>(_list106.size);
          @org.apache.thrift.annotation.Nullable ChannelInfo _elem107;
          for (int _i108 = 0; _i108 < _list106.size; ++_i108)
          {
            _elem107 = new ChannelInfo();
            _elem107.read(iprot);
            struct.channelInfos.add(_elem107);
          }
        }
        struct.setChannelInfosIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.channelDomains = new java.util.ArrayList<ChannelDomain>(_list109.size);
          @org.apache.thrift.annotation.Nullable ChannelDomain _elem110;
          for (int _i111 = 0; _i111 < _list109.size; ++_i111)
          {
            _elem110 = new ChannelDomain();
            _elem110.read(iprot);
            struct.channelDomains.add(_elem110);
          }
        }
        struct.setChannelDomainsIsSet(true);
      }
