            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.historys = new java.util.ArrayList<CoinHistory>(_list112.size);
                @org.apache.thrift.annotation.Nullable CoinHistory _elem113;
                for (int _i114 = 0; _i114 < _list112.size; ++_i114)
                {
                  _elem113 = new CoinHistory();
                  _elem113.read(iprot);
                  struct.historys.add(_elem113);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.historys = new java.util.ArrayList<CoinHistory>(_list117.size);
          @org.apache.thrift.annotation.Nullable CoinHistory _elem118;
          for (int _i119 = 0; _i119 < _list117.size; ++_i119)
          {
            _elem118 = new CoinHistory();
            _elem118.read(iprot);
            struct.historys.add(_elem118);
          }
        }
        struct.setHistorysIsSet(true);
      }
