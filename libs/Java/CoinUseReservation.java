            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.items = new java.util.ArrayList<CoinUseReservationItem>(_list120.size);
                @org.apache.thrift.annotation.Nullable CoinUseReservationItem _elem121;
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.items = new java.util.ArrayList<CoinUseReservationItem>(_list125.size);
          @org.apache.thrift.annotation.Nullable CoinUseReservationItem _elem126;
