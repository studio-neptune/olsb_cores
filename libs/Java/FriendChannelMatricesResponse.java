            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.matrices = new java.util.ArrayList<FriendChannelMatrix>(_list152.size);
                @org.apache.thrift.annotation.Nullable FriendChannelMatrix _elem153;
                for (int _i154 = 0; _i154 < _list152.size; ++_i154)
                {
                  _elem153 = new FriendChannelMatrix();
                  _elem153.read(iprot);
                  struct.matrices.add(_elem153);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.matrices = new java.util.ArrayList<FriendChannelMatrix>(_list157.size);
          @org.apache.thrift.annotation.Nullable FriendChannelMatrix _elem158;
          for (int _i159 = 0; _i159 < _list157.size; ++_i159)
          {
            _elem158 = new FriendChannelMatrix();
            _elem158.read(iprot);
            struct.matrices.add(_elem158);
          }
        }
        struct.setMatricesIsSet(true);
      }
