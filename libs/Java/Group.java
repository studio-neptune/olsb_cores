            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.members = new java.util.ArrayList<Contact>(_list168.size);
                @org.apache.thrift.annotation.Nullable Contact _elem169;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.invitee = new java.util.ArrayList<Contact>(_list171.size);
                @org.apache.thrift.annotation.Nullable Contact _elem172;
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.members = new java.util.ArrayList<Contact>(_list178.size);
          @org.apache.thrift.annotation.Nullable Contact _elem179;
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.invitee = new java.util.ArrayList<Contact>(_list181.size);
          @org.apache.thrift.annotation.Nullable Contact _elem182;
