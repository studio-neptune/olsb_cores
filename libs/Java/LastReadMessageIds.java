            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.lastReadMessageIds = new java.util.ArrayList<LastReadMessageId>(_list184.size);
                @org.apache.thrift.annotation.Nullable LastReadMessageId _elem185;
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.lastReadMessageIds = new java.util.ArrayList<LastReadMessageId>(_list189.size);
          @org.apache.thrift.annotation.Nullable LastReadMessageId _elem190;
