            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.operations = new java.util.ArrayList<MessageOperation>(_list202.size);
                @org.apache.thrift.annotation.Nullable MessageOperation _elem203;
                for (int _i204 = 0; _i204 < _list202.size; ++_i204)
                {
                  _elem203 = new MessageOperation();
                  _elem203.read(iprot);
                  struct.operations.add(_elem203);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MessageOperations struct) throws org.apache.thrift.TException {
      ...
      if (struct.operations != null) {
        oprot.writeFieldBegin(OPERATIONS_FIELD_DESC);
        {
          ...
          for (MessageOperation _iter205 : struct.operations)
          {
      ...
      if (struct.isSetOperations()) {
        {
          ...
          for (MessageOperation _iter206 : struct.operations)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.operations = new java.util.ArrayList<MessageOperation>(_list207.size);
          @org.apache.thrift.annotation.Nullable MessageOperation _elem208;
          for (int _i209 = 0; _i209 < _list207.size; ++_i209)
          {
            _elem208 = new MessageOperation();
            _elem208.read(iprot);
            struct.operations.add(_elem208);
          }
        }
        struct.setOperationsIsSet(true);
      }
