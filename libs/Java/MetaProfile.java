...
public class MetaProfile implements org.apache.thrift.TBase<MetaProfile, MetaProfile._Fields>, java.io.Serializable, Cloneable, Comparable<MetaProfile> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                @org.apache.thrift.annotation.Nullable RegistrationType _key211;
                @org.apache.thrift.annotation.Nullable java.lang.String _val212;
                for (int _i213 = 0; _i213 < _map210.size; ++_i213)
                {
                  _key211 = RegistrationType.findByValue(iprot.readI32());
                  _val212 = iprot.readString();
                  if (_key211 != null)
                  {
                    struct.identities.put(_key211, _val212);
                  }
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MetaProfile struct) throws org.apache.thrift.TException {
      ...
      if (struct.identities != null) {
        oprot.writeFieldBegin(IDENTITIES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<RegistrationType, java.lang.String> _iter214 : struct.identities.entrySet())
          {
            oprot.writeI32(_iter214.getKey().getValue());
  ...
  private static class MetaProfileTupleScheme extends org.apache.thrift.scheme.TupleScheme<MetaProfile> {
      ...
      if (struct.isSetIdentities()) {
        {
          ...
          for (java.util.Map.Entry<RegistrationType, java.lang.String> _iter215 : struct.identities.entrySet())
          {
            oprot.writeI32(_iter215.getKey().getValue());
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, MetaProfile struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TMap _map216 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.identities = new java.util.EnumMap<RegistrationType,java.lang.String>(RegistrationType.class);
          @org.apache.thrift.annotation.Nullable RegistrationType _key217;
          @org.apache.thrift.annotation.Nullable java.lang.String _val218;
          for (int _i219 = 0; _i219 < _map216.size; ++_i219)
          {
            _key217 = RegistrationType.findByValue(iprot.readI32());
            _val218 = iprot.readString();
            if (_key217 != null)
            {
              struct.identities.put(_key217, _val218);
            }
          }
        }
        struct.setIdentitiesIsSet(true);
