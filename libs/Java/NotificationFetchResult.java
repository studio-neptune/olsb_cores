            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.itemList = new java.util.ArrayList<NotificationItem>(_list230.size);
                @org.apache.thrift.annotation.Nullable NotificationItem _elem231;
                for (int _i232 = 0; _i232 < _list230.size; ++_i232)
                {
                  _elem231 = new NotificationItem();
                  _elem231.read(iprot);
                  struct.itemList.add(_elem231);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, NotificationFetchResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.itemList != null) {
        oprot.writeFieldBegin(ITEM_LIST_FIELD_DESC);
        {
          ...
          for (NotificationItem _iter233 : struct.itemList)
          {
      ...
      if (struct.isSetItemList()) {
        {
          ...
          for (NotificationItem _iter234 : struct.itemList)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.itemList = new java.util.ArrayList<NotificationItem>(_list235.size);
          @org.apache.thrift.annotation.Nullable NotificationItem _elem236;
          for (int _i237 = 0; _i237 < _list235.size; ++_i237)
          {
            _elem236 = new NotificationItem();
            _elem236.read(iprot);
            struct.itemList.add(_elem236);
          }
        }
        struct.setItemListIsSet(true);
      }
