            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.extras = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map238.size);
                ...
                for (int _i241 = 0; _i241 < _map238.size; ++_i241)
                {
                  ...
                  struct.extras.put(_key239, _val240);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PaymentReservationResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.extras != null) {
        oprot.writeFieldBegin(EXTRAS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter242 : struct.extras.entrySet())
          {
      ...
      if (struct.isSetExtras()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter243 : struct.extras.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.extras = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map244.size);
          ...
          for (int _i247 = 0; _i247 < _map244.size; ++_i247)
          {
            ...
            struct.extras.put(_key245, _val246);
          }
        }
        struct.setExtrasIsSet(true);
      }
