            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.productList = new java.util.ArrayList<Product>(_list248.size);
                @org.apache.thrift.annotation.Nullable Product _elem249;
                for (int _i250 = 0; _i250 < _list248.size; ++_i250)
                {
                  _elem249 = new Product();
                  _elem249.read(iprot);
                  struct.productList.add(_elem249);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ProductList struct) throws org.apache.thrift.TException {
      ...
      if (struct.productList != null) {
        oprot.writeFieldBegin(PRODUCT_LIST_FIELD_DESC);
        {
          ...
          for (Product _iter251 : struct.productList)
          {
      ...
      if (struct.isSetProductList()) {
        {
          ...
          for (Product _iter252 : struct.productList)
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.productList = new java.util.ArrayList<Product>(_list253.size);
          @org.apache.thrift.annotation.Nullable Product _elem254;
          for (int _i255 = 0; _i255 < _list253.size; ++_i255)
          {
            _elem254 = new Product();
            _elem254.read(iprot);
            struct.productList.add(_elem254);
          }
        }
        struct.setProductListIsSet(true);
      }
