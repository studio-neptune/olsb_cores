            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.productList = new java.util.ArrayList<ProductSimple>(_list256.size);
                @org.apache.thrift.annotation.Nullable ProductSimple _elem257;
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.productList = new java.util.ArrayList<ProductSimple>(_list261.size);
          @org.apache.thrift.annotation.Nullable ProductSimple _elem262;
