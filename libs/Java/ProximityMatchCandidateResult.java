            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.users = new java.util.ArrayList<Contact>(_list264.size);
                @org.apache.thrift.annotation.Nullable Contact _elem265;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.buddies = new java.util.ArrayList<Contact>(_list267.size);
                @org.apache.thrift.annotation.Nullable Contact _elem268;
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.users = new java.util.ArrayList<Contact>(_list274.size);
          @org.apache.thrift.annotation.Nullable Contact _elem275;
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.buddies = new java.util.ArrayList<Contact>(_list277.size);
          @org.apache.thrift.annotation.Nullable Contact _elem278;
