            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.contacts = new java.util.ArrayList<Contact>(_list42.size);
                Contact _elem43;
                for (int _i44 = 0; _i44 < _list42.size; ++_i44)
                {
                  _elem43 = new Contact();
                  _elem43.read(iprot);
                  struct.contacts.add(_elem43);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Room struct) throws org.apache.thrift.TException {
      ...
      if (struct.contacts != null) {
        oprot.writeFieldBegin(CONTACTS_FIELD_DESC);
        {
          ...
          for (Contact _iter45 : struct.contacts)
          {
            _iter45.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetContacts()) {
        {
          ...
          for (Contact _iter46 : struct.contacts)
          {
            _iter46.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.contacts = new java.util.ArrayList<Contact>(_list47.size);
          Contact _elem48;
          for (int _i49 = 0; _i49 < _list47.size; ++_i49)
          {
            _elem48 = new Contact();
            _elem48.read(iprot);
            struct.contacts.add(_elem48);
          }
        }
        struct.setContactsIsSet(true);
      }
