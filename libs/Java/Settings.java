            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                @org.apache.thrift.annotation.Nullable CustomMode _key293;
                @org.apache.thrift.annotation.Nullable java.lang.String _val294;
                for (int _i295 = 0; _i295 < _map292.size; ++_i295)
                {
                  _key293 = CustomMode.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Settings struct) throws org.apache.thrift.TException {
      ...
      if (struct.snsAccounts != null) {
        oprot.writeFieldBegin(SNS_ACCOUNTS_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<SnsIdType, java.lang.String> _iter296 : struct.snsAccounts.entrySet())
          {
      ...
      if (struct.customModes != null) {
        oprot.writeFieldBegin(CUSTOM_MODES_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<CustomMode, java.lang.String> _iter297 : struct.customModes.entrySet())
          {
      ...
      if (struct.isSetSnsAccounts()) {
        {
          ...
          for (java.util.Map.Entry<SnsIdType, java.lang.String> _iter298 : struct.snsAccounts.entrySet())
          {
      ...
      if (struct.isSetCustomModes()) {
        {
          ...
          for (java.util.Map.Entry<CustomMode, java.lang.String> _iter299 : struct.customModes.entrySet())
          {
