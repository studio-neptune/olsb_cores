            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.snsFriends = new java.util.ArrayList<SnsFriend>(_list308.size);
                @org.apache.thrift.annotation.Nullable SnsFriend _elem309;
                for (int _i310 = 0; _i310 < _list308.size; ++_i310)
                {
                  _elem309 = new SnsFriend();
                  _elem309.read(iprot);
                  struct.snsFriends.add(_elem309);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SnsFriends struct) throws org.apache.thrift.TException {
      ...
      if (struct.snsFriends != null) {
        oprot.writeFieldBegin(SNS_FRIENDS_FIELD_DESC);
        {
          ...
          for (SnsFriend _iter311 : struct.snsFriends)
          {
      ...
      if (struct.isSetSnsFriends()) {
        {
          ...
          for (SnsFriend _iter312 : struct.snsFriends)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.snsFriends = new java.util.ArrayList<SnsFriend>(_list313.size);
          @org.apache.thrift.annotation.Nullable SnsFriend _elem314;
          for (int _i315 = 0; _i315 < _list313.size; ++_i315)
          {
            _elem314 = new SnsFriend();
            _elem314.read(iprot);
            struct.snsFriends.add(_elem314);
          }
        }
        struct.setSnsFriendsIsSet(true);
      }
