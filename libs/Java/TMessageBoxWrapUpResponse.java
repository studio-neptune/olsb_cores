            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.messageBoxWrapUpList = new java.util.ArrayList<TMessageBoxWrapUp>(_list342.size);
                @org.apache.thrift.annotation.Nullable TMessageBoxWrapUp _elem343;
                for (int _i344 = 0; _i344 < _list342.size; ++_i344)
                {
                  _elem343 = new TMessageBoxWrapUp();
                  _elem343.read(iprot);
                  struct.messageBoxWrapUpList.add(_elem343);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TMessageBoxWrapUpResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.messageBoxWrapUpList != null) {
        oprot.writeFieldBegin(MESSAGE_BOX_WRAP_UP_LIST_FIELD_DESC);
        {
          ...
          for (TMessageBoxWrapUp _iter345 : struct.messageBoxWrapUpList)
          {
      ...
      if (struct.isSetMessageBoxWrapUpList()) {
        {
          ...
          for (TMessageBoxWrapUp _iter346 : struct.messageBoxWrapUpList)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.messageBoxWrapUpList = new java.util.ArrayList<TMessageBoxWrapUp>(_list347.size);
          @org.apache.thrift.annotation.Nullable TMessageBoxWrapUp _elem348;
          for (int _i349 = 0; _i349 < _list347.size; ++_i349)
          {
            _elem348 = new TMessageBoxWrapUp();
            _elem348.read(iprot);
            struct.messageBoxWrapUpList.add(_elem348);
          }
        }
        struct.setMessageBoxWrapUpListIsSet(true);
      }
