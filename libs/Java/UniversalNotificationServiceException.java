            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.parameterMap = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map350.size);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UniversalNotificationServiceException struct) throws org.apache.thrift.TException {
      ...
      if (struct.parameterMap != null) {
        oprot.writeFieldBegin(PARAMETER_MAP_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter354 : struct.parameterMap.entrySet())
          {
      ...
      if (struct.isSetParameterMap()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter355 : struct.parameterMap.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.parameterMap = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map356.size);
