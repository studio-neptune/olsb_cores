            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.availableVerificationMethods = new java.util.ArrayList<VerificationMethod>(_list368.size);
                @org.apache.thrift.annotation.Nullable VerificationMethod _elem369;
                for (int _i370 = 0; _i370 < _list368.size; ++_i370)
                {
                  _elem369 = VerificationMethod.findByValue(iprot.readI32());
                  if (_elem369 != null)
                  {
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.availableVerificationMethods = new java.util.ArrayList<VerificationMethod>(_list373.size);
          @org.apache.thrift.annotation.Nullable VerificationMethod _elem374;
          for (int _i375 = 0; _i375 < _list373.size; ++_i375)
          {
            _elem374 = VerificationMethod.findByValue(iprot.readI32());
            if (_elem374 != null)
            {
