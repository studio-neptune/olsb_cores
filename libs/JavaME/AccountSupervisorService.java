            ...
            if (field.type == TType.MAP) {
              {
                ...
                this.parameterMap = new Hashtable(2*_map188.size);
                for (int _i189 = 0; _i189 < _map188.size; ++_i189)
                {
                  ...
                  this.parameterMap.put(_key190, _val191);
                }
                iprot.readMapEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.parameterMap != null) {
        oprot.writeFieldBegin(PARAMETER_MAP_FIELD_DESC);
        {
          ...
          for (Enumeration _iter192_enum = this.parameterMap.keys(); _iter192_enum.hasMoreElements(); )           {
            String _iter192 = (String)_iter192_enum.nextElement();
            oprot.writeString(_iter192);
            oprot.writeString(((String)this.parameterMap.get(_iter192)));
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
