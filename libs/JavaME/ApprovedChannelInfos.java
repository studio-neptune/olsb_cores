          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.approvedChannelInfos = new Vector(_list8.size);
              for (int _i9 = 0; _i9 < _list8.size; ++_i9)
              {
                ApprovedChannelInfo _elem10;
                _elem10 = new ApprovedChannelInfo();
                _elem10.read(iprot);
                this.approvedChannelInfos.addElement(_elem10);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.approvedChannelInfos != null) {
      oprot.writeFieldBegin(APPROVED_CHANNEL_INFOS_FIELD_DESC);
      {
        ...
        for (Enumeration _iter11_enum = this.approvedChannelInfos.elements(); _iter11_enum.hasMoreElements(); )         {
          ApprovedChannelInfo _iter11 = (ApprovedChannelInfo)_iter11_enum.nextElement();
          _iter11.write(oprot);
        }
        oprot.writeListEnd();
      }
