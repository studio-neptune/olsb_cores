          ...
          if (field.type == TType.SET) {
            {
              ...
              this.acceptableContentTypes = new Hashtable(2*_set12.size);
              for (int _i13 = 0; _i13 < _set12.size; ++_i13)
              {
                ContentType _elem14;
                _elem14 = ContentType.findByValue(iprot.readI32());
                this.acceptableContentTypes.put(_elem14, _elem14);
              }
              iprot.readSetEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.acceptableContentTypes != null) {
      oprot.writeFieldBegin(ACCEPTABLE_CONTENT_TYPES_FIELD_DESC);
      {
        ...
        for (Enumeration _iter15_enum = this.acceptableContentTypes.keys(); _iter15_enum.hasMoreElements(); )         {
          ContentType _iter15 = (ContentType)_iter15_enum.nextElement();
