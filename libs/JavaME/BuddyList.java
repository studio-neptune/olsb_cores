          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.popularContacts = new Vector(_list16.size);
              for (int _i17 = 0; _i17 < _list16.size; ++_i17)
              {
                Contact _elem18;
                _elem18 = new Contact();
                _elem18.read(iprot);
                this.popularContacts.addElement(_elem18);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.popularContacts != null) {
      oprot.writeFieldBegin(POPULAR_CONTACTS_FIELD_DESC);
      {
        ...
        for (Enumeration _iter19_enum = this.popularContacts.elements(); _iter19_enum.hasMoreElements(); )         {
          Contact _iter19 = (Contact)_iter19_enum.nextElement();
          _iter19.write(oprot);
        }
        oprot.writeListEnd();
      }
