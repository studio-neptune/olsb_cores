            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.userMids = new Vector(_list193.size);
                for (int _i194 = 0; _i194 < _list193.size; ++_i194)
                {
                  String _elem195;
                  _elem195 = iprot.readString();
                  this.userMids.addElement(_elem195);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.userMids != null) {
        oprot.writeFieldBegin(USER_MIDS_FIELD_DESC);
        {
          ...
          for (Enumeration _iter196_enum = this.userMids.elements(); _iter196_enum.hasMoreElements(); )           {
            String _iter196 = (String)_iter196_enum.nextElement();
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.requestIdList = new Vector(_list197.size);
                for (int _i198 = 0; _i198 < _list197.size; ++_i198)
                {
                  String _elem199;
                  _elem199 = iprot.readString();
                  this.requestIdList.addElement(_elem199);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.requestIdList != null) {
        oprot.writeFieldBegin(REQUEST_ID_LIST_FIELD_DESC);
        {
          ...
          for (Enumeration _iter200_enum = this.requestIdList.elements(); _iter200_enum.hasMoreElements(); )           {
            String _iter200 = (String)_iter200_enum.nextElement();
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new Vector(_list201.size);
                for (int _i202 = 0; _i202 < _list201.size; ++_i202)
                {
                  SendBuddyMessageResult _elem203;
                  _elem203 = new SendBuddyMessageResult();
                  _elem203.read(iprot);
                  this.success.addElement(_elem203);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for (Enumeration _iter204_enum = this.success.elements(); _iter204_enum.hasMoreElements(); )           {
            SendBuddyMessageResult _iter204 = (SendBuddyMessageResult)_iter204_enum.nextElement();
  ...
  public static class commitSendMessagesToMids_args implements TBase   {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.requestIdList = new Vector(_list205.size);
                for (int _i206 = 0; _i206 < _list205.size; ++_i206)
                {
                  String _elem207;
                  _elem207 = iprot.readString();
                  this.requestIdList.addElement(_elem207);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.requestIdList != null) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRING, this.requestIdList.size()));
          for (Enumeration _iter211_enum = this.requestIdList.elements(); _iter211_enum.hasMoreElements(); )           {
            String _iter211 = (String)_iter211_enum.nextElement();
      ...
      if (this.mids != null) {
        oprot.writeFieldBegin(MIDS_FIELD_DESC);
        {
          ...
          for (Enumeration _iter212_enum = this.mids.elements(); _iter212_enum.hasMoreElements(); )           {
            String _iter212 = (String)_iter212_enum.nextElement();
  ...
  public static class commitSendMessagesToMids_result implements TBase   {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new Vector(_list213.size);
                for (int _i214 = 0; _i214 < _list213.size; ++_i214)
                {
                  SendBuddyMessageResult _elem215;
                  _elem215 = new SendBuddyMessageResult();
                  _elem215.read(iprot);
                  this.success.addElement(_elem215);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRUCT, this.success.size()));
          for (Enumeration _iter216_enum = this.success.elements(); _iter216_enum.hasMoreElements(); )           {
            SendBuddyMessageResult _iter216 = (SendBuddyMessageResult)_iter216_enum.nextElement();
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new Vector(_list217.size);
                for (int _i218 = 0; _i218 < _list217.size; ++_i218)
                {
                  String _elem219;
                  _elem219 = iprot.readString();
                  this.success.addElement(_elem219);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for (Enumeration _iter220_enum = this.success.elements(); _iter220_enum.hasMoreElements(); )           {
            String _iter220 = (String)_iter220_enum.nextElement();
  ...
  public static class getAllBuddyMembers_result implements TBase   {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new Vector(_list221.size);
                for (int _i222 = 0; _i222 < _list221.size; ++_i222)
                {
                  String _elem223;
                  _elem223 = iprot.readString();
                  this.success.addElement(_elem223);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRING, this.success.size()));
          for (Enumeration _iter224_enum = this.success.elements(); _iter224_enum.hasMoreElements(); )           {
  ...
  public static class getBlockedBuddyMembers_result implements TBase   {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new Vector(_list225.size);
                for (int _i226 = 0; _i226 < _list225.size; ++_i226)
                {
                  String _elem227;
                  _elem227 = iprot.readString();
                  this.success.addElement(_elem227);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRING, this.success.size()));
          for (Enumeration _iter228_enum = this.success.elements(); _iter228_enum.hasMoreElements(); )           {
            String _iter228 = (String)_iter228_enum.nextElement();
  ...
  public static class linkAndSendBuddyContentMessageToMids_args implements TBase   {
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.mids != null) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRING, this.mids.size()));
          for (Enumeration _iter232_enum = this.mids.elements(); _iter232_enum.hasMoreElements(); )           {
            String _iter232 = (String)_iter232_enum.nextElement();
            ...
            if (field.type == TType.MAP) {
              {
                ...
                this.settings = new Hashtable(2*_map233.size);
                for (int _i234 = 0; _i234 < _map233.size; ++_i234)
                {
                  ...
                  this.settings.put(_key235, _val236);
                }
                iprot.readMapEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.settings != null) {
        oprot.writeFieldBegin(SETTINGS_FIELD_DESC);
        {
          ...
          for (Enumeration _iter237_enum = this.settings.keys(); _iter237_enum.hasMoreElements(); )           {
            String _iter237 = (String)_iter237_enum.nextElement();
            oprot.writeString(_iter237);
            oprot.writeString(((String)this.settings.get(_iter237)));
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  public static class removeBuddyMembers_args implements TBase   {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.userMids = new Vector(_list238.size);
                for (int _i239 = 0; _i239 < _list238.size; ++_i239)
                {
                  String _elem240;
                  _elem240 = iprot.readString();
                  this.userMids.addElement(_elem240);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.userMids != null) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRING, this.userMids.size()));
          for (Enumeration _iter241_enum = this.userMids.elements(); _iter241_enum.hasMoreElements(); )           {
            String _iter241 = (String)_iter241_enum.nextElement();
  ...
  public static class sendBuddyContentMessageToMids_args implements TBase   {
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.mids != null) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRING, this.mids.size()));
          for (Enumeration _iter245_enum = this.mids.elements(); _iter245_enum.hasMoreElements(); )           {
            String _iter245 = (String)_iter245_enum.nextElement();
  ...
  public static class sendBuddyContentMessageToMidsAsync_args implements TBase   {
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.mids != null) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRING, this.mids.size()));
          for (Enumeration _iter249_enum = this.mids.elements(); _iter249_enum.hasMoreElements(); )           {
            String _iter249 = (String)_iter249_enum.nextElement();
  ...
  public static class sendBuddyMessageToMids_args implements TBase   {
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.mids != null) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRING, this.mids.size()));
          for (Enumeration _iter253_enum = this.mids.elements(); _iter253_enum.hasMoreElements(); )           {
            String _iter253 = (String)_iter253_enum.nextElement();
  ...
  public static class sendBuddyMessageToMidsAsync_args implements TBase   {
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.mids != null) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRING, this.mids.size()));
          for (Enumeration _iter257_enum = this.mids.elements(); _iter257_enum.hasMoreElements(); )           {
            String _iter257 = (String)_iter257_enum.nextElement();
            ...
            if (field.type == TType.MAP) {
              {
                ...
                this.attributes = new Hashtable(2*_map258.size);
                for (int _i259 = 0; _i259 < _map258.size; ++_i259)
                {
                  ...
                  this.attributes.put(_key260, _val261);
                }
                iprot.readMapEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.attributes != null) {
        oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
        {
          ...
          for (Enumeration _iter262_enum = this.attributes.keys(); _iter262_enum.hasMoreElements(); )           {
            String _iter262 = (String)_iter262_enum.nextElement();
            oprot.writeString(_iter262);
            oprot.writeString(((String)this.attributes.get(_iter262)));
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  public static class updateBuddyProfileAttributes_args implements TBase   {
            ...
            if (field.type == TType.MAP) {
              {
                ...
                this.attributes = new Hashtable(2*_map263.size);
                for (int _i264 = 0; _i264 < _map263.size; ++_i264)
                {
                  ...
                  this.attributes.put(_key265, _val266);
                }
                iprot.readMapEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.attributes != null) {
        ...
        {
          oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, this.attributes.size()));
          for (Enumeration _iter267_enum = this.attributes.keys(); _iter267_enum.hasMoreElements(); )           {
            String _iter267 = (String)_iter267_enum.nextElement();
            oprot.writeString(_iter267);
            oprot.writeString(((String)this.attributes.get(_iter267)));
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  public static class updateBuddyProfileAttributesAsync_args implements TBase   {
            ...
            if (field.type == TType.MAP) {
              {
                ...
                this.attributes = new Hashtable(2*_map268.size);
                for (int _i269 = 0; _i269 < _map268.size; ++_i269)
                {
                  ...
                  this.attributes.put(_key270, _val271);
                }
                iprot.readMapEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.attributes != null) {
        ...
        {
          oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, this.attributes.size()));
          for (Enumeration _iter272_enum = this.attributes.keys(); _iter272_enum.hasMoreElements(); )           {
            String _iter272 = (String)_iter272_enum.nextElement();
            oprot.writeString(_iter272);
            oprot.writeString(((String)this.attributes.get(_iter272)));
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  public static class updateBuddySettings_args implements TBase   {
            ...
            if (field.type == TType.MAP) {
              {
                ...
                this.settings = new Hashtable(2*_map273.size);
                for (int _i274 = 0; _i274 < _map273.size; ++_i274)
                {
                  ...
                  this.settings.put(_key275, _val276);
                }
                iprot.readMapEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.settings != null) {
        ...
        {
          oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, this.settings.size()));
          for (Enumeration _iter277_enum = this.settings.keys(); _iter277_enum.hasMoreElements(); )           {
            String _iter277 = (String)_iter277_enum.nextElement();
            oprot.writeString(_iter277);
            oprot.writeString(((String)this.settings.get(_iter277)));
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
