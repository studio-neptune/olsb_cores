          ...
          if (field.type == TType.MAP) {
            {
              ...
              this.contentMetadata = new Hashtable(2*_map20.size);
              for (int _i21 = 0; _i21 < _map20.size; ++_i21)
              {
                ...
                this.contentMetadata.put(_key22, _val23);
              }
              iprot.readMapEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.contentMetadata != null) {
      oprot.writeFieldBegin(CONTENT_METADATA_FIELD_DESC);
      {
        ...
        for (Enumeration _iter24_enum = this.contentMetadata.keys(); _iter24_enum.hasMoreElements(); )         {
          String _iter24 = (String)_iter24_enum.nextElement();
          oprot.writeString(_iter24);
          oprot.writeString(((String)this.contentMetadata.get(_iter24)));
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
