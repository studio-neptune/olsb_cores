            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new Vector(_list278.size);
                for (int _i279 = 0; _i279 < _list278.size; ++_i279)
                {
                  BuddySearchResult _elem280;
                  _elem280 = new BuddySearchResult();
                  _elem280.read(iprot);
                  this.success.addElement(_elem280);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for (Enumeration _iter281_enum = this.success.elements(); _iter281_enum.hasMoreElements(); )           {
            BuddySearchResult _iter281 = (BuddySearchResult)_iter281_enum.nextElement();
  ...
  public static class getBuddyContacts_result implements TBase   {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new Vector(_list282.size);
                for (int _i283 = 0; _i283 < _list282.size; ++_i283)
                {
                  Contact _elem284;
                  _elem284 = new Contact();
                  _elem284.read(iprot);
                  this.success.addElement(_elem284);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRUCT, this.success.size()));
          for (Enumeration _iter285_enum = this.success.elements(); _iter285_enum.hasMoreElements(); )           {
            Contact _iter285 = (Contact)_iter285_enum.nextElement();
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new Vector(_list286.size);
                for (int _i287 = 0; _i287 < _list286.size; ++_i287)
                {
                  String _elem288;
                  _elem288 = iprot.readString();
                  this.success.addElement(_elem288);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for (Enumeration _iter289_enum = this.success.elements(); _iter289_enum.hasMoreElements(); )           {
            String _iter289 = (String)_iter289_enum.nextElement();
            ...
            if (field.type == TType.MAP) {
              {
                ...
                this.success = new Hashtable(2*_map290.size);
                for (int _i291 = 0; _i291 < _map290.size; ++_i291)
                {
                  ...
                  this.success.put(_key292, new Long(_val293));
                }
                iprot.readMapEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for (Enumeration _iter294_enum = this.success.keys(); _iter294_enum.hasMoreElements(); )           {
            String _iter294 = (String)_iter294_enum.nextElement();
            oprot.writeString(_iter294);
            oprot.writeI64(((Long)this.success.get(_iter294)));
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  public static class getPopularBuddyLists_result implements TBase   {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new Vector(_list295.size);
                for (int _i296 = 0; _i296 < _list295.size; ++_i296)
                {
                  BuddyList _elem297;
                  _elem297 = new BuddyList();
                  _elem297.read(iprot);
                  this.success.addElement(_elem297);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRUCT, this.success.size()));
          for (Enumeration _iter298_enum = this.success.elements(); _iter298_enum.hasMoreElements(); )           {
            BuddyList _iter298 = (BuddyList)_iter298_enum.nextElement();
  ...
  public static class getPromotedBuddyContacts_result implements TBase   {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new Vector(_list299.size);
                for (int _i300 = 0; _i300 < _list299.size; ++_i300)
                {
                  Contact _elem301;
                  _elem301 = new Contact();
                  _elem301.read(iprot);
                  this.success.addElement(_elem301);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRUCT, this.success.size()));
          for (Enumeration _iter302_enum = this.success.elements(); _iter302_enum.hasMoreElements(); )           {
            Contact _iter302 = (Contact)_iter302_enum.nextElement();
