            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new Vector(_list303.size);
                for (int _i304 = 0; _i304 < _list303.size; ++_i304)
                {
                  String _elem305;
                  _elem305 = iprot.readString();
                  this.success.addElement(_elem305);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for (Enumeration _iter306_enum = this.success.elements(); _iter306_enum.hasMoreElements(); )           {
            String _iter306 = (String)_iter306_enum.nextElement();
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new Vector(_list307.size);
                for (int _i308 = 0; _i308 < _list307.size; ++_i308)
                {
                  CompactContact _elem309;
                  _elem309 = new CompactContact();
                  _elem309.read(iprot);
                  this.success.addElement(_elem309);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for (Enumeration _iter310_enum = this.success.elements(); _iter310_enum.hasMoreElements(); )           {
            CompactContact _iter310 = (CompactContact)_iter310_enum.nextElement();
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.ids != null) {
        oprot.writeFieldBegin(IDS_FIELD_DESC);
        {
          ...
          for (Enumeration _iter314_enum = this.ids.elements(); _iter314_enum.hasMoreElements(); )           {
            String _iter314 = (String)_iter314_enum.nextElement();
  ...
  public static class getContactsForChannel_result implements TBase   {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new Vector(_list315.size);
                for (int _i316 = 0; _i316 < _list315.size; ++_i316)
                {
                  Contact _elem317;
                  _elem317 = new Contact();
                  _elem317.read(iprot);
                  this.success.addElement(_elem317);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRUCT, this.success.size()));
          for (Enumeration _iter318_enum = this.success.elements(); _iter318_enum.hasMoreElements(); )           {
            Contact _iter318 = (Contact)_iter318_enum.nextElement();
  ...
  public static class getFavoriteMidsForChannel_result implements TBase   {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new Vector(_list319.size);
                for (int _i320 = 0; _i320 < _list319.size; ++_i320)
                {
                  String _elem321;
                  _elem321 = iprot.readString();
                  this.success.addElement(_elem321);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRING, this.success.size()));
          for (Enumeration _iter322_enum = this.success.elements(); _iter322_enum.hasMoreElements(); )           {
            String _iter322 = (String)_iter322_enum.nextElement();
  ...
  public static class getFriendMids_result implements TBase   {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new Vector(_list323.size);
                for (int _i324 = 0; _i324 < _list323.size; ++_i324)
                {
                  String _elem325;
                  _elem325 = iprot.readString();
                  this.success.addElement(_elem325);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRING, this.success.size()));
          for (Enumeration _iter326_enum = this.success.elements(); _iter326_enum.hasMoreElements(); )           {
            String _iter326 = (String)_iter326_enum.nextElement();
  ...
  public static class getGroupMemberMids_result implements TBase   {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new Vector(_list327.size);
                for (int _i328 = 0; _i328 < _list327.size; ++_i328)
                {
                  String _elem329;
                  _elem329 = iprot.readString();
                  this.success.addElement(_elem329);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRING, this.success.size()));
          for (Enumeration _iter330_enum = this.success.elements(); _iter330_enum.hasMoreElements(); )           {
            String _iter330 = (String)_iter330_enum.nextElement();
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.groupIds = new Vector(_list331.size);
                for (int _i332 = 0; _i332 < _list331.size; ++_i332)
                {
                  String _elem333;
                  _elem333 = iprot.readString();
                  this.groupIds.addElement(_elem333);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.groupIds != null) {
        oprot.writeFieldBegin(GROUP_IDS_FIELD_DESC);
        {
          ...
          for (Enumeration _iter334_enum = this.groupIds.elements(); _iter334_enum.hasMoreElements(); )           {
            String _iter334 = (String)_iter334_enum.nextElement();
  ...
  public static class getGroupsForChannel_result implements TBase   {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new Vector(_list335.size);
                for (int _i336 = 0; _i336 < _list335.size; ++_i336)
                {
                  Group _elem337;
                  _elem337 = new Group();
                  _elem337.read(iprot);
                  this.success.addElement(_elem337);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRUCT, this.success.size()));
          for (Enumeration _iter338_enum = this.success.elements(); _iter338_enum.hasMoreElements(); )           {
            Group _iter338 = (Group)_iter338_enum.nextElement();
  ...
  public static class getJoinedGroupIdsForChannel_result implements TBase   {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new Vector(_list339.size);
                for (int _i340 = 0; _i340 < _list339.size; ++_i340)
                {
                  String _elem341;
                  _elem341 = iprot.readString();
                  this.success.addElement(_elem341);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRING, this.success.size()));
          for (Enumeration _iter342_enum = this.success.elements(); _iter342_enum.hasMoreElements(); )           {
            String _iter342 = (String)_iter342_enum.nextElement();
  ...
  public static class getSimpleChannelContacts_args implements TBase   {
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.ids != null) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRING, this.ids.size()));
          for (Enumeration _iter346_enum = this.ids.elements(); _iter346_enum.hasMoreElements(); )           {
            String _iter346 = (String)_iter346_enum.nextElement();
  ...
  public static class getSimpleChannelContacts_result implements TBase   {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new Vector(_list347.size);
                for (int _i348 = 0; _i348 < _list347.size; ++_i348)
                {
                  SimpleChannelContact _elem349;
                  _elem349 = new SimpleChannelContact();
                  _elem349.read(iprot);
                  this.success.addElement(_elem349);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRUCT, this.success.size()));
          for (Enumeration _iter350_enum = this.success.elements(); _iter350_enum.hasMoreElements(); )           {
            SimpleChannelContact _iter350 = (SimpleChannelContact)_iter350_enum.nextElement();
            ...
            if (field.type == TType.MAP) {
              {
                ...
                this.success = new Hashtable(2*_map351.size);
                for (int _i352 = 0; _i352 < _map351.size; ++_i352)
                {
                  RegistrationType _key353;
                  String _val354;
                  _key353 = RegistrationType.findByValue(iprot.readI32());
                  _val354 = iprot.readString();
                  this.success.put(_key353, _val354);
                }
                iprot.readMapEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for (Enumeration _iter355_enum = this.success.keys(); _iter355_enum.hasMoreElements(); )           {
            RegistrationType _iter355 = (RegistrationType)_iter355_enum.nextElement();
            oprot.writeI32(_iter355.getValue());
            oprot.writeString(((String)this.success.get(_iter355)));
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
  ...
  public static class getUserMidsWhoAddedMe_result implements TBase   {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new Vector(_list356.size);
                for (int _i357 = 0; _i357 < _list356.size; ++_i357)
                {
                  String _elem358;
                  _elem358 = iprot.readString();
                  this.success.addElement(_elem358);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRING, this.success.size()));
          for (Enumeration _iter359_enum = this.success.elements(); _iter359_enum.hasMoreElements(); )           {
            String _iter359 = (String)_iter359_enum.nextElement();
