          ...
          if (field.type == TType.MAP) {
            {
              ...
              this.parameterMap = new Hashtable(2*_map39.size);
              for (int _i40 = 0; _i40 < _map39.size; ++_i40)
              {
                ...
                this.parameterMap.put(_key41, _val42);
              }
              iprot.readMapEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.parameterMap != null) {
      oprot.writeFieldBegin(PARAMETER_MAP_FIELD_DESC);
      {
        ...
        for (Enumeration _iter43_enum = this.parameterMap.keys(); _iter43_enum.hasMoreElements(); )         {
          String _iter43 = (String)_iter43_enum.nextElement();
          oprot.writeString(_iter43);
          oprot.writeString(((String)this.parameterMap.get(_iter43)));
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
