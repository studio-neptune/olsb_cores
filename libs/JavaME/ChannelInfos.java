          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.channelInfos = new Vector(_list44.size);
              for (int _i45 = 0; _i45 < _list44.size; ++_i45)
              {
                ChannelInfo _elem46;
                _elem46 = new ChannelInfo();
                _elem46.read(iprot);
                this.channelInfos.addElement(_elem46);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.channelInfos != null) {
      oprot.writeFieldBegin(CHANNEL_INFOS_FIELD_DESC);
      {
        ...
        for (Enumeration _iter47_enum = this.channelInfos.elements(); _iter47_enum.hasMoreElements(); )         {
          ChannelInfo _iter47 = (ChannelInfo)_iter47_enum.nextElement();
          _iter47.write(oprot);
        }
        oprot.writeListEnd();
      }
