            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new Vector(_list360.size);
                for (int _i361 = 0; _i361 < _list360.size; ++_i361)
                {
                  ChannelNotificationSetting _elem362;
                  _elem362 = new ChannelNotificationSetting();
                  _elem362.read(iprot);
                  this.success.addElement(_elem362);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for (Enumeration _iter363_enum = this.success.elements(); _iter363_enum.hasMoreElements(); )           {
            ChannelNotificationSetting _iter363 = (ChannelNotificationSetting)_iter363_enum.nextElement();
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.channelIds = new Vector(_list364.size);
                for (int _i365 = 0; _i365 < _list364.size; ++_i365)
                {
                  String _elem366;
                  _elem366 = iprot.readString();
                  this.channelIds.addElement(_elem366);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.channelIds != null) {
        oprot.writeFieldBegin(CHANNEL_IDS_FIELD_DESC);
        {
          ...
          for (Enumeration _iter367_enum = this.channelIds.elements(); _iter367_enum.hasMoreElements(); )           {
            String _iter367 = (String)_iter367_enum.nextElement();
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.authScheme = new Vector(_list368.size);
                for (int _i369 = 0; _i369 < _list368.size; ++_i369)
                {
                  String _elem370;
                  _elem370 = iprot.readString();
                  this.authScheme.addElement(_elem370);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.authScheme != null) {
        oprot.writeFieldBegin(AUTH_SCHEME_FIELD_DESC);
        {
          ...
          for (Enumeration _iter371_enum = this.authScheme.elements(); _iter371_enum.hasMoreElements(); )           {
            String _iter371 = (String)_iter371_enum.nextElement();
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.setting = new Vector(_list372.size);
                for (int _i373 = 0; _i373 < _list372.size; ++_i373)
                {
                  ChannelNotificationSetting _elem374;
                  _elem374 = new ChannelNotificationSetting();
                  _elem374.read(iprot);
                  this.setting.addElement(_elem374);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.setting != null) {
        oprot.writeFieldBegin(SETTING_FIELD_DESC);
        {
          ...
          for (Enumeration _iter375_enum = this.setting.elements(); _iter375_enum.hasMoreElements(); )           {
            ChannelNotificationSetting _iter375 = (ChannelNotificationSetting)_iter375_enum.nextElement();
