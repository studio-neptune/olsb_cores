          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.channelInfos = new Vector(_list48.size);
              for (int _i49 = 0; _i49 < _list48.size; ++_i49)
              {
                ChannelInfo _elem50;
                _elem50 = new ChannelInfo();
                _elem50.read(iprot);
                this.channelInfos.addElement(_elem50);
              }
              iprot.readListEnd();
            }
          } else { 
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.channelDomains = new Vector(_list51.size);
              for (int _i52 = 0; _i52 < _list51.size; ++_i52)
              {
                ChannelDomain _elem53;
                _elem53 = new ChannelDomain();
                _elem53.read(iprot);
                this.channelDomains.addElement(_elem53);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.channelInfos != null) {
      oprot.writeFieldBegin(CHANNEL_INFOS_FIELD_DESC);
      {
        ...
        for (Enumeration _iter54_enum = this.channelInfos.elements(); _iter54_enum.hasMoreElements(); )         {
          ChannelInfo _iter54 = (ChannelInfo)_iter54_enum.nextElement();
          _iter54.write(oprot);
        }
        oprot.writeListEnd();
      }
    ...
    if (this.channelDomains != null) {
      oprot.writeFieldBegin(CHANNEL_DOMAINS_FIELD_DESC);
      {
        ...
        for (Enumeration _iter55_enum = this.channelDomains.elements(); _iter55_enum.hasMoreElements(); )         {
          ChannelDomain _iter55 = (ChannelDomain)_iter55_enum.nextElement();
          _iter55.write(oprot);
        }
        oprot.writeListEnd();
      }
