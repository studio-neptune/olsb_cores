          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.historys = new Vector(_list56.size);
              for (int _i57 = 0; _i57 < _list56.size; ++_i57)
              {
                CoinHistory _elem58;
                _elem58 = new CoinHistory();
                _elem58.read(iprot);
                this.historys.addElement(_elem58);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.historys != null) {
      oprot.writeFieldBegin(HISTORYS_FIELD_DESC);
      {
        ...
        for (Enumeration _iter59_enum = this.historys.elements(); _iter59_enum.hasMoreElements(); )         {
          CoinHistory _iter59 = (CoinHistory)_iter59_enum.nextElement();
          _iter59.write(oprot);
        }
        oprot.writeListEnd();
      }
