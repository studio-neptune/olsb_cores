          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.items = new Vector(_list60.size);
              for (int _i61 = 0; _i61 < _list60.size; ++_i61)
              {
                CoinUseReservationItem _elem62;
                _elem62 = new CoinUseReservationItem();
                _elem62.read(iprot);
                this.items.addElement(_elem62);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.items != null) {
      oprot.writeFieldBegin(ITEMS_FIELD_DESC);
      {
        ...
        for (Enumeration _iter63_enum = this.items.elements(); _iter63_enum.hasMoreElements(); )         {
          CoinUseReservationItem _iter63 = (CoinUseReservationItem)_iter63_enum.nextElement();
          _iter63.write(oprot);
        }
        oprot.writeListEnd();
      }
