          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.phones = new Vector(_list64.size);
              for (int _i65 = 0; _i65 < _list64.size; ++_i65)
              {
                String _elem66;
                _elem66 = iprot.readString();
                this.phones.addElement(_elem66);
              }
              iprot.readListEnd();
            }
          } else { 
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.emails = new Vector(_list67.size);
              for (int _i68 = 0; _i68 < _list67.size; ++_i68)
              {
                String _elem69;
                _elem69 = iprot.readString();
                this.emails.addElement(_elem69);
              }
              iprot.readListEnd();
            }
          } else { 
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.userids = new Vector(_list70.size);
              for (int _i71 = 0; _i71 < _list70.size; ++_i71)
              {
                String _elem72;
                _elem72 = iprot.readString();
                this.userids.addElement(_elem72);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.phones != null) {
      oprot.writeFieldBegin(PHONES_FIELD_DESC);
      {
        ...
        for (Enumeration _iter73_enum = this.phones.elements(); _iter73_enum.hasMoreElements(); )         {
          String _iter73 = (String)_iter73_enum.nextElement();
    ...
    if (this.emails != null) {
      oprot.writeFieldBegin(EMAILS_FIELD_DESC);
      {
        ...
        for (Enumeration _iter74_enum = this.emails.elements(); _iter74_enum.hasMoreElements(); )         {
          String _iter74 = (String)_iter74_enum.nextElement();
    ...
    if (this.userids != null) {
      oprot.writeFieldBegin(USERIDS_FIELD_DESC);
      {
        ...
        for (Enumeration _iter75_enum = this.userids.elements(); _iter75_enum.hasMoreElements(); )         {
          String _iter75 = (String)_iter75_enum.nextElement();
