          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.matrices = new Vector(_list76.size);
              for (int _i77 = 0; _i77 < _list76.size; ++_i77)
              {
                FriendChannelMatrix _elem78;
                _elem78 = new FriendChannelMatrix();
                _elem78.read(iprot);
                this.matrices.addElement(_elem78);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.matrices != null) {
      oprot.writeFieldBegin(MATRICES_FIELD_DESC);
      {
        ...
        for (Enumeration _iter79_enum = this.matrices.elements(); _iter79_enum.hasMoreElements(); )         {
          FriendChannelMatrix _iter79 = (FriendChannelMatrix)_iter79_enum.nextElement();
          _iter79.write(oprot);
        }
        oprot.writeListEnd();
      }
