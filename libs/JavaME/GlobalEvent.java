          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.targets = new Vector(_list80.size);
              for (int _i81 = 0; _i81 < _list80.size; ++_i81)
              {
                NotificationTarget _elem82;
                _elem82 = new NotificationTarget();
                _elem82.read(iprot);
                this.targets.addElement(_elem82);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.targets != null) {
      oprot.writeFieldBegin(TARGETS_FIELD_DESC);
      {
        ...
        for (Enumeration _iter83_enum = this.targets.elements(); _iter83_enum.hasMoreElements(); )         {
          NotificationTarget _iter83 = (NotificationTarget)_iter83_enum.nextElement();
          _iter83.write(oprot);
        }
        oprot.writeListEnd();
      }
