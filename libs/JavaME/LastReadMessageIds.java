          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.lastReadMessageIds = new Vector(_list92.size);
              for (int _i93 = 0; _i93 < _list92.size; ++_i93)
              {
                LastReadMessageId _elem94;
                _elem94 = new LastReadMessageId();
                _elem94.read(iprot);
                this.lastReadMessageIds.addElement(_elem94);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.lastReadMessageIds != null) {
      oprot.writeFieldBegin(LAST_READ_MESSAGE_IDS_FIELD_DESC);
      {
        ...
        for (Enumeration _iter95_enum = this.lastReadMessageIds.elements(); _iter95_enum.hasMoreElements(); )         {
          LastReadMessageId _iter95 = (LastReadMessageId)_iter95_enum.nextElement();
          _iter95.write(oprot);
        }
        oprot.writeListEnd();
      }
