          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.operations = new Vector(_list101.size);
              for (int _i102 = 0; _i102 < _list101.size; ++_i102)
              {
                MessageOperation _elem103;
                _elem103 = new MessageOperation();
                _elem103.read(iprot);
                this.operations.addElement(_elem103);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.operations != null) {
      oprot.writeFieldBegin(OPERATIONS_FIELD_DESC);
      {
        ...
        for (Enumeration _iter104_enum = this.operations.elements(); _iter104_enum.hasMoreElements(); )         {
          MessageOperation _iter104 = (MessageOperation)_iter104_enum.nextElement();
