            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.chatIds = new Vector(_list376.size);
                for (int _i377 = 0; _i377 < _list376.size; ++_i377)
                {
                  String _elem378;
                  _elem378 = iprot.readString();
                  this.chatIds.addElement(_elem378);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.chatIds != null) {
        oprot.writeFieldBegin(CHAT_IDS_FIELD_DESC);
        {
          ...
          for (Enumeration _iter379_enum = this.chatIds.elements(); _iter379_enum.hasMoreElements(); )           {
            String _iter379 = (String)_iter379_enum.nextElement();
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new Vector(_list380.size);
                for (int _i381 = 0; _i381 < _list380.size; ++_i381)
                {
                  LastReadMessageIds _elem382;
                  _elem382 = new LastReadMessageIds();
                  _elem382.read(iprot);
                  this.success.addElement(_elem382);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for (Enumeration _iter383_enum = this.success.elements(); _iter383_enum.hasMoreElements(); )           {
            LastReadMessageIds _iter383 = (LastReadMessageIds)_iter383_enum.nextElement();
