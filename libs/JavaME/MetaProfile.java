          ...
          if (field.type == TType.MAP) {
            {
              ...
              this.identities = new Hashtable(2*_map105.size);
              for (int _i106 = 0; _i106 < _map105.size; ++_i106)
              {
                RegistrationType _key107;
                String _val108;
                _key107 = RegistrationType.findByValue(iprot.readI32());
                _val108 = iprot.readString();
                this.identities.put(_key107, _val108);
              }
              iprot.readMapEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.identities != null) {
      oprot.writeFieldBegin(IDENTITIES_FIELD_DESC);
      {
        ...
        for (Enumeration _iter109_enum = this.identities.keys(); _iter109_enum.hasMoreElements(); )         {
          RegistrationType _iter109 = (RegistrationType)_iter109_enum.nextElement();
          oprot.writeI32(_iter109.getValue());
          oprot.writeString(((String)this.identities.get(_iter109)));
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
