          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.itemList = new Vector(_list115.size);
              for (int _i116 = 0; _i116 < _list115.size; ++_i116)
              {
                NotificationItem _elem117;
                _elem117 = new NotificationItem();
                _elem117.read(iprot);
                this.itemList.addElement(_elem117);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.itemList != null) {
      oprot.writeFieldBegin(ITEM_LIST_FIELD_DESC);
      {
        ...
        for (Enumeration _iter118_enum = this.itemList.elements(); _iter118_enum.hasMoreElements(); )         {
          NotificationItem _iter118 = (NotificationItem)_iter118_enum.nextElement();
