...
public class NotificationItem implements TBase {
  ...
  private static final TField FROM__FIELD_DESC = new TField("from_", TType.STRING, (short)2);
          ...
          if (field.type == TType.MAP) {
            {
              ...
              this.content = new Hashtable(2*_map110.size);
              for (int _i111 = 0; _i111 < _map110.size; ++_i111)
              {
                ...
                this.content.put(_key112, _val113);
              }
              iprot.readMapEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.content != null) {
      oprot.writeFieldBegin(CONTENT_FIELD_DESC);
      {
        ...
        for (Enumeration _iter114_enum = this.content.keys(); _iter114_enum.hasMoreElements(); )         {
          String _iter114 = (String)_iter114_enum.nextElement();
          oprot.writeString(_iter114);
          oprot.writeString(((String)this.content.get(_iter114)));
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
