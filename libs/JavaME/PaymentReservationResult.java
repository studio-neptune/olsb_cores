          ...
          if (field.type == TType.MAP) {
            {
              ...
              this.extras = new Hashtable(2*_map119.size);
              for (int _i120 = 0; _i120 < _map119.size; ++_i120)
              {
                ...
                this.extras.put(_key121, _val122);
              }
              iprot.readMapEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.extras != null) {
      oprot.writeFieldBegin(EXTRAS_FIELD_DESC);
      {
        ...
        for (Enumeration _iter123_enum = this.extras.keys(); _iter123_enum.hasMoreElements(); )         {
          String _iter123 = (String)_iter123_enum.nextElement();
          oprot.writeString(_iter123);
          oprot.writeString(((String)this.extras.get(_iter123)));
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
