          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.productList = new Vector(_list124.size);
              for (int _i125 = 0; _i125 < _list124.size; ++_i125)
              {
                Product _elem126;
                _elem126 = new Product();
                _elem126.read(iprot);
                this.productList.addElement(_elem126);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.productList != null) {
      oprot.writeFieldBegin(PRODUCT_LIST_FIELD_DESC);
      {
        ...
        for (Enumeration _iter127_enum = this.productList.elements(); _iter127_enum.hasMoreElements(); )         {
          Product _iter127 = (Product)_iter127_enum.nextElement();
