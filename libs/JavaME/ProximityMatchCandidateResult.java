          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.users = new Vector(_list132.size);
              for (int _i133 = 0; _i133 < _list132.size; ++_i133)
              {
                Contact _elem134;
                _elem134 = new Contact();
                _elem134.read(iprot);
                this.users.addElement(_elem134);
              }
              iprot.readListEnd();
            }
          } else { 
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.buddies = new Vector(_list135.size);
              for (int _i136 = 0; _i136 < _list135.size; ++_i136)
              {
                Contact _elem137;
                _elem137 = new Contact();
                _elem137.read(iprot);
                this.buddies.addElement(_elem137);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.users != null) {
      oprot.writeFieldBegin(USERS_FIELD_DESC);
      {
        ...
        for (Enumeration _iter138_enum = this.users.elements(); _iter138_enum.hasMoreElements(); )         {
          Contact _iter138 = (Contact)_iter138_enum.nextElement();
    ...
    if (this.buddies != null) {
      oprot.writeFieldBegin(BUDDIES_FIELD_DESC);
      {
        ...
        for (Enumeration _iter139_enum = this.buddies.elements(); _iter139_enum.hasMoreElements(); )         {
          Contact _iter139 = (Contact)_iter139_enum.nextElement();
