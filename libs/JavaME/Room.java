          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.contacts = new Vector(_list140.size);
              for (int _i141 = 0; _i141 < _list140.size; ++_i141)
              {
                Contact _elem142;
                _elem142 = new Contact();
                _elem142.read(iprot);
                this.contacts.addElement(_elem142);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.contacts != null) {
      oprot.writeFieldBegin(CONTACTS_FIELD_DESC);
      {
        ...
        for (Enumeration _iter143_enum = this.contacts.elements(); _iter143_enum.hasMoreElements(); )         {
          Contact _iter143 = (Contact)_iter143_enum.nextElement();
