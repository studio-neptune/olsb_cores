          ...
          if (field.type == TType.MAP) {
            {
              ...
              this.snsAccounts = new Hashtable(2*_map144.size);
              for (int _i145 = 0; _i145 < _map144.size; ++_i145)
              {
                SnsIdType _key146;
                String _val147;
                _key146 = SnsIdType.findByValue(iprot.readI32());
                _val147 = iprot.readString();
                this.snsAccounts.put(_key146, _val147);
              }
              iprot.readMapEnd();
            }
          } else { 
          ...
          if (field.type == TType.MAP) {
            {
              ...
              this.customModes = new Hashtable(2*_map148.size);
              for (int _i149 = 0; _i149 < _map148.size; ++_i149)
              {
                CustomMode _key150;
                String _val151;
                _key150 = CustomMode.findByValue(iprot.readI32());
                _val151 = iprot.readString();
                this.customModes.put(_key150, _val151);
              }
              iprot.readMapEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.snsAccounts != null) {
      oprot.writeFieldBegin(SNS_ACCOUNTS_FIELD_DESC);
      {
        ...
        for (Enumeration _iter152_enum = this.snsAccounts.keys(); _iter152_enum.hasMoreElements(); )         {
          SnsIdType _iter152 = (SnsIdType)_iter152_enum.nextElement();
          oprot.writeI32(_iter152.getValue());
          oprot.writeString(((String)this.snsAccounts.get(_iter152)));
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
    ...
    if (this.customModes != null) {
      oprot.writeFieldBegin(CUSTOM_MODES_FIELD_DESC);
      {
        ...
        for (Enumeration _iter153_enum = this.customModes.keys(); _iter153_enum.hasMoreElements(); )         {
          CustomMode _iter153 = (CustomMode)_iter153_enum.nextElement();
          oprot.writeI32(_iter153.getValue());
          oprot.writeString(((String)this.customModes.get(_iter153)));
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
