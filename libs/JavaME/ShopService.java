            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new Vector(_list384.size);
                for (int _i385 = 0; _i385 < _list384.size; ++_i385)
                {
                  CoinProductItem _elem386;
                  _elem386 = new CoinProductItem();
                  _elem386.read(iprot);
                  this.success.addElement(_elem386);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
        {
          ...
          for (Enumeration _iter387_enum = this.success.elements(); _iter387_enum.hasMoreElements(); )           {
            CoinProductItem _iter387 = (CoinProductItem)_iter387_enum.nextElement();
  ...
  public static class getCoinProductsByPgCode_result implements TBase   {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.success = new Vector(_list388.size);
                for (int _i389 = 0; _i389 < _list388.size; ++_i389)
                {
                  CoinProductItem _elem390;
                  _elem390 = new CoinProductItem();
                  _elem390.read(iprot);
                  this.success.addElement(_elem390);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.isSetSuccess()) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRUCT, this.success.size()));
          for (Enumeration _iter391_enum = this.success.elements(); _iter391_enum.hasMoreElements(); )           {
            CoinProductItem _iter391 = (CoinProductItem)_iter391_enum.nextElement();
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.productIdList = new Vector(_list392.size);
                for (int _i393 = 0; _i393 < _list392.size; ++_i393)
                {
                  String _elem394;
                  _elem394 = iprot.readString();
                  this.productIdList.addElement(_elem394);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.productIdList != null) {
        oprot.writeFieldBegin(PRODUCT_ID_LIST_FIELD_DESC);
        {
          ...
          for (Enumeration _iter395_enum = this.productIdList.elements(); _iter395_enum.hasMoreElements(); )           {
            String _iter395 = (String)_iter395_enum.nextElement();
  ...
  public static class getProductListWithCarrier_args implements TBase   {
            ...
            if (field.type == TType.LIST) {
              {
                ...
                this.productIdList = new Vector(_list396.size);
                for (int _i397 = 0; _i397 < _list396.size; ++_i397)
                {
                  String _elem398;
                  _elem398 = iprot.readString();
                  this.productIdList.addElement(_elem398);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(TProtocol oprot) throws TException {
      ...
      if (this.productIdList != null) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRING, this.productIdList.size()));
          for (Enumeration _iter399_enum = this.productIdList.elements(); _iter399_enum.hasMoreElements(); )           {
            String _iter399 = (String)_iter399_enum.nextElement();
