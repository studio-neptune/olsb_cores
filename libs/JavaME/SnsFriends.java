          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.snsFriends = new Vector(_list154.size);
              for (int _i155 = 0; _i155 < _list154.size; ++_i155)
              {
                SnsFriend _elem156;
                _elem156 = new SnsFriend();
                _elem156.read(iprot);
                this.snsFriends.addElement(_elem156);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.snsFriends != null) {
      oprot.writeFieldBegin(SNS_FRIENDS_FIELD_DESC);
      {
        ...
        for (Enumeration _iter157_enum = this.snsFriends.elements(); _iter157_enum.hasMoreElements(); )         {
          SnsFriend _iter157 = (SnsFriend)_iter157_enum.nextElement();
