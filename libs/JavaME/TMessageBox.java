          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.lastMessages = new Vector(_list163.size);
              for (int _i164 = 0; _i164 < _list163.size; ++_i164)
              {
                Message _elem165;
                _elem165 = new Message();
                _elem165.read(iprot);
                this.lastMessages.addElement(_elem165);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.lastMessages != null) {
      oprot.writeFieldBegin(LAST_MESSAGES_FIELD_DESC);
      {
        ...
        for (Enumeration _iter166_enum = this.lastMessages.elements(); _iter166_enum.hasMoreElements(); )         {
          Message _iter166 = (Message)_iter166_enum.nextElement();
