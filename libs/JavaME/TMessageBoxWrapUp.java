          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.contacts = new Vector(_list167.size);
              for (int _i168 = 0; _i168 < _list167.size; ++_i168)
              {
                Contact _elem169;
                _elem169 = new Contact();
                _elem169.read(iprot);
                this.contacts.addElement(_elem169);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.contacts != null) {
      oprot.writeFieldBegin(CONTACTS_FIELD_DESC);
      {
        ...
        for (Enumeration _iter170_enum = this.contacts.elements(); _iter170_enum.hasMoreElements(); )         {
          Contact _iter170 = (Contact)_iter170_enum.nextElement();
