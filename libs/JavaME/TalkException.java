          ...
          if (field.type == TType.MAP) {
            {
              ...
              this.parameterMap = new Hashtable(2*_map158.size);
              for (int _i159 = 0; _i159 < _map158.size; ++_i159)
              {
                ...
                this.parameterMap.put(_key160, _val161);
              }
              iprot.readMapEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.parameterMap != null) {
      oprot.writeFieldBegin(PARAMETER_MAP_FIELD_DESC);
      {
        ...
        for (Enumeration _iter162_enum = this.parameterMap.keys(); _iter162_enum.hasMoreElements(); )         {
          String _iter162 = (String)_iter162_enum.nextElement();
          oprot.writeString(_iter162);
          oprot.writeString(((String)this.parameterMap.get(_iter162)));
        }
        oprot.writeMapEnd();
      }
      oprot.writeFieldEnd();
