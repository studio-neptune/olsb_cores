          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.registeredSnsIdTypes = new Vector(_list180.size);
              for (int _i181 = 0; _i181 < _list180.size; ++_i181)
              {
                SnsIdType _elem182;
                _elem182 = SnsIdType.findByValue(iprot.readI32());
                this.registeredSnsIdTypes.addElement(_elem182);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.registeredSnsIdTypes != null) {
      oprot.writeFieldBegin(REGISTERED_SNS_ID_TYPES_FIELD_DESC);
      {
        ...
        for (Enumeration _iter183_enum = this.registeredSnsIdTypes.elements(); _iter183_enum.hasMoreElements(); )         {
          SnsIdType _iter183 = (SnsIdType)_iter183_enum.nextElement();
