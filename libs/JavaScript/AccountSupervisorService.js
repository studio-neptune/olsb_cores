  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.MAP) {
        this.parameterMap = {};
        var _rtmp3245 = input.readMapBegin();
        ...
        for (var _i246 = 0; _i246 < _size244; ++_i246) {
          ...
          var key247 = null;
          var val248 = null;
          key247 = input.readString().value;
          val248 = input.readString().value;
          this.parameterMap[key247] = val248;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
AccountSupervisorService_notifyEmailConfirmationResult_args.prototype.write = function(output) {
  ...
  if (this.parameterMap !== null && this.parameterMap !== undefined) {
    ...
    for (var kiter249 in this.parameterMap) {
      if (this.parameterMap.hasOwnProperty(kiter249)) {
        var viter250 = this.parameterMap[kiter249];
