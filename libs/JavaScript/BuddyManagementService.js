...
BuddyManagementService_addBuddyMembers_args.prototype.write = function(output) {
  ...
  if (this.userMids !== null && this.userMids !== undefined) {
    ...
    for (var iter255 in this.userMids) {
      if (this.userMids.hasOwnProperty(iter255)) {
        iter255 = this.userMids[iter255];
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i258 = 0; _i258 < _size256; ++_i258) {
          ...
          this.requestIdList.push(elem259);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
BuddyManagementService_commitSendMessagesToAll_args.prototype.write = function(output) {
  ...
  if (this.requestIdList !== null && this.requestIdList !== undefined) {
    ...
    for (var iter260 in this.requestIdList) {
      if (this.requestIdList.hasOwnProperty(iter260)) {
        iter260 = this.requestIdList[iter260];
...
BuddyManagementService_commitSendMessagesToAll_result.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        this.success = [];
        var _rtmp3262 = input.readListBegin();
        var _size261 = _rtmp3262.size || 0;
        for (var _i263 = 0; _i263 < _size261; ++_i263) {
          var elem264 = null;
          elem264 = new SendBuddyMessageResult();
          elem264.read(input);
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i268 = 0; _i268 < _size266; ++_i268) {
          ...
          this.requestIdList.push(elem269);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
BuddyManagementService_commitSendMessagesToMids_args.prototype.write = function(output) {
  ...
  if (this.requestIdList !== null && this.requestIdList !== undefined) {
    output.writeFieldBegin('requestIdList', Thrift.Type.LIST, 1);
    output.writeListBegin(Thrift.Type.STRING, this.requestIdList.length);
    for (var iter274 in this.requestIdList) {
      if (this.requestIdList.hasOwnProperty(iter274)) {
        iter274 = this.requestIdList[iter274];
  ...
  if (this.mids !== null && this.mids !== undefined) {
    ...
    for (var iter275 in this.mids) {
      if (this.mids.hasOwnProperty(iter275)) {
        iter275 = this.mids[iter275];
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i278 = 0; _i278 < _size276; ++_i278) {
          var elem279 = null;
          elem279 = new SendBuddyMessageResult();
          elem279.read(input);
...
BuddyManagementService_getAllBuddyMembers_result.prototype.write = function(output) {
  ...
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.LIST, 0);
    output.writeListBegin(Thrift.Type.STRING, this.success.length);
    for (var iter290 in this.success) {
      if (this.success.hasOwnProperty(iter290)) {
        iter290 = this.success[iter290];
...
BuddyManagementService_linkAndSendBuddyContentMessageToMids_args.prototype.write = function(output) {
  ...
  if (this.mids !== null && this.mids !== undefined) {
    ...
    output.writeListBegin(Thrift.Type.STRING, this.mids.length);
    for (var iter300 in this.mids) {
      if (this.mids.hasOwnProperty(iter300)) {
        iter300 = this.mids[iter300];
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.MAP) {
        this.settings = {};
        var _rtmp3302 = input.readMapBegin();
...
BuddyManagementService_registerBuddy_args.prototype.write = function(output) {
  ...
  if (this.settings !== null && this.settings !== undefined) {
    ...
    for (var kiter306 in this.settings) {
      if (this.settings.hasOwnProperty(kiter306)) {
        var viter307 = this.settings[kiter306];
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i310 = 0; _i310 < _size308; ++_i310) {
          var elem311 = null;
          elem311 = input.readString().value;
          this.userMids.push(elem311);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
BuddyManagementService_removeBuddyMembers_args.prototype.write = function(output) {
  ...
  if (this.userMids !== null && this.userMids !== undefined) {
    output.writeFieldBegin('userMids', Thrift.Type.LIST, 2);
    output.writeListBegin(Thrift.Type.STRING, this.userMids.length);
    for (var iter312 in this.userMids) {
      if (this.userMids.hasOwnProperty(iter312)) {
        iter312 = this.userMids[iter312];
        output.writeString(iter312);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
...
BuddyManagementService_sendBuddyContentMessageToMids_args.prototype.write = function(output) {
  ...
  if (this.mids !== null && this.mids !== undefined) {
    output.writeFieldBegin('mids', Thrift.Type.LIST, 4);
    output.writeListBegin(Thrift.Type.STRING, this.mids.length);
    for (var iter317 in this.mids) {
      if (this.mids.hasOwnProperty(iter317)) {
        iter317 = this.mids[iter317];
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i320 = 0; _i320 < _size318; ++_i320) {
          var elem321 = null;
          elem321 = input.readString().value;
          this.mids.push(elem321);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
BuddyManagementService_sendBuddyContentMessageToMidsAsync_args.prototype.write = function(output) {
  ...
  if (this.mids !== null && this.mids !== undefined) {
    output.writeFieldBegin('mids', Thrift.Type.LIST, 4);
    output.writeListBegin(Thrift.Type.STRING, this.mids.length);
    for (var iter322 in this.mids) {
      if (this.mids.hasOwnProperty(iter322)) {
        iter322 = this.mids[iter322];
        output.writeString(iter322);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
...
BuddyManagementService_sendBuddyMessageToMids_args.prototype.write = function(output) {
  ...
  if (this.mids !== null && this.mids !== undefined) {
    ...
    output.writeListBegin(Thrift.Type.STRING, this.mids.length);
    for (var iter327 in this.mids) {
      if (this.mids.hasOwnProperty(iter327)) {
        iter327 = this.mids[iter327];
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i330 = 0; _i330 < _size328; ++_i330) {
          var elem331 = null;
          elem331 = input.readString().value;
          this.mids.push(elem331);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
BuddyManagementService_sendBuddyMessageToMidsAsync_args.prototype.write = function(output) {
  ...
  if (this.mids !== null && this.mids !== undefined) {
    output.writeFieldBegin('mids', Thrift.Type.LIST, 3);
    output.writeListBegin(Thrift.Type.STRING, this.mids.length);
    for (var iter332 in this.mids) {
      if (this.mids.hasOwnProperty(iter332)) {
        iter332 = this.mids[iter332];
        output.writeString(iter332);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
...
BuddyManagementService_updateBuddyAdminProfileAttribute_args.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.MAP) {
        this.attributes = {};
        var _rtmp3334 = input.readMapBegin();
        var _size333 = _rtmp3334.size || 0;
        for (var _i335 = 0; _i335 < _size333; ++_i335) {
          if (_i335 > 0 ) {
            if (input.rstack.length > input.rpos[input.rpos.length -1] + 1) {
              input.rstack.pop();
            }
...
BuddyManagementService_updateBuddyProfileAttributes_args.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.MAP) {
        this.attributes = {};
        var _rtmp3341 = input.readMapBegin();
        var _size340 = _rtmp3341.size || 0;
        for (var _i342 = 0; _i342 < _size340; ++_i342) {
          if (_i342 > 0 ) {
            if (input.rstack.length > input.rpos[input.rpos.length -1] + 1) {
              input.rstack.pop();
            }
          ...
          var key343 = null;
          var val344 = null;
          key343 = input.readString().value;
          val344 = input.readString().value;
...
BuddyManagementService_updateBuddyProfileAttributes_args.prototype.write = function(output) {
  ...
  if (this.attributes !== null && this.attributes !== undefined) {
    output.writeFieldBegin('attributes', Thrift.Type.MAP, 2);
    output.writeMapBegin(Thrift.Type.STRING, Thrift.Type.STRING, Thrift.objectLength(this.attributes));
    for (var kiter345 in this.attributes) {
      if (this.attributes.hasOwnProperty(kiter345)) {
        var viter346 = this.attributes[kiter345];
        output.writeString(kiter345);
        output.writeString(viter346);
      }
    }
    output.writeMapEnd();
    output.writeFieldEnd();
...
BuddyManagementService_updateBuddyProfileAttributesAsync_args.prototype.write = function(output) {
  ...
  if (this.attributes !== null && this.attributes !== undefined) {
    output.writeFieldBegin('attributes', Thrift.Type.MAP, 2);
    output.writeMapBegin(Thrift.Type.STRING, Thrift.Type.STRING, Thrift.objectLength(this.attributes));
    for (var kiter352 in this.attributes) {
      if (this.attributes.hasOwnProperty(kiter352)) {
        var viter353 = this.attributes[kiter352];
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i356 = 0; _i356 < _size354; ++_i356) {
          ...
          var key357 = null;
          var val358 = null;
          key357 = input.readString().value;
          val358 = input.readString().value;
          this.settings[key357] = val358;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
BuddyManagementService_updateBuddySettings_args.prototype.write = function(output) {
  ...
  if (this.settings !== null && this.settings !== undefined) {
    ...
    output.writeMapBegin(Thrift.Type.STRING, Thrift.Type.STRING, Thrift.objectLength(this.settings));
    for (var kiter359 in this.settings) {
      if (this.settings.hasOwnProperty(kiter359)) {
        var viter360 = this.settings[kiter359];
        output.writeString(kiter359);
        output.writeString(viter360);
      }
    }
    output.writeMapEnd();
    output.writeFieldEnd();
