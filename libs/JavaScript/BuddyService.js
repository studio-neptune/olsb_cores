    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i378 = 0; _i378 < _size376; ++_i378) {
          ...
          var key379 = null;
          var val380 = null;
          key379 = input.readString().value;
          val380 = input.readI64().value;
          this.success[key379] = val380;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
BuddyService_getNewlyReleasedBuddyIds_result.prototype.write = function(output) {
  ...
  if (this.success !== null && this.success !== undefined) {
    ...
    for (var kiter381 in this.success) {
      if (this.success.hasOwnProperty(kiter381)) {
        var viter382 = this.success[kiter381];
        output.writeString(kiter381);
        output.writeI64(viter382);
      }
    }
    output.writeMapEnd();
    output.writeFieldEnd();
...
BuddyService_getPromotedBuddyContacts_result.prototype.write = function(output) {
  ...
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.LIST, 0);
    output.writeListBegin(Thrift.Type.STRUCT, this.success.length);
    for (var iter392 in this.success) {
      if (this.success.hasOwnProperty(iter392)) {
        iter392 = this.success[iter392];
