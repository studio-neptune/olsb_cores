    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i395 = 0; _i395 < _size393; ++_i395) {
          var elem396 = null;
          elem396 = input.readString().value;
...
ChannelApplicationProvidedService_getCompactContacts_result.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        this.success = [];
        var _rtmp3399 = input.readListBegin();
        var _size398 = _rtmp3399.size || 0;
        for (var _i400 = 0; _i400 < _size398; ++_i400) {
          var elem401 = null;
          elem401 = new CompactContact();
          elem401.read(input);
          this.success.push(elem401);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
ChannelApplicationProvidedService_getCompactContacts_result.prototype.write = function(output) {
  ...
  if (this.success !== null && this.success !== undefined) {
    ...
    for (var iter402 in this.success) {
      if (this.success.hasOwnProperty(iter402)) {
        iter402 = this.success[iter402];
        iter402.write(output);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
...
ChannelApplicationProvidedService_getContactsForChannel_args.prototype.write = function(output) {
  ...
  if (this.ids !== null && this.ids !== undefined) {
    ...
    for (var iter407 in this.ids) {
      if (this.ids.hasOwnProperty(iter407)) {
        iter407 = this.ids[iter407];
...
ChannelApplicationProvidedService_getContactsForChannel_result.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        this.success = [];
        var _rtmp3409 = input.readListBegin();
        var _size408 = _rtmp3409.size || 0;
        for (var _i410 = 0; _i410 < _size408; ++_i410) {
          var elem411 = null;
          elem411 = new Contact();
          elem411.read(input);
          this.success.push(elem411);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
ChannelApplicationProvidedService_getContactsForChannel_result.prototype.write = function(output) {
  ...
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.LIST, 0);
    output.writeListBegin(Thrift.Type.STRUCT, this.success.length);
    for (var iter412 in this.success) {
      if (this.success.hasOwnProperty(iter412)) {
        iter412 = this.success[iter412];
...
ChannelApplicationProvidedService_getFavoriteMidsForChannel_result.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        this.success = [];
        var _rtmp3414 = input.readListBegin();
        var _size413 = _rtmp3414.size || 0;
        for (var _i415 = 0; _i415 < _size413; ++_i415) {
          var elem416 = null;
...
ChannelApplicationProvidedService_getFriendMids_result.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        this.success = [];
        var _rtmp3419 = input.readListBegin();
        var _size418 = _rtmp3419.size || 0;
        for (var _i420 = 0; _i420 < _size418; ++_i420) {
          var elem421 = null;
          elem421 = input.readString().value;
          this.success.push(elem421);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
ChannelApplicationProvidedService_getFriendMids_result.prototype.write = function(output) {
  ...
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.LIST, 0);
    output.writeListBegin(Thrift.Type.STRING, this.success.length);
    for (var iter422 in this.success) {
      if (this.success.hasOwnProperty(iter422)) {
        iter422 = this.success[iter422];
        output.writeString(iter422);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
...
ChannelApplicationProvidedService_getGroupMemberMids_result.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        this.success = [];
        var _rtmp3424 = input.readListBegin();
        var _size423 = _rtmp3424.size || 0;
        for (var _i425 = 0; _i425 < _size423; ++_i425) {
          var elem426 = null;
...
ChannelApplicationProvidedService_getGroupsForChannel_args.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        this.groupIds = [];
        var _rtmp3429 = input.readListBegin();
        var _size428 = _rtmp3429.size || 0;
        for (var _i430 = 0; _i430 < _size428; ++_i430) {
          var elem431 = null;
          elem431 = input.readString().value;
          this.groupIds.push(elem431);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
ChannelApplicationProvidedService_getGroupsForChannel_args.prototype.write = function(output) {
  ...
  if (this.groupIds !== null && this.groupIds !== undefined) {
    ...
    for (var iter432 in this.groupIds) {
      if (this.groupIds.hasOwnProperty(iter432)) {
        iter432 = this.groupIds[iter432];
        output.writeString(iter432);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
...
ChannelApplicationProvidedService_getJoinedGroupIdsForChannel_result.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        this.success = [];
        var _rtmp3439 = input.readListBegin();
        var _size438 = _rtmp3439.size || 0;
        for (var _i440 = 0; _i440 < _size438; ++_i440) {
          var elem441 = null;
          elem441 = input.readString().value;
          this.success.push(elem441);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
ChannelApplicationProvidedService_getJoinedGroupIdsForChannel_result.prototype.write = function(output) {
  ...
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.LIST, 0);
    output.writeListBegin(Thrift.Type.STRING, this.success.length);
    for (var iter442 in this.success) {
      if (this.success.hasOwnProperty(iter442)) {
        iter442 = this.success[iter442];
...
ChannelApplicationProvidedService_getSimpleChannelContacts_args.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        this.ids = [];
        var _rtmp3444 = input.readListBegin();
        var _size443 = _rtmp3444.size || 0;
        for (var _i445 = 0; _i445 < _size443; ++_i445) {
          var elem446 = null;
          elem446 = input.readString().value;
          this.ids.push(elem446);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
ChannelApplicationProvidedService_getSimpleChannelContacts_args.prototype.write = function(output) {
  ...
  if (this.ids !== null && this.ids !== undefined) {
    ...
    output.writeListBegin(Thrift.Type.STRING, this.ids.length);
    for (var iter447 in this.ids) {
      if (this.ids.hasOwnProperty(iter447)) {
        iter447 = this.ids[iter447];
...
ChannelApplicationProvidedService_getSimpleChannelContacts_result.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        this.success = [];
        var _rtmp3449 = input.readListBegin();
        var _size448 = _rtmp3449.size || 0;
        for (var _i450 = 0; _i450 < _size448; ++_i450) {
          var elem451 = null;
          elem451 = new SimpleChannelContact();
          elem451.read(input);
          this.success.push(elem451);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
ChannelApplicationProvidedService_getSimpleChannelContacts_result.prototype.write = function(output) {
  ...
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.LIST, 0);
    output.writeListBegin(Thrift.Type.STRUCT, this.success.length);
    for (var iter452 in this.success) {
      if (this.success.hasOwnProperty(iter452)) {
        iter452 = this.success[iter452];
        iter452.write(output);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.MAP) {
        this.success = {};
        var _rtmp3454 = input.readMapBegin();
        var _size453 = _rtmp3454.size || 0;
        for (var _i455 = 0; _i455 < _size453; ++_i455) {
          if (_i455 > 0 ) {
