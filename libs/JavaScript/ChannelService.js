  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        this.success = [];
        var _rtmp3466 = input.readListBegin();
        var _size465 = _rtmp3466.size || 0;
        for (var _i467 = 0; _i467 < _size465; ++_i467) {
          var elem468 = null;
          elem468 = new ChannelNotificationSetting();
          elem468.read(input);
...
ChannelService_getFriendChannelMatrices_args.prototype.write = function(output) {
  ...
  if (this.channelIds !== null && this.channelIds !== undefined) {
    ...
    for (var iter474 in this.channelIds) {
      if (this.channelIds.hasOwnProperty(iter474)) {
        iter474 = this.channelIds[iter474];
...
ChannelService_issueRequestTokenWithAuthScheme_args.prototype.write = function(output) {
  ...
  if (this.authScheme !== null && this.authScheme !== undefined) {
    ...
    for (var iter479 in this.authScheme) {
      if (this.authScheme.hasOwnProperty(iter479)) {
        iter479 = this.authScheme[iter479];
...
ChannelService_updateChannelNotificationSetting_args.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        this.setting = [];
        var _rtmp3481 = input.readListBegin();
        var _size480 = _rtmp3481.size || 0;
        for (var _i482 = 0; _i482 < _size480; ++_i482) {
          var elem483 = null;
          elem483 = new ChannelNotificationSetting();
          elem483.read(input);
          this.setting.push(elem483);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
ChannelService_updateChannelNotificationSetting_args.prototype.write = function(output) {
  ...
  if (this.setting !== null && this.setting !== undefined) {
    ...
    for (var iter484 in this.setting) {
      if (this.setting.hasOwnProperty(iter484)) {
        iter484 = this.setting[iter484];
        iter484.write(output);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
