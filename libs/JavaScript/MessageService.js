  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        this.chatIds = [];
        var _rtmp3486 = input.readListBegin();
        var _size485 = _rtmp3486.size || 0;
        for (var _i487 = 0; _i487 < _size485; ++_i487) {
          var elem488 = null;
          elem488 = input.readString().value;
          this.chatIds.push(elem488);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
MessageService_multiGetLastReadMessageIds_args.prototype.write = function(output) {
  ...
  if (this.chatIds !== null && this.chatIds !== undefined) {
    ...
    for (var iter489 in this.chatIds) {
      if (this.chatIds.hasOwnProperty(iter489)) {
        iter489 = this.chatIds[iter489];
...
MessageService_multiGetLastReadMessageIds_result.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        this.success = [];
        var _rtmp3491 = input.readListBegin();
        var _size490 = _rtmp3491.size || 0;
        for (var _i492 = 0; _i492 < _size490; ++_i492) {
          var elem493 = null;
          elem493 = new LastReadMessageIds();
          elem493.read(input);
          this.success.push(elem493);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
MessageService_multiGetLastReadMessageIds_result.prototype.write = function(output) {
  ...
  if (this.success !== null && this.success !== undefined) {
    ...
    for (var iter494 in this.success) {
      if (this.success.hasOwnProperty(iter494)) {
        iter494 = this.success[iter494];
