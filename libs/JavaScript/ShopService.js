  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        this.success = [];
        var _rtmp3496 = input.readListBegin();
        var _size495 = _rtmp3496.size || 0;
        for (var _i497 = 0; _i497 < _size495; ++_i497) {
          var elem498 = null;
          elem498 = new CoinProductItem();
          elem498.read(input);
...
ShopService_getCoinProductsByPgCode_result.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        this.success = [];
        var _rtmp3501 = input.readListBegin();
        var _size500 = _rtmp3501.size || 0;
        for (var _i502 = 0; _i502 < _size500; ++_i502) {
          var elem503 = null;
          elem503 = new CoinProductItem();
          elem503.read(input);
          this.success.push(elem503);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
ShopService_getCoinProductsByPgCode_result.prototype.write = function(output) {
  ...
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.LIST, 0);
    output.writeListBegin(Thrift.Type.STRUCT, this.success.length);
    for (var iter504 in this.success) {
      if (this.success.hasOwnProperty(iter504)) {
        iter504 = this.success[iter504];
        iter504.write(output);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
...
ShopService_getProductList_args.prototype.write = function(output) {
  ...
  if (this.productIdList !== null && this.productIdList !== undefined) {
    ...
    for (var iter509 in this.productIdList) {
      if (this.productIdList.hasOwnProperty(iter509)) {
        iter509 = this.productIdList[iter509];
...
ShopService_getProductListWithCarrier_args.prototype.write = function(output) {
  ...
  if (this.productIdList !== null && this.productIdList !== undefined) {
    output.writeFieldBegin('productIdList', Thrift.Type.LIST, 2);
    output.writeListBegin(Thrift.Type.STRING, this.productIdList.length);
    for (var iter514 in this.productIdList) {
      if (this.productIdList.hasOwnProperty(iter514)) {
        iter514 = this.productIdList[iter514];
