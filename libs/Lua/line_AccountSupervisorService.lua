  ...
  while true do
    ...
    elseif fid == 2 then
      if ftype == TType.MAP then
        self.parameterMap = {}
        local _ktype289, _vtype290, _size288 = iprot:readMapBegin() 
        for _i=1,_size288 do
          local _key292 = iprot:readString()
          local _val293 = iprot:readString()
          self.parameterMap[_key292] = _val293
        end
        iprot:readMapEnd()
      else
        iprot:skip(ftype)
...
function notifyEmailConfirmationResult_args:write(oprot)
  ...
  if self.parameterMap ~= nil then
    ...
    for kiter294,viter295 in pairs(self.parameterMap) do
