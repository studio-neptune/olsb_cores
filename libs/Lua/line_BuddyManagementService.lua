    ...
    elseif fid == 2 then
      if ftype == TType.LIST then
        ...
        for _i=1,_size296 do
          ...
          table.insert(self.userMids, _elem300)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function addBuddyMembers_args:write(oprot)
  ...
  if self.userMids ~= nil then
    ...
    for _,iter301 in ipairs(self.userMids) do
    ...
    elseif fid == 1 then
      if ftype == TType.LIST then
        ...
        for _i=1,_size302 do
          ...
          table.insert(self.requestIdList, _elem306)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function commitSendMessagesToAll_args:write(oprot)
  ...
  if self.requestIdList ~= nil then
    ...
    for _,iter307 in ipairs(self.requestIdList) do
    ...
    elseif fid == 0 then
      if ftype == TType.LIST then
        ...
        for _i=1,_size308 do
          local _elem312 = SendBuddyMessageResult:new{}
          _elem312:read(iprot)
          table.insert(self.success, _elem312)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function commitSendMessagesToAll_result:write(oprot)
  ...
  if self.success ~= nil then
    ...
    for _,iter313 in ipairs(self.success) do
      iter313:write(oprot)
    end
    oprot:writeListEnd()
    oprot:writeFieldEnd()
...
function commitSendMessagesToMids_args:read(iprot)
  ...
  while true do
    ...
    elseif fid == 1 then
      if ftype == TType.LIST then
        ...
        for _i=1,_size314 do
          ...
          table.insert(self.requestIdList, _elem318)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
    ...
    elseif fid == 2 then
      if ftype == TType.LIST then
        self.mids = {}
        local _etype322, _size319 = iprot:readListBegin()
        for _i=1,_size319 do
          local _elem323 = iprot:readString()
          table.insert(self.mids, _elem323)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function commitSendMessagesToMids_args:write(oprot)
  ...
  if self.requestIdList ~= nil then
    oprot:writeFieldBegin('requestIdList', TType.LIST, 1)
    oprot:writeListBegin(TType.STRING, #self.requestIdList)
    for _,iter324 in ipairs(self.requestIdList) do
  ...
  if self.mids ~= nil then
    ...
    for _,iter325 in ipairs(self.mids) do
...
function commitSendMessagesToMids_result:read(iprot)
  ...
  while true do
    ...
    elseif fid == 0 then
      if ftype == TType.LIST then
        self.success = {}
        local _etype329, _size326 = iprot:readListBegin()
        for _i=1,_size326 do
          local _elem330 = SendBuddyMessageResult:new{}
          _elem330:read(iprot)
          table.insert(self.success, _elem330)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function commitSendMessagesToMids_result:write(oprot)
  ...
  if self.success ~= nil then
    oprot:writeFieldBegin('success', TType.LIST, 0)
    oprot:writeListBegin(TType.STRUCT, #self.success)
    for _,iter331 in ipairs(self.success) do
      iter331:write(oprot)
    end
    oprot:writeListEnd()
    oprot:writeFieldEnd()
    ...
    elseif fid == 0 then
      if ftype == TType.LIST then
        ...
        for _i=1,_size332 do
          local _elem336 = iprot:readString()
          table.insert(self.success, _elem336)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function getActiveMemberMidsByBuddyMid_result:write(oprot)
  ...
  if self.success ~= nil then
    ...
    for _,iter337 in ipairs(self.success) do
    ...
    elseif fid == 0 then
      if ftype == TType.LIST then
        ...
        for _i=1,_size338 do
          ...
          table.insert(self.success, _elem342)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function getAllBuddyMembers_result:write(oprot)
  ...
  if self.success ~= nil then
    oprot:writeFieldBegin('success', TType.LIST, 0)
    oprot:writeListBegin(TType.STRING, #self.success)
    for _,iter343 in ipairs(self.success) do
    ...
    elseif fid == 0 then
      if ftype == TType.LIST then
        ...
        for _i=1,_size344 do
          local _elem348 = iprot:readString()
...
function linkAndSendBuddyContentMessageToMids_args:read(iprot)
  ...
  while true do
    ...
    elseif fid == 4 then
      if ftype == TType.LIST then
        self.mids = {}
        local _etype353, _size350 = iprot:readListBegin()
        for _i=1,_size350 do
          local _elem354 = iprot:readString()
          table.insert(self.mids, _elem354)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function linkAndSendBuddyContentMessageToMids_args:write(oprot)
  ...
  if self.mids ~= nil then
    ...
    oprot:writeListBegin(TType.STRING, #self.mids)
    for _,iter355 in ipairs(self.mids) do
...
function registerBuddy_args:write(oprot)
  ...
  if self.settings ~= nil then
    ...
    for kiter362,viter363 in pairs(self.settings) do
...
function removeBuddyMembers_args:read(iprot)
  ...
  while true do
    ...
    elseif fid == 2 then
      if ftype == TType.LIST then
        self.userMids = {}
        local _etype367, _size364 = iprot:readListBegin()
        for _i=1,_size364 do
          local _elem368 = iprot:readString()
          table.insert(self.userMids, _elem368)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function removeBuddyMembers_args:write(oprot)
  ...
  if self.userMids ~= nil then
    oprot:writeFieldBegin('userMids', TType.LIST, 2)
    oprot:writeListBegin(TType.STRING, #self.userMids)
    for _,iter369 in ipairs(self.userMids) do
    ...
    elseif fid == 4 then
      if ftype == TType.LIST then
        ...
        for _i=1,_size370 do
          ...
          table.insert(self.mids, _elem374)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function sendBuddyContentMessageToMids_args:write(oprot)
  ...
  if self.mids ~= nil then
    oprot:writeFieldBegin('mids', TType.LIST, 4)
    oprot:writeListBegin(TType.STRING, #self.mids)
    for _,iter375 in ipairs(self.mids) do
    ...
    elseif fid == 4 then
      if ftype == TType.LIST then
        ...
        for _i=1,_size376 do
          ...
          table.insert(self.mids, _elem380)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function sendBuddyContentMessageToMidsAsync_args:write(oprot)
  ...
  if self.mids ~= nil then
    oprot:writeFieldBegin('mids', TType.LIST, 4)
    oprot:writeListBegin(TType.STRING, #self.mids)
    for _,iter381 in ipairs(self.mids) do
    ...
    elseif fid == 3 then
      if ftype == TType.LIST then
        ...
        for _i=1,_size382 do
          ...
          table.insert(self.mids, _elem386)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function sendBuddyMessageToMids_args:write(oprot)
  ...
  if self.mids ~= nil then
    ...
    oprot:writeListBegin(TType.STRING, #self.mids)
    for _,iter387 in ipairs(self.mids) do
    ...
    elseif fid == 3 then
      if ftype == TType.LIST then
        ...
        for _i=1,_size388 do
          ...
          table.insert(self.mids, _elem392)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function sendBuddyMessageToMidsAsync_args:write(oprot)
  ...
  if self.mids ~= nil then
    oprot:writeFieldBegin('mids', TType.LIST, 3)
    oprot:writeListBegin(TType.STRING, #self.mids)
    for _,iter393 in ipairs(self.mids) do
    ...
    elseif fid == 2 then
      if ftype == TType.MAP then
        ...
        for _i=1,_size394 do
          ...
          self.attributes[_key398] = _val399
        end
        iprot:readMapEnd()
      else
        iprot:skip(ftype)
...
function updateBuddyAdminProfileAttribute_args:write(oprot)
  ...
  if self.attributes ~= nil then
    ...
    for kiter400,viter401 in pairs(self.attributes) do
    ...
    elseif fid == 2 then
      if ftype == TType.MAP then
        ...
        for _i=1,_size402 do
          ...
          self.attributes[_key406] = _val407
        end
        iprot:readMapEnd()
      else
        iprot:skip(ftype)
...
function updateBuddyProfileAttributes_args:write(oprot)
  ...
  if self.attributes ~= nil then
    oprot:writeFieldBegin('attributes', TType.MAP, 2)
    oprot:writeMapBegin(TType.STRING, TType.STRING, ttable_size(self.attributes))
    for kiter408,viter409 in pairs(self.attributes) do
...
function updateBuddyProfileAttributesAsync_args:write(oprot)
  ...
  if self.attributes ~= nil then
    oprot:writeFieldBegin('attributes', TType.MAP, 2)
    oprot:writeMapBegin(TType.STRING, TType.STRING, ttable_size(self.attributes))
    for kiter416,viter417 in pairs(self.attributes) do
...
function updateBuddySettings_args:write(oprot)
  ...
  if self.settings ~= nil then
    ...
    oprot:writeMapBegin(TType.STRING, TType.STRING, ttable_size(self.settings))
    for kiter424,viter425 in pairs(self.settings) do
