    ...
    elseif fid == 0 then
      if ftype == TType.LIST then
        ...
        for _i=1,_size426 do
          local _elem430 = BuddySearchResult:new{}
          _elem430:read(iprot)
          table.insert(self.success, _elem430)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function findBuddyContactsByQuery_result:write(oprot)
  ...
  if self.success ~= nil then
    ...
    for _,iter431 in ipairs(self.success) do
      iter431:write(oprot)
    end
    oprot:writeListEnd()
    oprot:writeFieldEnd()
    ...
    elseif fid == 0 then
      if ftype == TType.LIST then
        ...
        for _i=1,_size432 do
          local _elem436 = Contact:new{}
          _elem436:read(iprot)
          table.insert(self.success, _elem436)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function getBuddyContacts_result:write(oprot)
  ...
  if self.success ~= nil then
    oprot:writeFieldBegin('success', TType.LIST, 0)
    oprot:writeListBegin(TType.STRUCT, #self.success)
    for _,iter437 in ipairs(self.success) do
      iter437:write(oprot)
    end
    oprot:writeListEnd()
    oprot:writeFieldEnd()
    ...
    elseif fid == 0 then
      if ftype == TType.LIST then
        ...
        for _i=1,_size438 do
          ...
          table.insert(self.success, _elem442)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function getCountriesHavingBuddy_result:write(oprot)
  ...
  if self.success ~= nil then
    ...
    for _,iter443 in ipairs(self.success) do
  ...
  while true do
    ...
    elseif fid == 0 then
      if ftype == TType.MAP then
        self.success = {}
        local _ktype445, _vtype446, _size444 = iprot:readMapBegin() 
        for _i=1,_size444 do
          local _key448 = iprot:readString()
          local _val449 = iprot:readI64()
...
function getNewlyReleasedBuddyIds_result:write(oprot)
  ...
  if self.success ~= nil then
    ...
    for kiter450,viter451 in pairs(self.success) do
      oprot:writeString(kiter450)
      oprot:writeI64(viter451)
    end
    oprot:writeMapEnd()
    oprot:writeFieldEnd()
  end
    ...
    elseif fid == 0 then
      if ftype == TType.LIST then
        ...
        for _i=1,_size452 do
          local _elem456 = BuddyList:new{}
          _elem456:read(iprot)
          table.insert(self.success, _elem456)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function getPopularBuddyLists_result:write(oprot)
  ...
  if self.success ~= nil then
    oprot:writeFieldBegin('success', TType.LIST, 0)
    oprot:writeListBegin(TType.STRUCT, #self.success)
    for _,iter457 in ipairs(self.success) do
      iter457:write(oprot)
    end
    oprot:writeListEnd()
    oprot:writeFieldEnd()
