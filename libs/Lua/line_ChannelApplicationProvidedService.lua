  ...
  while true do
    ...
    elseif fid == 0 then
      if ftype == TType.LIST then
        self.success = {}
        local _etype467, _size464 = iprot:readListBegin()
        for _i=1,_size464 do
          local _elem468 = iprot:readString()
          table.insert(self.success, _elem468)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function getAllContactIdsForChannel_result:write(oprot)
  ...
  if self.success ~= nil then
    ...
    for _,iter469 in ipairs(self.success) do
...
function getCompactContacts_result:read(iprot)
  ...
  while true do
    ...
    elseif fid == 0 then
      if ftype == TType.LIST then
        self.success = {}
        local _etype473, _size470 = iprot:readListBegin()
        for _i=1,_size470 do
          local _elem474 = CompactContact:new{}
          _elem474:read(iprot)
          table.insert(self.success, _elem474)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function getCompactContacts_result:write(oprot)
  ...
  if self.success ~= nil then
    ...
    for _,iter475 in ipairs(self.success) do
      iter475:write(oprot)
    end
    oprot:writeListEnd()
    oprot:writeFieldEnd()
...
function getContactsForChannel_args:read(iprot)
  ...
  while true do
    ...
    elseif fid == 2 then
      if ftype == TType.LIST then
        self.ids = {}
        local _etype479, _size476 = iprot:readListBegin()
        for _i=1,_size476 do
          local _elem480 = iprot:readString()
          table.insert(self.ids, _elem480)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function getContactsForChannel_args:write(oprot)
  ...
  if self.ids ~= nil then
    ...
    for _,iter481 in ipairs(self.ids) do
...
function getContactsForChannel_result:read(iprot)
  ...
  while true do
    ...
    elseif fid == 0 then
      if ftype == TType.LIST then
        self.success = {}
        local _etype485, _size482 = iprot:readListBegin()
        for _i=1,_size482 do
          local _elem486 = Contact:new{}
          _elem486:read(iprot)
          table.insert(self.success, _elem486)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function getContactsForChannel_result:write(oprot)
  ...
  if self.success ~= nil then
    oprot:writeFieldBegin('success', TType.LIST, 0)
    oprot:writeListBegin(TType.STRUCT, #self.success)
    for _,iter487 in ipairs(self.success) do
      iter487:write(oprot)
    end
    oprot:writeListEnd()
    oprot:writeFieldEnd()
    ...
    elseif fid == 0 then
      if ftype == TType.LIST then
        ...
        for _i=1,_size488 do
          local _elem492 = iprot:readString()
          table.insert(self.success, _elem492)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function getFavoriteMidsForChannel_result:write(oprot)
  ...
  if self.success ~= nil then
    oprot:writeFieldBegin('success', TType.LIST, 0)
    oprot:writeListBegin(TType.STRING, #self.success)
    for _,iter493 in ipairs(self.success) do
...
function getFriendMids_result:read(iprot)
  ...
  while true do
    ...
    elseif fid == 0 then
      if ftype == TType.LIST then
        self.success = {}
        local _etype497, _size494 = iprot:readListBegin()
        for _i=1,_size494 do
          local _elem498 = iprot:readString()
          table.insert(self.success, _elem498)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function getFriendMids_result:write(oprot)
  ...
  if self.success ~= nil then
    oprot:writeFieldBegin('success', TType.LIST, 0)
    oprot:writeListBegin(TType.STRING, #self.success)
    for _,iter499 in ipairs(self.success) do
...
function getGroupMemberMids_result:read(iprot)
  ...
  while true do
    ...
    elseif fid == 0 then
      if ftype == TType.LIST then
        self.success = {}
        local _etype503, _size500 = iprot:readListBegin()
        for _i=1,_size500 do
          local _elem504 = iprot:readString()
          table.insert(self.success, _elem504)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function getGroupMemberMids_result:write(oprot)
  ...
  if self.success ~= nil then
    oprot:writeFieldBegin('success', TType.LIST, 0)
    oprot:writeListBegin(TType.STRING, #self.success)
    for _,iter505 in ipairs(self.success) do
...
function getGroupsForChannel_args:read(iprot)
  ...
  while true do
    ...
    elseif fid == 1 then
      if ftype == TType.LIST then
        self.groupIds = {}
        local _etype509, _size506 = iprot:readListBegin()
        for _i=1,_size506 do
          local _elem510 = iprot:readString()
          table.insert(self.groupIds, _elem510)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function getGroupsForChannel_args:write(oprot)
  ...
  if self.groupIds ~= nil then
    ...
    for _,iter511 in ipairs(self.groupIds) do
...
function getGroupsForChannel_result:read(iprot)
  ...
  while true do
    ...
    elseif fid == 0 then
      if ftype == TType.LIST then
        self.success = {}
        local _etype515, _size512 = iprot:readListBegin()
        for _i=1,_size512 do
          local _elem516 = Group:new{}
          _elem516:read(iprot)
          table.insert(self.success, _elem516)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function getGroupsForChannel_result:write(oprot)
  ...
  if self.success ~= nil then
    oprot:writeFieldBegin('success', TType.LIST, 0)
    oprot:writeListBegin(TType.STRUCT, #self.success)
    for _,iter517 in ipairs(self.success) do
      iter517:write(oprot)
    end
    oprot:writeListEnd()
    oprot:writeFieldEnd()
    ...
    elseif fid == 0 then
      if ftype == TType.LIST then
        ...
        for _i=1,_size518 do
          local _elem522 = iprot:readString()
          table.insert(self.success, _elem522)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function getJoinedGroupIdsForChannel_result:write(oprot)
  ...
  if self.success ~= nil then
    oprot:writeFieldBegin('success', TType.LIST, 0)
    oprot:writeListBegin(TType.STRING, #self.success)
    for _,iter523 in ipairs(self.success) do
    ...
    elseif fid == 1 then
      if ftype == TType.LIST then
        ...
        for _i=1,_size524 do
          local _elem528 = iprot:readString()
          table.insert(self.ids, _elem528)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function getSimpleChannelContacts_args:write(oprot)
  ...
  if self.ids ~= nil then
    ...
    oprot:writeListBegin(TType.STRING, #self.ids)
    for _,iter529 in ipairs(self.ids) do
    ...
    elseif fid == 0 then
      if ftype == TType.LIST then
        ...
        for _i=1,_size530 do
          local _elem534 = SimpleChannelContact:new{}
          _elem534:read(iprot)
  ...
  while true do
    ...
    elseif fid == 0 then
      if ftype == TType.MAP then
        self.success = {}
        local _ktype537, _vtype538, _size536 = iprot:readMapBegin() 
        for _i=1,_size536 do
          local _key540 = iprot:readI32()
          local _val541 = iprot:readString()
...
function getUserIdentities_result:write(oprot)
  ...
  if self.success ~= nil then
    ...
    for kiter542,viter543 in pairs(self.success) do
      oprot:writeI32(kiter542)
      oprot:writeString(viter543)
    end
    oprot:writeMapEnd()
    oprot:writeFieldEnd()
  end
    ...
    elseif fid == 0 then
      if ftype == TType.LIST then
        ...
        for _i=1,_size544 do
          ...
          table.insert(self.success, _elem548)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function getUserMidsWhoAddedMe_result:write(oprot)
  ...
  if self.success ~= nil then
    oprot:writeFieldBegin('success', TType.LIST, 0)
    oprot:writeListBegin(TType.STRING, #self.success)
    for _,iter549 in ipairs(self.success) do
