    ...
    elseif fid == 0 then
      if ftype == TType.LIST then
        ...
        for _i=1,_size586 do
          local _elem590 = CoinProductItem:new{}
          _elem590:read(iprot)
          table.insert(self.success, _elem590)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function getCoinProducts_result:write(oprot)
  ...
  if self.success ~= nil then
    ...
    for _,iter591 in ipairs(self.success) do
      iter591:write(oprot)
    end
    oprot:writeListEnd()
    oprot:writeFieldEnd()
...
function getCoinProductsByPgCode_result:read(iprot)
  ...
  while true do
    ...
    elseif fid == 0 then
      if ftype == TType.LIST then
        self.success = {}
        local _etype595, _size592 = iprot:readListBegin()
        for _i=1,_size592 do
          local _elem596 = CoinProductItem:new{}
          _elem596:read(iprot)
          table.insert(self.success, _elem596)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function getCoinProductsByPgCode_result:write(oprot)
  ...
  if self.success ~= nil then
    oprot:writeFieldBegin('success', TType.LIST, 0)
    oprot:writeListBegin(TType.STRUCT, #self.success)
    for _,iter597 in ipairs(self.success) do
      iter597:write(oprot)
    end
    oprot:writeListEnd()
    oprot:writeFieldEnd()
...
function getProductList_args:read(iprot)
  ...
  while true do
    ...
    elseif fid == 2 then
      if ftype == TType.LIST then
        self.productIdList = {}
        local _etype601, _size598 = iprot:readListBegin()
        for _i=1,_size598 do
          local _elem602 = iprot:readString()
          table.insert(self.productIdList, _elem602)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function getProductList_args:write(oprot)
  ...
  if self.productIdList ~= nil then
    ...
    for _,iter603 in ipairs(self.productIdList) do
...
function getProductListWithCarrier_args:read(iprot)
  ...
  while true do
    ...
    elseif fid == 2 then
      if ftype == TType.LIST then
        self.productIdList = {}
        local _etype607, _size604 = iprot:readListBegin()
        for _i=1,_size604 do
          local _elem608 = iprot:readString()
          table.insert(self.productIdList, _elem608)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function getProductListWithCarrier_args:write(oprot)
  ...
  if self.productIdList ~= nil then
    oprot:writeFieldBegin('productIdList', TType.LIST, 2)
    oprot:writeListBegin(TType.STRING, #self.productIdList)
    for _,iter609 in ipairs(self.productIdList) do
