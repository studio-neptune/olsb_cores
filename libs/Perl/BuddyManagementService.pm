...
sub write {
      ...
      if (defined $self->{userMids}) {
        $xfer += $output->writeFieldBegin('userMids', Thrift::TType::LIST, 2);
        {
          ...
          {
            foreach my $iter347 (@{$self->{userMids}}) 
            {
          ...
          /^1$/ && do{          if ($ftype == Thrift::TType::LIST) {
            {
              ...
              for (my $_i352 = 0; $_i352 < $_size348; ++$_i352)
              {
                ...
                push(@{$self->{requestIdList}},$elem353);
              }
              $xfer += $input->readListEnd();
            }
          } else {
...
sub write {
      ...
      if (defined $self->{requestIdList}) {
        $xfer += $output->writeFieldBegin('requestIdList', Thrift::TType::LIST, 1);
        {
          ...
          {
            foreach my $iter354 (@{$self->{requestIdList}}) 
            {
          ...
          /^0$/ && do{          if ($ftype == Thrift::TType::LIST) {
            {
              ...
              {
                my $elem360 = undef;
                $elem360 = SendBuddyMessageResult->new();
                $xfer += $elem360->read($input);
                push(@{$self->{success}},$elem360);
              }
              $xfer += $input->readListEnd();
            }
          } else {
...
sub write {
      ...
      if (defined $self->{success}) {
        $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
        {
          ...
          {
            foreach my $iter361 (@{$self->{success}}) 
            {
          ...
          /^1$/ && do{          if ($ftype == Thrift::TType::LIST) {
            {
              ...
              for (my $_i366 = 0; $_i366 < $_size362; ++$_i366)
              {
                ...
                push(@{$self->{requestIdList}},$elem367);
              }
              $xfer += $input->readListEnd();
            }
          } else {
...
sub write {
      ...
      if (defined $self->{requestIdList}) {
        $xfer += $output->writeFieldBegin('requestIdList', Thrift::TType::LIST, 1);
        {
          $xfer += $output->writeListBegin(Thrift::TType::STRING, scalar(@{$self->{requestIdList}}));
          {
            foreach my $iter374 (@{$self->{requestIdList}}) 
            {
          ...
          /^0$/ && do{          if ($ftype == Thrift::TType::LIST) {
            {
              ...
              {
                my $elem381 = undef;
                $elem381 = SendBuddyMessageResult->new();
...
sub write {
      ...
      if (defined $self->{settings}) {
        $xfer += $output->writeFieldBegin('settings', Thrift::TType::MAP, 7);
        {
          ...
          {
            while( my ($kiter418,$viter419) = each %{$self->{settings}}) 
            {
...
sub write {
      ...
      if (defined $self->{userMids}) {
        $xfer += $output->writeFieldBegin('userMids', Thrift::TType::LIST, 2);
        {
          $xfer += $output->writeListBegin(Thrift::TType::STRING, scalar(@{$self->{userMids}}));
          {
            foreach my $iter426 (@{$self->{userMids}}) 
            {
          ...
          /^3$/ && do{          if ($ftype == Thrift::TType::LIST) {
            {
              ...
              for (my $_i452 = 0; $_i452 < $_size448; ++$_i452)
              {
                my $elem453 = undef;
                $xfer += $input->readString(\$elem453);
                push(@{$self->{mids}},$elem453);
              }
              $xfer += $input->readListEnd();
            }
          } else {
...
sub write {
      ...
      if (defined $self->{attributes}) {
        $xfer += $output->writeFieldBegin('attributes', Thrift::TType::MAP, 2);
        {
          ...
          {
            while( my ($kiter462,$viter463) = each %{$self->{attributes}}) 
            {
...
sub write {
      ...
      if (defined $self->{attributes}) {
        $xfer += $output->writeFieldBegin('attributes', Thrift::TType::MAP, 2);
        {
          $xfer += $output->writeMapBegin(Thrift::TType::STRING, Thrift::TType::STRING, scalar(keys %{$self->{attributes}}));
          {
            while( my ($kiter471,$viter472) = each %{$self->{attributes}}) 
            {
          ...
          /^2$/ && do{          if ($ftype == Thrift::TType::MAP) {
            {
              ...
              for (my $_i477 = 0; $_i477 < $_size473; ++$_i477)
              {
                my $key478 = '';
                my $val479 = '';
                $xfer += $input->readString(\$key478);
                $xfer += $input->readString(\$val479);
                $self->{attributes}->{$key478} = $val479;
              }
              $xfer += $input->readMapEnd();
            }
          } else {
...
sub write {
      ...
      if (defined $self->{attributes}) {
        $xfer += $output->writeFieldBegin('attributes', Thrift::TType::MAP, 2);
        {
          $xfer += $output->writeMapBegin(Thrift::TType::STRING, Thrift::TType::STRING, scalar(keys %{$self->{attributes}}));
          {
            while( my ($kiter480,$viter481) = each %{$self->{attributes}}) 
            {
              $xfer += $output->writeString($kiter480);
              $xfer += $output->writeString($viter481);
            }
          }
          $xfer += $output->writeMapEnd();
        }
          ...
          /^2$/ && do{          if ($ftype == Thrift::TType::MAP) {
            {
              ...
              for (my $_i486 = 0; $_i486 < $_size482; ++$_i486)
              {
                my $key487 = '';
                my $val488 = '';
                $xfer += $input->readString(\$key487);
                $xfer += $input->readString(\$val488);
                $self->{settings}->{$key487} = $val488;
              }
              $xfer += $input->readMapEnd();
            }
          } else {
...
sub write {
      ...
      if (defined $self->{settings}) {
        $xfer += $output->writeFieldBegin('settings', Thrift::TType::MAP, 2);
        {
          $xfer += $output->writeMapBegin(Thrift::TType::STRING, Thrift::TType::STRING, scalar(keys %{$self->{settings}}));
          {
            while( my ($kiter489,$viter490) = each %{$self->{settings}}) 
            {
              $xfer += $output->writeString($kiter489);
              $xfer += $output->writeString($viter490);
            }
          }
          $xfer += $output->writeMapEnd();
        }
