            ...
            /^0$/ && do{            if ($ftype == Thrift::TType::LIST) {
              {
                ...
                for (my $_i495 = 0; $_i495 < $_size491; ++$_i495)
                {
                  my $elem496 = undef;
                  $elem496 = BuddySearchResult->new();
                  $xfer += $elem496->read($input);
                  push(@{$self->{success}},$elem496);
                }
...
sub write {
        ...
        if (defined $self->{success}) {
          $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
          {
            ...
            {
              foreach my $iter497 (@{$self->{success}}) 
              {
            ...
            /^0$/ && do{            if ($ftype == Thrift::TType::LIST) {
              {
                ...
                for (my $_i502 = 0; $_i502 < $_size498; ++$_i502)
                {
                  my $elem503 = undef;
                  $elem503 = Contact->new();
                  $xfer += $elem503->read($input);
                  push(@{$self->{success}},$elem503);
                }
                $xfer += $input->readListEnd();
              }
            } else {
...
sub write {
        ...
        if (defined $self->{success}) {
          $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
          {
            $xfer += $output->writeListBegin(Thrift::TType::STRUCT, scalar(@{$self->{success}}));
            {
              foreach my $iter504 (@{$self->{success}}) 
              {
            ...
            /^0$/ && do{            if ($ftype == Thrift::TType::LIST) {
              {
                ...
                for (my $_i509 = 0; $_i509 < $_size505; ++$_i509)
                {
                  my $elem510 = undef;
                  $xfer += $input->readString(\$elem510);
                  push(@{$self->{success}},$elem510);
                }
                $xfer += $input->readListEnd();
              }
            } else {
...
sub write {
        ...
        if (defined $self->{success}) {
          $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
          {
            ...
            {
              foreach my $iter511 (@{$self->{success}}) 
              {
            ...
            /^0$/ && do{            if ($ftype == Thrift::TType::MAP) {
              {
                ...
                for (my $_i516 = 0; $_i516 < $_size512; ++$_i516)
                {
                  my $key517 = '';
                  my $val518 = 0;
                  $xfer += $input->readString(\$key517);
                  $xfer += $input->readI64(\$val518);
                  $self->{success}->{$key517} = $val518;
                }
...
sub write {
        ...
        if (defined $self->{success}) {
          $xfer += $output->writeFieldBegin('success', Thrift::TType::MAP, 0);
          {
            ...
            {
              while( my ($kiter519,$viter520) = each %{$self->{success}}) 
              {
                $xfer += $output->writeString($kiter519);
                $xfer += $output->writeI64($viter520);
              }
            }
            ...
            /^0$/ && do{            if ($ftype == Thrift::TType::LIST) {
              {
                ...
                {
                  my $elem526 = undef;
                  $elem526 = BuddyList->new();
                  $xfer += $elem526->read($input);
                  push(@{$self->{success}},$elem526);
                }
                $xfer += $input->readListEnd();
              }
            } else {
...
sub write {
        ...
        if (defined $self->{success}) {
          $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
          {
            $xfer += $output->writeListBegin(Thrift::TType::STRUCT, scalar(@{$self->{success}}));
            {
              foreach my $iter527 (@{$self->{success}}) 
              {
            ...
            /^0$/ && do{            if ($ftype == Thrift::TType::LIST) {
              {
                ...
                for (my $_i532 = 0; $_i532 < $_size528; ++$_i532)
                {
                  my $elem533 = undef;
                  $elem533 = Contact->new();
                  $xfer += $elem533->read($input);
                  push(@{$self->{success}},$elem533);
                }
                $xfer += $input->readListEnd();
              }
            } else {
...
sub write {
        ...
        if (defined $self->{success}) {
          $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
          {
            $xfer += $output->writeListBegin(Thrift::TType::STRUCT, scalar(@{$self->{success}}));
            {
              foreach my $iter534 (@{$self->{success}}) 
              {
