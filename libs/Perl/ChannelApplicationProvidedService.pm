              ...
              /^0$/ && do{              if ($ftype == Thrift::TType::LIST) {
                {
                  ...
                  for (my $_i539 = 0; $_i539 < $_size535; ++$_i539)
                  {
                    my $elem540 = undef;
                    $xfer += $input->readString(\$elem540);
                    push(@{$self->{success}},$elem540);
                  }
...
sub write {
          ...
          if (defined $self->{success}) {
            $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
            {
              ...
              {
                foreach my $iter541 (@{$self->{success}}) 
                {
              ...
              /^0$/ && do{              if ($ftype == Thrift::TType::LIST) {
                {
                  ...
                  for (my $_i546 = 0; $_i546 < $_size542; ++$_i546)
                  {
                    my $elem547 = undef;
                    $elem547 = CompactContact->new();
                    $xfer += $elem547->read($input);
                    push(@{$self->{success}},$elem547);
                  }
                  $xfer += $input->readListEnd();
                }
              } else {
...
sub write {
          ...
          if (defined $self->{success}) {
            $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
            {
              ...
              {
                foreach my $iter548 (@{$self->{success}}) 
                {
              ...
              /^2$/ && do{              if ($ftype == Thrift::TType::LIST) {
                {
                  ...
                  for (my $_i553 = 0; $_i553 < $_size549; ++$_i553)
                  {
                    my $elem554 = undef;
                    $xfer += $input->readString(\$elem554);
                    push(@{$self->{ids}},$elem554);
                  }
                  $xfer += $input->readListEnd();
                }
              } else {
              ...
              /^0$/ && do{              if ($ftype == Thrift::TType::LIST) {
                {
                  ...
                  for (my $_i560 = 0; $_i560 < $_size556; ++$_i560)
                  {
                    my $elem561 = undef;
                    $elem561 = Contact->new();
                    $xfer += $elem561->read($input);
                    push(@{$self->{success}},$elem561);
                  }
                  $xfer += $input->readListEnd();
                }
              } else {
...
sub write {
          ...
          if (defined $self->{success}) {
            $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
            {
              $xfer += $output->writeListBegin(Thrift::TType::STRUCT, scalar(@{$self->{success}}));
              {
                foreach my $iter562 (@{$self->{success}}) 
                {
              ...
              /^0$/ && do{              if ($ftype == Thrift::TType::LIST) {
                {
                  ...
                  for (my $_i567 = 0; $_i567 < $_size563; ++$_i567)
                  {
                    my $elem568 = undef;
                    $xfer += $input->readString(\$elem568);
                    push(@{$self->{success}},$elem568);
                  }
                  $xfer += $input->readListEnd();
                }
              } else {
...
sub write {
          ...
          if (defined $self->{success}) {
            $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
            {
              $xfer += $output->writeListBegin(Thrift::TType::STRING, scalar(@{$self->{success}}));
              {
                foreach my $iter569 (@{$self->{success}}) 
                {
...
sub write {
          ...
          if (defined $self->{success}) {
            $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
            {
              $xfer += $output->writeListBegin(Thrift::TType::STRING, scalar(@{$self->{success}}));
              {
                foreach my $iter576 (@{$self->{success}}) 
                {
              ...
              /^0$/ && do{              if ($ftype == Thrift::TType::LIST) {
                {
                  ...
                  for (my $_i581 = 0; $_i581 < $_size577; ++$_i581)
                  {
                    my $elem582 = undef;
                    $xfer += $input->readString(\$elem582);
                    push(@{$self->{success}},$elem582);
                  }
                  $xfer += $input->readListEnd();
                }
              } else {
...
sub write {
          ...
          if (defined $self->{success}) {
            $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
            {
              $xfer += $output->writeListBegin(Thrift::TType::STRING, scalar(@{$self->{success}}));
              {
                foreach my $iter583 (@{$self->{success}}) 
                {
              ...
              /^1$/ && do{              if ($ftype == Thrift::TType::LIST) {
                {
                  ...
                  for (my $_i588 = 0; $_i588 < $_size584; ++$_i588)
                  {
                    my $elem589 = undef;
                    $xfer += $input->readString(\$elem589);
                    push(@{$self->{groupIds}},$elem589);
                  }
                  $xfer += $input->readListEnd();
                }
              } else {
...
sub write {
          ...
          if (defined $self->{groupIds}) {
            $xfer += $output->writeFieldBegin('groupIds', Thrift::TType::LIST, 1);
            {
              ...
              {
                foreach my $iter590 (@{$self->{groupIds}}) 
                {
              ...
              /^0$/ && do{              if ($ftype == Thrift::TType::LIST) {
                {
                  ...
                  for (my $_i595 = 0; $_i595 < $_size591; ++$_i595)
                  {
                    my $elem596 = undef;
                    $elem596 = Group->new();
                    $xfer += $elem596->read($input);
                    push(@{$self->{success}},$elem596);
                  }
                  $xfer += $input->readListEnd();
                }
              } else {
...
sub write {
          ...
          if (defined $self->{success}) {
            $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
            {
              $xfer += $output->writeListBegin(Thrift::TType::STRUCT, scalar(@{$self->{success}}));
              {
                foreach my $iter597 (@{$self->{success}}) 
                {
              ...
              /^0$/ && do{              if ($ftype == Thrift::TType::LIST) {
                {
                  ...
                  for (my $_i602 = 0; $_i602 < $_size598; ++$_i602)
                  {
                    my $elem603 = undef;
                    $xfer += $input->readString(\$elem603);
                    push(@{$self->{success}},$elem603);
                  }
                  $xfer += $input->readListEnd();
                }
              } else {
...
sub write {
          ...
          if (defined $self->{success}) {
            $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
            {
              $xfer += $output->writeListBegin(Thrift::TType::STRING, scalar(@{$self->{success}}));
              {
                foreach my $iter604 (@{$self->{success}}) 
                {
              ...
              /^1$/ && do{              if ($ftype == Thrift::TType::LIST) {
                {
                  ...
                  for (my $_i609 = 0; $_i609 < $_size605; ++$_i609)
                  {
                    my $elem610 = undef;
                    $xfer += $input->readString(\$elem610);
                    push(@{$self->{ids}},$elem610);
                  }
                  $xfer += $input->readListEnd();
                }
              } else {
              ...
              /^0$/ && do{              if ($ftype == Thrift::TType::LIST) {
                {
                  ...
                  for (my $_i616 = 0; $_i616 < $_size612; ++$_i616)
                  {
                    my $elem617 = undef;
                    $elem617 = SimpleChannelContact->new();
                    $xfer += $elem617->read($input);
                    push(@{$self->{success}},$elem617);
                  }
                  $xfer += $input->readListEnd();
                }
              } else {
...
sub write {
          ...
          if (defined $self->{success}) {
            $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
            {
              $xfer += $output->writeListBegin(Thrift::TType::STRUCT, scalar(@{$self->{success}}));
              {
                foreach my $iter618 (@{$self->{success}}) 
                {
              ...
              /^0$/ && do{              if ($ftype == Thrift::TType::MAP) {
                {
                  ...
                  for (my $_i623 = 0; $_i623 < $_size619; ++$_i623)
                  {
                    my $key624 = 0;
                    my $val625 = '';
                    $xfer += $input->readI32(\$key624);
                    $xfer += $input->readString(\$val625);
                    $self->{success}->{$key624} = $val625;
                  }
...
sub write {
          ...
          if (defined $self->{success}) {
            $xfer += $output->writeFieldBegin('success', Thrift::TType::MAP, 0);
            {
              ...
              {
                while( my ($kiter626,$viter627) = each %{$self->{success}}) 
                {
                  $xfer += $output->writeI32($kiter626);
                  $xfer += $output->writeString($viter627);
                }
              }
              ...
              /^0$/ && do{              if ($ftype == Thrift::TType::LIST) {
                {
                  ...
                  for (my $_i632 = 0; $_i632 < $_size628; ++$_i632)
                  {
                    my $elem633 = undef;
                    $xfer += $input->readString(\$elem633);
                    push(@{$self->{success}},$elem633);
                  }
                  $xfer += $input->readListEnd();
                }
              } else {
...
sub write {
          ...
          if (defined $self->{success}) {
            $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
            {
              $xfer += $output->writeListBegin(Thrift::TType::STRING, scalar(@{$self->{success}}));
              {
                foreach my $iter634 (@{$self->{success}}) 
                {
