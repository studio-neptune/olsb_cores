                ...
                /^0$/ && do{                if ($ftype == Thrift::TType::LIST) {
                  {
                    ...
                    for (my $_i639 = 0; $_i639 < $_size635; ++$_i639)
                    {
                      my $elem640 = undef;
                      $elem640 = ChannelNotificationSetting->new();
                      $xfer += $elem640->read($input);
                      push(@{$self->{success}},$elem640);
                    }
...
sub write {
            ...
            if (defined $self->{success}) {
              $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
              {
                ...
                {
                  foreach my $iter641 (@{$self->{success}}) 
                  {
                ...
                /^1$/ && do{                if ($ftype == Thrift::TType::LIST) {
                  {
                    ...
                    for (my $_i646 = 0; $_i646 < $_size642; ++$_i646)
                    {
                      my $elem647 = undef;
                      $xfer += $input->readString(\$elem647);
                      push(@{$self->{channelIds}},$elem647);
                    }
                    $xfer += $input->readListEnd();
                  }
                } else {
...
sub write {
            ...
            if (defined $self->{channelIds}) {
              $xfer += $output->writeFieldBegin('channelIds', Thrift::TType::LIST, 1);
              {
                ...
                {
                  foreach my $iter648 (@{$self->{channelIds}}) 
                  {
                ...
                /^3$/ && do{                if ($ftype == Thrift::TType::LIST) {
                  {
                    ...
                    for (my $_i653 = 0; $_i653 < $_size649; ++$_i653)
                    {
                      my $elem654 = undef;
                      $xfer += $input->readString(\$elem654);
                      push(@{$self->{authScheme}},$elem654);
                    }
                    $xfer += $input->readListEnd();
                  }
                } else {
...
sub write {
            ...
            if (defined $self->{authScheme}) {
              $xfer += $output->writeFieldBegin('authScheme', Thrift::TType::LIST, 3);
              {
                ...
                {
                  foreach my $iter655 (@{$self->{authScheme}}) 
                  {
                ...
                /^1$/ && do{                if ($ftype == Thrift::TType::LIST) {
                  {
                    ...
                    {
                      my $elem661 = undef;
                      $elem661 = ChannelNotificationSetting->new();
                      $xfer += $elem661->read($input);
                      push(@{$self->{setting}},$elem661);
                    }
                    $xfer += $input->readListEnd();
                  }
                } else {
...
sub write {
            ...
            if (defined $self->{setting}) {
              $xfer += $output->writeFieldBegin('setting', Thrift::TType::LIST, 1);
              {
                ...
                {
                  foreach my $iter662 (@{$self->{setting}}) 
                  {
