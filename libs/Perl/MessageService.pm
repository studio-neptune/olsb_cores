                  ...
                  /^2$/ && do{                  if ($ftype == Thrift::TType::LIST) {
                    {
                      ...
                      for (my $_i667 = 0; $_i667 < $_size663; ++$_i667)
                      {
                        my $elem668 = undef;
                        $xfer += $input->readString(\$elem668);
                        push(@{$self->{chatIds}},$elem668);
                      }
...
sub write {
              ...
              if (defined $self->{chatIds}) {
                $xfer += $output->writeFieldBegin('chatIds', Thrift::TType::LIST, 2);
                {
                  ...
                  {
                    foreach my $iter669 (@{$self->{chatIds}}) 
                    {
                  ...
                  /^0$/ && do{                  if ($ftype == Thrift::TType::LIST) {
                    {
                      ...
                      for (my $_i674 = 0; $_i674 < $_size670; ++$_i674)
                      {
                        my $elem675 = undef;
                        $elem675 = LastReadMessageIds->new();
                        $xfer += $elem675->read($input);
                        push(@{$self->{success}},$elem675);
                      }
                      $xfer += $input->readListEnd();
                    }
                  } else {
...
sub write {
              ...
              if (defined $self->{success}) {
                $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
                {
                  ...
                  {
                    foreach my $iter676 (@{$self->{success}}) 
                    {
