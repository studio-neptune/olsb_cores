                    ...
                    /^0$/ && do{                    if ($ftype == Thrift::TType::LIST) {
                      {
                        ...
                        for (my $_i681 = 0; $_i681 < $_size677; ++$_i681)
                        {
                          my $elem682 = undef;
                          $elem682 = CoinProductItem->new();
                          $xfer += $elem682->read($input);
                          push(@{$self->{success}},$elem682);
                        }
...
sub write {
                ...
                if (defined $self->{success}) {
                  $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
                  {
                    ...
                    {
                      foreach my $iter683 (@{$self->{success}}) 
                      {
                        $xfer += ${iter683}->write($output);
                      }
                    }
                    ...
                    /^0$/ && do{                    if ($ftype == Thrift::TType::LIST) {
                      {
                        ...
                        for (my $_i688 = 0; $_i688 < $_size684; ++$_i688)
                        {
                          my $elem689 = undef;
                          $elem689 = CoinProductItem->new();
                          $xfer += $elem689->read($input);
                          push(@{$self->{success}},$elem689);
                        }
                        $xfer += $input->readListEnd();
                      }
                    } else {
...
sub write {
                ...
                if (defined $self->{success}) {
                  $xfer += $output->writeFieldBegin('success', Thrift::TType::LIST, 0);
                  {
                    $xfer += $output->writeListBegin(Thrift::TType::STRUCT, scalar(@{$self->{success}}));
                    {
                      foreach my $iter690 (@{$self->{success}}) 
                      {
                    ...
                    /^2$/ && do{                    if ($ftype == Thrift::TType::LIST) {
                      {
                        ...
                        for (my $_i695 = 0; $_i695 < $_size691; ++$_i695)
                        {
                          my $elem696 = undef;
                          $xfer += $input->readString(\$elem696);
                          push(@{$self->{productIdList}},$elem696);
                        }
                        $xfer += $input->readListEnd();
                      }
                    } else {
...
sub write {
                ...
                if (defined $self->{productIdList}) {
                  $xfer += $output->writeFieldBegin('productIdList', Thrift::TType::LIST, 2);
                  {
                    ...
                    {
                      foreach my $iter697 (@{$self->{productIdList}}) 
                      {
                    ...
                    /^2$/ && do{                    if ($ftype == Thrift::TType::LIST) {
                      {
                        ...
                        for (my $_i702 = 0; $_i702 < $_size698; ++$_i702)
                        {
                          my $elem703 = undef;
                          $xfer += $input->readString(\$elem703);
                          push(@{$self->{productIdList}},$elem703);
                        }
                        $xfer += $input->readListEnd();
                      }
                    } else {
...
sub write {
                ...
                if (defined $self->{productIdList}) {
                  $xfer += $output->writeFieldBegin('productIdList', Thrift::TType::LIST, 2);
                  {
                    $xfer += $output->writeListBegin(Thrift::TType::STRING, scalar(@{$self->{productIdList}}));
                    {
                      foreach my $iter704 (@{$self->{productIdList}}) 
                      {
                        $xfer += $output->writeString($iter704);
                      }
                    }
                    $xfer += $output->writeListEnd();
                  }
