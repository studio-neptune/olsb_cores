        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            uint32_t _size534;
            ::apache::thrift::protocol::TType _ktype535;
            ::apache::thrift::protocol::TType _vtype536;
            xfer += iprot->readMapBegin(_ktype535, _vtype536, _size534);
            uint32_t _i538;
            for (_i538 = 0; _i538 < _size534; ++_i538)
            {
              std::string _key539;
              xfer += iprot->readString(_key539);
              std::string& _val540 = this->parameterMap[_key539];
              xfer += iprot->readString(_val540);
            }
...
uint32_t AccountSupervisorService_notifyEmailConfirmationResult_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("parameterMap", ::apache::thrift::protocol::T_MAP, 2);
  {
    ...
    for (_iter541 = this->parameterMap.begin(); _iter541 != this->parameterMap.end(); ++_iter541)
    {
...
uint32_t AccountSupervisorService_notifyEmailConfirmationResult_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("parameterMap", ::apache::thrift::protocol::T_MAP, 2);
  {
    ...
    for (_iter542 = (*(this->parameterMap)).begin(); _iter542 != (*(this->parameterMap)).end(); ++_iter542)
    {
