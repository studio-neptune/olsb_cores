    ...
    switch (fid)
    {
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->carrier = (CarrierCode::type)ecast543;
    ...
    switch (fid)
    {
      case 0:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->success = (UserAgeType::type)ecast544;
    ...
    switch (fid)
    {
      case 0:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          (*(this->success)) = (UserAgeType::type)ecast545;
          this->__isset.success = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->carrier = (CarrierCode::type)ecast546;
          this->__isset.carrier = true;
        } else {
          xfer += iprot->skip(ftype);
        }
