  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          int32_t ecast992;
          xfer += iprot->readI32(ecast992);
          this->appStoreCode = (PaymentType::type)ecast992;
...
uint32_t ShopService_getCoinProducts_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    xfer += oprot->writeFieldBegin("success", ::apache::thrift::protocol::T_LIST, 0);
    {
      ...
      std::vector<CoinProductItem> ::const_iterator _iter998;
    ...
    switch (fid)
    {
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->appStoreCode = (PaymentType::type)ecast1004;
          this->__isset.appStoreCode = true;
        } else {
          xfer += iprot->skip(ftype);
        }
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          int32_t ecast1005;
          xfer += iprot->readI32(ecast1005);
          this->pgCode = (PaymentPgType::type)ecast1005;
...
uint32_t ShopService_getCoinProductsByPgCode_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.success) {
    ...
    {
      xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(this->success.size()));
      std::vector<CoinProductItem> ::const_iterator _iter1011;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->productIdList.resize(_size1017);
            uint32_t _i1021;
            for (_i1021 = 0; _i1021 < _size1017; ++_i1021)
            {
              xfer += iprot->readString(this->productIdList[_i1021]);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t ShopService_getProductList_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("productIdList", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter1022 = this->productIdList.begin(); _iter1022 != this->productIdList.end(); ++_iter1022)
    {
...
uint32_t ShopService_getProductList_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("productIdList", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter1023 = (*(this->productIdList)).begin(); _iter1023 != (*(this->productIdList)).end(); ++_iter1023)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->productIdList.resize(_size1024);
            uint32_t _i1028;
            for (_i1028 = 0; _i1028 < _size1024; ++_i1028)
            {
              xfer += iprot->readString(this->productIdList[_i1028]);
            }
            xfer += iprot->readListEnd();
          }
          this->__isset.productIdList = true;
...
uint32_t ShopService_getProductListWithCarrier_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("productIdList", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter1029 = this->productIdList.begin(); _iter1029 != this->productIdList.end(); ++_iter1029)
    {
...
uint32_t ShopService_getProductListWithCarrier_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("productIdList", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    for (_iter1030 = (*(this->productIdList)).begin(); _iter1030 != (*(this->productIdList)).end(); ++_iter1030)
    {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          int32_t ecast1031;
          xfer += iprot->readI32(ecast1031);
          this->appStoreCode = (PaymentType::type)ecast1031;
          this->__isset.appStoreCode = true;
        } else {
          xfer += iprot->skip(ftype);
        }
