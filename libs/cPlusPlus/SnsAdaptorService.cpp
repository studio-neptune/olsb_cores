    ...
    switch (fid)
    {
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->snsIdType = (SnsIdType::type)ecast1032;
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          int32_t ecast1033;
          xfer += iprot->readI32(ecast1033);
          this->snsIdType = (SnsIdType::type)ecast1033;
          this->__isset.snsIdType = true;
        } else {
          xfer += iprot->skip(ftype);
        }
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          int32_t ecast1034;
          xfer += iprot->readI32(ecast1034);
          this->snsIdType = (SnsIdType::type)ecast1034;
          this->__isset.snsIdType = true;
        } else {
          xfer += iprot->skip(ftype);
        }
